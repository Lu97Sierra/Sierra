...
import { IEditorInput, IResourceInput, IEditorOptions, ITextEditorOptions, IResourceDiffInput, IUntitledResourceInput, IResourceSideBySideInput,
    IEditorPart,
...
export type ICommonEditor = ICodeEditor | IStandaloneCodeEditor | IStandaloneDiffEditor;
...
export interface IEditorService extends IEditorControl, TitleControl, Pick<IOriginalEditorService,
    Exclude<keyof IOriginalEditorService, '_serviceBrand' | 'onDidActiveEditorChange' | 'onDidVisibleEditorsChange' | 'activeTextEditorWidget' | 'visibleEditors'
        | 'visibleControls' | 'visibleTextEditorWidgets' | 'replaceEditors' | 'overrideOpenEditor' | 'invokeWithinEditorContext' | 'activeControl'
        | 'openEditors' | 'isOpen' | 'getOpened'
    >> {
...
export interface ICodeEditorService extends Pick<IVSCodeEditorService,
    Exclude<keyof IVSCodeEditorService, '_serviceBrand' | 'onCodeEditorAdd' | 'onCodeEditorRemove' | 'onDiffEditorAdd' | 'onDiffEditorRemove' | 'onDidChangeTransientModelProperty'>> {
}


export interface IEditorControl {
    closeEditor(editor: IEditorInput, layoutId: string);
}

export interface TitleControl {
    pinEditor(editor: IEditorInput);
}

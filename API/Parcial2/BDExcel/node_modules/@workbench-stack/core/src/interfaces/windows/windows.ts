...
import {
    INativeOpenDialogOptions, IDevToolsOptions, IEnterWorkspaceResult,
    IMessageBoxOptions, ISaveDialogOptions, IOpenDialogOptions, IOpenSettings,
    IMessageBoxResult, IURIToOpen, IWorkspaceIdentifier, INewWindowOptions,
    ICrashReporterStartOptions,
...
export interface IWindowService extends Pick<IVscodeWindowService,
    'isFocused' | 'openWindow' | 'onDidChangeFocus' | 'showSaveDialog' | 'showOpenDialog' | 'showMessageBox'> {
...
interface IVscodeWindowsService {
    ...
    addRecentlyOpened(recents): Promise<void>;

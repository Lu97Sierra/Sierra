...
import { ConfigurationTarget as IConfigurationTarget } from '../configuration';
...
export type IArg_Input = {
  id?: Maybe<Scalars['String']>;
  folderUri?: Maybe<Scalars['URI']>;
};

export type IArgs_input = {
  id?: Maybe<Scalars['String']>;
  folderUri?: Maybe<Scalars['URI']>;
};
...
export const enum IAutoSaveConfigurationType {
  off = 'off',
 ...
 */
export type IBaseResourceInput = {
...
export type IBranchStatus = IIStatusbarItem & {
...
export type ICachedSearchStats = {
...
export type IChangeRange_Input = {
  startLineNumber?: Maybe<Scalars['Int']>;
  startColumn?: Maybe<Scalars['Int']>;
  endLineNumber?: Maybe<Scalars['Int']>;
  endColumn?: Maybe<Scalars['Int']>;
...
export type IChangesChangesChunk_Input = {
...
export type IChangesChunk_Input = {
  range?: Maybe<IChangeRange_Input>;
  rangeLength?: Maybe<Scalars['Int']>;
  text?: Maybe<Scalars['String']>;
  rangeOffset?: Maybe<Scalars['Int']>;
...
export type ICheckboxOptions_input = {
  label?: Maybe<Scalars['String']>;
  checked?: Maybe<Scalars['Boolean']>;
};

export type IChunkOptions_Input = {
...
export type ICloseEditor_Input = {
  resource: Scalars['String'];
  editorId?: Maybe<Scalars['Int']>;
  name?: Maybe<Scalars['String']>;
};

export type ICloseEditorOptions_Input = {
...
export type ICloseOptions_Input = {
  preserveFocus?: Maybe<Scalars['Boolean']>;
  closeEmptyGroups?: Maybe<Scalars['Boolean']>;
};

export type ICodeEditorViewState = {
...
export type ICodeEditorViewState_Input = {
  cursorState?: Maybe<Scalars['JSON']>;
  viewState?: Maybe<Scalars['JSON']>;
  contributionsState?: Maybe<Scalars['JSON']>;
};
...
export const enum IcommentThread {
  editable = 'editable'
};
...
export const enum IConfigurationServiceAction {
...
export type IContentChangedEvent = {
...
export type IContentChangedEvent_Input = {
...
export type IContextMenu_input = {
  isShow?: Maybe<Scalars['Boolean']>;
...
export type ICopyEditorOptions_Input = {
  index?: Maybe<Scalars['Int']>;
  inactive?: Maybe<Scalars['Boolean']>;
  preserveFocus?: Maybe<Scalars['Boolean']>;
};

export type ICrashReporterStartOptions = {
...
export type ICreateFileOptions_Input = {
  /**
...
export type ICursorState_Input = {
  inSelectionMode?: Maybe<Scalars['Boolean']>;
 ...
 */
export type IDataUriEditorInput = IIEditorInput & IIEditorInputWithGroupFields & {
...
export type IDefaultPreferencesResponse = {
...
export type IDeleteFileOptions_Input = {
...
export const enum IDevToolsOptionsMode {
  right = 'right',
  botton = 'botton',
  undocked = 'undocked',
  detach = 'detach'
 ...
 */
export type IDiffEditorInput = IIEditorInput & IIEditorInputWithGroupFields & {
...
export type IEditKeybindingItem = {
...
export const enum IEDITOR_INPUT_ID {
...
export const enum IEDITOR_INPUT_RESOURCE_TYPE_ID {
  /** If the resource is `file` */
  file = 'file'
};

export const enum IEditorActionType {
  init = 'init',
  add = 'add',
  remove = 'remove',
  removeAll = 'removeAll',
...
export const enum IEditorActivation {
  /**
...
export type IEditorChildren = IEditorPart | IEditorGroup;

export type IEditorChildren_Input = {
  /**
...
export type IEditorGroup = IIEditorGroup & {
...
export type IEditorGroupLayout = {
   __typename?: 'EditorGroupLayout';
  orientation?: Maybe<GroupOrientation>;
  groups?: Maybe<Array<Maybe<IGroupLayoutArgument>>>;
};

export type IEditorIdentifier = {
   __typename?: 'EditorIdentifier';
  groupId?: Maybe<Scalars['Int']>;
  editor?: Maybe<IEditorInput>;
};

export type IEditorInput = IDataUriEditorInput | IDiffEditorInput | IFileEditorInput | IKeybindingEditorInput | IPreferencesEditorInput | IResourceEditorInput | ISideBySideEditorInput | IUntitledEditorInput;

export type IEditorInput_Input = {
  id?: Maybe<Scalars['String']>;
  resource: Scalars['String'];
  name?: Maybe<Scalars['String']>;
  label?: Maybe<Scalars['String']>;
...
export type IEditorLayout_Input = {
  /**
   * A unique identifier of this group that remains identical even if the
   * group is moved to different locations.
   */
...
export const enum IEditorOpenContext {
  /**
...
export type IEditorOpenOptions_Input = {
...
export type IEditorOptions_Input = {
  /**
...
export type IEditorPartConfiguration_Input = {
  /**
...
export type IEditorPartOptions_Input = {
...
export type IEncodingStatus = IIStatusbarItem & {
...
export type IEndOfLineSequence = IIStatusbarItem & {
...
export type IEnterWorkspaceResult = {
...
export const enum IEnvironmentServiceAction {
...
export type IExtensionHostDebugParams = IIDebugParams & {
...
export const enum IExtensionKind {
  ui = 'ui',
  workspace = 'workspace'
};
...
export const enum IExtensionType {
  System = 'System',
  User = 'User'
};
...
export const enum IFileChangeType {
  UPDATED = 'UPDATED',
  ADDED = 'ADDED',
  DELETED = 'DELETED'
};

export type IFileContent = IIBaseStatWithMetadata & IIBaseStat & {
...
export const enum IFileContentStatus {
  PENDING = 'PENDING',
  START = 'START',
...
export type IFileDeleteOptions = {
   __typename?: 'FileDeleteOptions';
  recursive: Scalars['Boolean'];
  useTrash: Scalars['Boolean'];
};

export type IFileEditorInput = IIFileEditorInput & IIEditorInput & IIEditorInputWithGroupFields & IIEncodingSupport & IIModeSupport & {
...
export type IFileIndexProviderStats = {
...
export const enum IFileLoadReason {
  EDITOR = 'EDITOR',
  REFERENCE = 'REFERENCE',
  OTHER = 'OTHER'
};

export type IFileMatch = IIFileMatch & {
...
export const enum IFileModelState {
  /**  A model is saved.  */
  SAVED = 'SAVED',
  /**  A model is dirty.  */
  DIRTY = 'DIRTY',
...
export const enum IFileOperation {
  CREATE = 'CREATE',
  DELETE = 'DELETE',
  MOVE = 'MOVE',
  COPY = 'COPY'
...
export type IFileOperationOutput = {
...
export const enum IFileOperationResult {
...
export type IFileOverwriteOptions = {
   __typename?: 'FileOverwriteOptions';
  overwrite: Scalars['Boolean'];
};

export type IFileQueryInput = {
...
export type IFileSearchStatsdetailStats = ISearchEngineStats | ICachedSearchStats | IFileSearchProviderStats | IFileIndexProviderStats;

export const enum IFileSearchStatsType {
  fileIndexProvider = 'fileIndexProvider',
  fileSearchProvider = 'fileSearchProvider',
  searchProcess = 'searchProcess'
};

export type IFileStat = IIBaseStat & {
   __typename?: 'FileStat';
  resource: Scalars['URI'];
  name: Scalars['String'];
  size?: Maybe<Scalars['Int']>;
...
export const enum IFileStateChange {
  DIRTY = 'DIRTY',
  SAVING = 'SAVING',
...
export type IFileStatWithMetadata = IIBaseStat & IIBaseStatWithMetadata & IIContentChangedEvent & IIFileClientMetadata & IITreeItem & IIUntitledFileValue & {
...
export type IFileStreamContent = IIBaseStatWithMetadata & IIBaseStat & {
...
export type IFileToOpen = {
   __typename?: 'FileToOpen';
  fileUri?: Maybe<Scalars['URI']>;
  label?: Maybe<Scalars['String']>;
};

export const enum IFileType {
  Unknown = 'Unknown',
  File = 'File',
  Directory = 'Directory',
...
export type IFolder_input = {
  uri: Scalars['URI'];
  name?: Maybe<Scalars['String']>;
};

export type IFolderConfigurationModel = {
...
export type IFolderSettings = IISettingsSubject & {
...
export type IFoldersToAdd_Input = {
  uri: Scalars['URI'];
  name?: Maybe<Scalars['String']>;
};

export type IFolderToOpen = {
...
export type IGoToLineQuickAccess = {
...
export const enum IGraphqlCallType {
  mutation = 'mutation',
  query = 'query'
};
...
export const enum IHotExitConfiguration {
  OFF = 'OFF',
  ON_EXIT = 'ON_EXIT',
...
export type IIBaseStatWithMetadata = {
  mtime: Scalars['BigInt'];
  etag: Scalars['String'];
  size: Scalars['Int'];
};
...
export type IIBaseTextFileContent = {
...
export type IIContentChangedEvent = {
  changes?: Maybe<Scalars['JSON']>;
  eol?: Maybe<Scalars['String']>;
  versionId?: Maybe<Scalars['Int']>;
  isUndoing?: Maybe<Scalars['Boolean']>;
 ...
 * helps IEditorGroup
 */
export type IIEditorInputWithGroupFields = {
  /**
...
export type IIEncodingSupport = {
  /** encoding for the input for saving. */
  encoding?: Maybe<Scalars['String']>;
};

export type IIFileClientMetadata = {
  /** Content of the file is modified */
  dirty?: Maybe<Scalars['Boolean']>;
  /** File is in conflict with storage. */
  inConflictMode?: Maybe<Scalars['Boolean']>;
...
export type IIFileMatch = {
  resource?: Maybe<Scalars['URI']>;
  results?: Maybe<Array<Maybe<ITextSearchResult>>>;
};

export type IIJSONValue_input = {
  key?: Maybe<Scalars['String']>;
...
export type IIndentation = IIStatusbarItem & {
...
export type IInputTypeDetail = {
   __typename?: 'InputTypeDetail';
  type?: Maybe<Scalars['String']>;
  options?: Maybe<Array<Maybe<Scalars['String']>>>;
};

export type IInputTypeDetail_input = {
  type?: Maybe<Scalars['String']>;
  options?: Maybe<Array<Maybe<Scalars['String']>>>;
};
...
export type IISideBySideEditorInput = {
...
export type IIStaticWorkspaceData = {
  id: Scalars['String'];
  name?: Maybe<Scalars['String']>;
...
export type IIUntitledFileValue = {
  value?: Maybe<Scalars['String']>;
};

export type IIUserPreferences = {
   __typename?: 'IUserPreferences';
  content?: Maybe<Scalars['String']>;
  user?: Maybe<Scalars['String']>;
};

export type IIUserSettings = {
...
export type IKeybindingContextMenu = {
...
export type IKeybindingEditorInput = IIEditorInput & IIEditorInputWithGroupFields & {
...
export type IKeybindingItem_input = {
...
export const enum IKeybindingSource {
  Default = 'Default',
  User = 'User'
};

export type IKeyboardEvent_input = {
...
export type IKeyboardEvent_output = {
...
export type ILanguageMode = IIStatusbarItem & {
...
export type ILoadOptions_Input = {
...
export type IMergeGroupOptions_Input = {
...
export type IMessageLink_input = {
  name?: Maybe<Scalars['String']>;
  href?: Maybe<Scalars['String']>;
  offset?: Maybe<Scalars['Int']>;
  length?: Maybe<Scalars['Int']>;
...
export type IModelLoadOrCreateOptions_Input = {
...
export type IModelLoadOrCreateOptions_Input_reload = {
  async?: Maybe<Scalars['Boolean']>;
};

/**  All Moleculer Topic names are extended from this. */
export const enum IMoleculerServiceName {
...
export type IMoveEditor_Input = {
  resource: Scalars['String'];
  editorId?: Maybe<Scalars['Int']>;
  name?: Maybe<Scalars['String']>;
};

export type IMoveEditorOptions_Input = {
  index?: Maybe<Scalars['Int']>;
  inactive?: Maybe<Scalars['Boolean']>;
  preserveFocus?: Maybe<Scalars['Boolean']>;
};
...
export type IMutationactivateEditorArgs = {
  editorId?: Maybe<Scalars['Int']>;
};


export type IMutationaddEntryArgs = {
  arg?: Maybe<IAddEntry_input>;
};


export type IMutationaddFoldersArgs = {
...
export type IMutationcanHandleResourceArgs = {
  resource: Scalars['URI'];
};


export type IMutationchangeEditArgs = {
  changed?: Maybe<Scalars['Boolean']>;
  resource?: Maybe<Scalars['String']>;
};


export type IMutationchangeKeybindingArgs = {
...
export type IMutationchangeWhenExpressionArgs = {
  editItem?: Maybe<IKeybindingItem_input>;
  editWhenIndex?: Maybe<Scalars['Int']>;
  newWhen?: Maybe<Scalars['String']>;
};
...
export type IMutationchangeWorkspaceArgs = {
  args?: Maybe<IArgs_input>;
};


export type IMutationclearSearchCacheArgs = {
  cacheKey?: Maybe<Scalars['String']>;
};


export type IMutationcloseEditorArgs = {
  content?: Maybe<ICloseEditor_Input>;
  layoutId?: Maybe<Scalars['String']>;
};


export type IMutationcloseEditorsArgs = {
...
export type IMutationcopyFileArgs = {
  source: Scalars['URI'];
  target: Scalars['URI'];
  overwrite?: Maybe<Scalars['Boolean']>;
};
...
export type IMutationcreateTextFileArgs = {
  resource: Scalars['URI'];
  content?: Maybe<Scalars['String']>;
  overwrite?: Maybe<Scalars['Boolean']>;
};
...
export type IMutationcreateUntitledFileArgs = {
  resource?: Maybe<Scalars['URI']>;
  mode?: Maybe<Scalars['String']>;
...
export type IMutationdeleteTextFileArgs = {
  resource: Scalars['URI'];
  useTrash?: Maybe<Scalars['Boolean']>;
};
...
export type IMutationeditKeybindingArgs = {
...
export type IMutationfindFileStatArgs = {
  resource: Scalars['URI'];
};


export type IMutationgetConfigurationTargetArgs = {
  resource?: Maybe<Scalars['URI']>;
};


export type IMutationgetEditorStateArgs = {
  editorId: Scalars['String'];
  resource: Scalars['URI'];
};


export type IMutationgetFilesTreeDataArgs = {
  resource: Scalars['URI'];
};


export type IMutationgotoLineArgs = {
...
export type IMutationhighlightLineArgs = {
  range?: Maybe<ILineRange_input>;
};
...
export type IMutationjsonWriteArgs = {
  resource?: Maybe<Scalars['URI']>;
...
export type IMutationkeepOpenArgs = {
  content?: Maybe<IKeepOpen_Input>;
};


export type IMutationloadFileArgs = {
  resource: Scalars['URI'];
  options?: Maybe<IResolveMetadataFileOptions_Input>;
};


export type IMutationloadFileContentArgs = {
  resource: Scalars['URI'];
  options?: Maybe<IReadFileOptions_Input>;
};


export type IMutationloadFileWithContentArgs = {
  resource: Scalars['URI'];
  options?: Maybe<ILoadOptions_Input>;
};


export type IMutationloadFilesTreeDataArgs = {
  resource: Scalars['URI'];
};


export type IMutationlookupKeybindingArgs = {
  commandId?: Maybe<Scalars['String']>;
};


export type IMutationmakePinEditorArgs = {
  tabId?: Maybe<Scalars['String']>;
  editorId?: Maybe<Scalars['Int']>;
};


export type IMutationmoveEditorInsideGroupArgs = {
  content?: Maybe<IMoveEditor_Input>;
  moveOptions?: Maybe<IMoveEditorOptions_Input>;
};


export type IMutationmoveFileArgs = {
  source: Scalars['URI'];
  target: Scalars['URI'];
  overwrite?: Maybe<Scalars['Boolean']>;
};
...
export type IMutationmoveTextFileArgs = {
  source: Scalars['URI'];
  target: Scalars['URI'];
  overwrite?: Maybe<Scalars['Boolean']>;
};
...
export type IMutationopenEditorArgs = {
  content: IOpenEditor_Input;
  options?: Maybe<IEditorOpenOptions_Input>;
};


export type IMutationopenEditorWithResourceDiffInputArgs = {
  editor: IResourceDiff_Input;
  group?: Maybe<Scalars['Int']>;
};


export type IMutationopenEditorWithResourceInputArgs = {
  editor: IResource_Input;
  group?: Maybe<Scalars['Int']>;
};


export type IMutationopenEditorWithResourceSideBySideInputArgs = {
  editor: IResourceSideBySide_Input;
  group?: Maybe<Scalars['Int']>;
};


export type IMutationopenEditorWithUntitledResourceInputArgs = {
  editor: IUntitledResource_Input;
  group?: Maybe<Scalars['Int']>;
};


export type IMutationopenFileArgs = {
  content: IOpenEditor_Input;
  options?: Maybe<IEditorOpenOptions_Input>;
};


export type IMutationopenGlobalKeybindingSettingsArgs = {
...
export type IMutationopenPreferenceSettingsArgs = {
...
export type IMutationreadTextFileArgs = {
  resource: Scalars['URI'];
...
export type IMutationregisterKeybindingArgs = {
  keybinding?: Maybe<IKeybinding_input>;
};


export type IMutationremoveChangedContentArgs = {
  resource: Scalars['URI'];
  reset?: Maybe<Scalars['Boolean']>;
};


export type IMutationremoveEditArgs = {
...
export type IMutationremoveFoldersArgs = {
  folders?: Maybe<Array<Maybe<Scalars['URI']>>>;
};


export type IMutationremoveKeybindingArgs = {
  keybindingItem?: Maybe<IKeybindingItem_input>;
};


export type IMutationremoveStatusbarEntryArgs = {
  id: Scalars['ID'];
};


export type IMutationrenameArgs = {
  resource: Scalars['URI'];
  target: Scalars['URI'];
  overwrite?: Maybe<Scalars['Boolean']>;
};
...
export type IMutationreplaceContentArgs = {
  resource?: Maybe<Scalars['String']>;
...
export type IMutationresetKeybindingArgs = {
  keybindingItem?: Maybe<IKeybindingItem_input>;
};


export type IMutationresetSettingArgs = {
  resource?: Maybe<Scalars['URI']>;
  settingKey?: Maybe<Scalars['String']>;
};


export type IMutationresolveKeyboardEventArgs = {
...
export type IMutationsaveAllEditorArgs = {
  allSave?: Maybe<Scalars['Boolean']>;
};


export type IMutationsaveFileArgs = {
  resource: Scalars['URI'];
  versionId?: Maybe<Scalars['Int']>;
...
export type IMutationsaveFileAsArgs = {
  resource: Scalars['String'];
  versionId?: Maybe<Scalars['Int']>;
  options: ISaveOptions_Input;
...
export type IMutationsaveUserSettingsArgs = {
  content?: Maybe<Scalars['String']>;
};


export type IMutationsearchKeybindingArgs = {
  value?: Maybe<Scalars['String']>;
};


export type IMutationselectEditArgs = {
  content?: Maybe<ISelectEditor_Input>;
};


export type IMutationsetEncodingArgs = {
  resource: Scalars['URI'];
  encoding?: Maybe<Scalars['String']>;
};


export type IMutationsetFilesTreeDataArgs = {
  treeData?: Maybe<Array<Maybe<ITreeData_Input>>>;
  originalData?: Maybe<ITreeData_Input>;
};


export type IMutationsetSelectedArgs = {
  selectedValue?: Maybe<Array<Maybe<IPickItem>>>;
  inputValue?: Maybe<Scalars['String']>;
};


export type IMutationsetSelectedKeybindingIndexArgs = {
  index?: Maybe<Scalars['Int']>;
};


export type IMutationsetStatusMessageArgs = {
  arg?: Maybe<ISetStatusMsg_input>;
};


export type IMutationshowArgs = {
...
export type IMutationshowInputArgs = {
  options?: Maybe<IInputOptions>;
};


export type IMutationshowPickInputArgs = {
...
export type IMutationswitchSettingsArgs = {
...
export type IMutationtextSearch_Args = {
  query?: Maybe<ITextQueryInput>;
};


export type IMutationunwatchArgs = {
  resource: Scalars['URI'];
  session: Scalars['String'];
};


export type IMutationunwatchFileChangesArgs = {
  resource: Scalars['URI'];
  session: Scalars['String'];
};


export type IMutationupdateChangedContentArgs = {
  resource: Scalars['URI'];
...
export type IMutationupdateEditorStateArgs = {
  editorId: Scalars['String'];
  resource: Scalars['URI'];
...
export type IMutationupdateFoldersArgs = {
...
export type IMutationupdateSelectedResourceArgs = {
  resource: Scalars['URI'];
};


export type IMutationupdateStatusbarEntryArgs = {
  arg?: Maybe<IUpdateEntry_input>;
};


export type IMutationupdateWorkspaceContextAddFoldersArgs = {
  foldersToAdd?: Maybe<Array<Maybe<IFoldersToAdd_Input>>>;
  index?: Maybe<Scalars['Int']>;
};


export type IMutationupdateWorkspaceContextRemoveFoldersArgs = {
  foldersToRemove?: Maybe<Array<Maybe<Scalars['URI']>>>;
};


export type IMutationupdateWorkspaceContextUpdateFoldersArgs = {
  foldersToAdd?: Maybe<Array<Maybe<IFoldersToAdd_Input>>>;
  foldersToRemove?: Maybe<Array<Maybe<Scalars['URI']>>>;
  index?: Maybe<Scalars['Int']>;
};
...
export type IMutationwatchFileArgs = {
  resource: Scalars['URI'];
};


export type IMutationwatchFileChangesArgs = {
  resource: Scalars['URI'];
  options: IWatchOptions_Input;
};


export type IMutationwriteChunkArgs = {
  resource: Scalars['URI'];
...
export type IMutationwriteChunkWithDelayArgs = {
  resource: Scalars['URI'];
  changes: Array<Maybe<IChangesChunk_Input>>;
  options: IWriteTextFileOptions_Input;
};
...
export type IMutationwriteTextFileArgs = {
  resource: Scalars['URI'];
  value: Scalars['String'];
  options: IWriteTextFileOptions_Input;
};

export type INativeOpenDialogOptions = {
...
export type INotification_input = {
  severity?: Maybe<NotificationSeverity>;
...
export type INotificationActions_input = {
...
export const enum INotificationChangeType {
  ADD = 'ADD',
  CHANGE = 'CHANGE',
  REMOVE = 'REMOVE'
};
...
export type INotificationMessage_input = {
  raw?: Maybe<Scalars['String']>;
...
export const enum INotificationViewItemLabelKind {
  SEVERITY = 'SEVERITY',
  MESSAGE = 'MESSAGE',
  ACTIONS = 'ACTIONS',
  PROGRESS = 'PROGRESS'
...
export type IOneSearchPathPattern = {
   __typename?: 'OneSearchPathPattern';
  searchPath?: Maybe<Scalars['URI']>;
  pattern?: Maybe<Scalars['String']>;
};

export type IOpenConfiguration = {
...
export const enum IOpenContext {
...
export const enum IOpenDialogOptionsProperties {
  openFile = 'openFile',
...
export type IPathsToWaitFor = IIPathsToWaitForData & {
   __typename?: 'PathsToWaitFor';
  paths?: Maybe<Array<Maybe<IPath>>>;
  waitMarkerFileUri?: Maybe<Scalars['URI']>;
};

export type IPatternInfo = {
...
export type IPendingStatusbarEntry = {
...
export type IPreferencesEditorInput = IIEditorInput & IIEditorInputWithGroupFields & IISideBySideEditorInput & {
...
export type IPrimaryButtonAction = {
   __typename?: 'PrimaryButtonAction';
  label?: Maybe<Scalars['String']>;
  run?: Maybe<IActionRun>;
};

export type IPrimaryButtonAction_input = {
  label?: Maybe<Scalars['String']>;
  run?: Maybe<IActionRun_input>;
};
...
export type IPromptChoice_input = {
...
export type IPromptOptions_input = {
  /**
...
export const enum IProvidedRemoteConnectionStates {
...
export type IQueryeditorStateArgs = {
  editorId: Scalars['String'];
  resource: Scalars['URI'];
};


export type IQueryexistsFileArgs = {
  resource: Scalars['URI'];
};
...
export type IQueryfileSearchArgs = {
...
export type IQuerygetChangedEventArgs = {
  resource: Scalars['URI'];
};
...
export type IQuerygetDefaultSettingsArgs = {
  target?: Maybe<ConfigurationTarget>;
};


export type IQuerygetDefaultSettingsResourceArgs = {
  configurationTarget?: Maybe<ConfigurationTarget>;
};


export type IQuerygetViewsArgs = {
  containerId: Scalars['String'];
};


export type IQuerygetWorkspaceFolderContextArgs = {
  arg?: Maybe<IArg_Input>;
};


export type IQuerygetWorkspaceValueArgs = {
  value?: Maybe<IWorkspaceValue_Input>;
};


export type IQueryreadStreamTextFileArgs = {
  resource: Scalars['URI'];
  options?: Maybe<IReadTextFileOptions_Input>;
};


export type IQueryreadStringStreamTextFileArgs = {
  resource: Scalars['URI'];
  options?: Maybe<IReadTextFileOptions_Input>;
};


export type IQueryreadTextFileArgs = {
  resource: Scalars['URI'];
  options?: Maybe<IReadTextFileOptions_Input>;
};
...
export type IQueryresolveContentArgs = {
  resource: Scalars['URI'];
  options?: Maybe<IReadFileOptions_Input>;
};


export type IQueryresolveContentsArgs = {
  toResolve?: Maybe<Array<Maybe<IResolveAll_toResolveWithMetadata_Input>>>;
};


export type IQueryresolveFileArgs = {
  resource: Scalars['URI'];
  options?: Maybe<IResolveMetadataFileOptions_Input>;
};


export type IQueryresolveFileContentArgs = {
  resource: Scalars['URI'];
  options?: Maybe<ILoadOptions_Input>;
};


export type IQueryresolveUntitledFileContentArgs = {
  resource: Scalars['URI'];
};


export type IQuerysettingsSubjectArgs = {
  id: Scalars['ID'];
};


export type IQueryshowDialogArgs = {
  dialog?: Maybe<IDialog_input>;
};
...
export type IQuerystatusbarItemArgs = {
  id?: Maybe<Scalars['String']>;
};


export type IQuerytextSearchArgs = {
  query?: Maybe<ITextQueryInput>;
};
...
export const enum IQueryType {
  File = 'File',
  Text = 'Text'
};

export type IQuickInput = {
...
export type IQuickPickItemHighlights = {
...
export type IQuickPickItemHighlights_input = {
...
export type IReadFileOptions_Input = {
  /**
...
export type IRemoveEditor_Input = {
  editorId?: Maybe<Scalars['Int']>;
  resource?: Maybe<Scalars['String']>;
  name?: Maybe<Scalars['String']>;
};

export type IReplaceContentResult = {
...
export type IResolveAll_toResolve_Input = {
  resource?: Maybe<Scalars['URI']>;
  options?: Maybe<IResolveFileOptions_Input>;
};

export type IResolveAll_toResolveWithMetadata_Input = {
  resource?: Maybe<Scalars['URI']>;
  options?: Maybe<IResolveMetadataFileOptions_Input>;
};

export type IResolveFileOptions_Input = {
  /**
...
export type IResolveFileResult = {
...
export type IResolveFileResultWithMetadata = {
...
export type IResolveMetadataFileOptions_Input = {
  resolveTo?: Maybe<Array<Maybe<Scalars['URI']>>>;
  resolveSingleChildDescendants?: Maybe<Scalars['Boolean']>;
  resolveMetadata?: Maybe<Scalars['Boolean']>;
};
...
export type IResourceDiff_Input = {
  options?: Maybe<ITextEditorOptions_Input>;
  label?: Maybe<Scalars['String']>;
  description?: Maybe<Scalars['String']>;
  forceFile?: Maybe<Scalars['Boolean']>;
 ...
 * code editor model.
 */
export type IResourceEditorInput = IIEditorInput & IIEditorInputWithGroupFields & {
...
export type IResourceEncoding = {
   __typename?: 'ResourceEncoding';
  encoding?: Maybe<Scalars['String']>;
  hasBOM?: Maybe<Scalars['Boolean']>;
};

export type IResourceMapConfigurationModel = {
...
/** Extends BaseResource_Input */
export type IResourceSideBySide_Input = {
  options?: Maybe<ITextEditorOptions_Input>;
  label?: Maybe<Scalars['String']>;
  description?: Maybe<Scalars['String']>;
  forceFile?: Maybe<Scalars['Boolean']>;
...
export type IRunActionInWindowRequest = {
...
export const enum IRunActionInWindowRequestFrom {
  menu = 'menu',
  touchbar = 'touchbar',
  mouse = 'mouse'
};

export type IRunKeybindingInWindowRequest = {
...
export type ISaveOptions_Input = {
  force?: Maybe<Scalars['Boolean']>;
...
export type ISaveWorkspaceRes = {
   __typename?: 'SaveWorkspaceRes';
  updated?: Maybe<Scalars['Boolean']>;
  id?: Maybe<Scalars['String']>;
};

export const enum IscmProviders {
  git = 'git'
};

export const enum IscmResourceGroups {
...
export type ISearchComplete = IISearchCompleteStats & {
...
export type ISearchCompleteStatsStats = IFileSearchStats | ITextSearchStats;

export type ISearchCompleteStream = {
...
export type ISearchEngineStats = {
...
export type ISearchPathPattern = {
   __typename?: 'SearchPathPattern';
  searchPath?: Maybe<Scalars['URI']>;
  pattern?: Maybe<Scalars['String']>;
};

export type ISearchProgressItem = IIFileMatch & IISearchProgress & {
...
export type ISearchStreamInput = {
  _reason?: Maybe<Scalars['String']>;
  folderQueries?: Maybe<Array<Maybe<IFolderQueryInput>>>;
  includePattern?: Maybe<Scalars['AnyObject']>;
  excludePattern?: Maybe<Scalars['AnyObject']>;
...
export type ISelectEditor_Input = {
  resource: Scalars['String'];
  editorId?: Maybe<Scalars['Int']>;
  name?: Maybe<Scalars['String']>;
};

export type ISelectedOutput = {
...
export type ISelectionStatus = IIStatusbarItem & {
...
export type ISetStatusMsg_input = {
  id: Scalars['String'];
  message: Scalars['String'];
};
...
export type ISettingsSubject = IUserSettings | ILocalUserSettings | IRemoteUserSettings | IFolderSettings | IGlobalSettings | IWorkspaceSettings | IMemorySettings | IDefaultSettings;
...
export type ISideBySideEditorInput = IIEditorInput & IIEditorInputWithGroupFields & IISideBySideEditorInput & {
...
export const enum ISTATUSBAR_ITEM_ID {
  TERMINAL = 'TERMINAL',
...
export const enum IStatusbarAlignment {
  LEFT = 'LEFT',
  RIGHT = 'RIGHT'
};

export type IStatusbarEntry = {
...
export type IStatusbarEntry_input = {
  showTabsButtons?: Maybe<Scalars['Boolean']>;
  showIcons?: Maybe<Scalars['Boolean']>;
  showStatusbar?: Maybe<Scalars['Boolean']>;
  text: Scalars['String'];
...
export type IStatusbarItem = ITerminal | ISelectionStatus | IIndentation | IEncodingStatus | IEndOfLineSequence | ILanguageMode | ISyncStatus | IBranchStatus;

export const enum IStorageScope {
...
export type ISubscriptionfileDataArgs = {
  resource: Scalars['URI'];
};


export type ISubscriptionfileOperationArgs = {
  resource: Scalars['URI'];
};


export type ISubscriptionreadStreamTextFileArgs = {
  resource: Scalars['URI'];
};


export type ISubscriptionreadStreamTextStringArgs = {
  resource: Scalars['URI'];
};


export type ISubscriptionsearchStreamContentArgs = {
  input?: Maybe<Scalars['AnyObject']>;
};

export type ISyncStatus = IIStatusbarItem & {
...
export type ITerminal = IIStatusbarItem & {
   __typename?: 'Terminal';
  alignment?: Maybe<IStatusbarAlignment>;
  container?: Maybe<Scalars['String']>;
  entry?: Maybe<IStatusbarEntry>;
...
export type ITextEditorOptions_Input = {
  /**
   * Tells the editor to not receive keyboard focus when the editor is being opened. 
   * 
   * Will also not activate the group the editor opens in unless the group is already
...
export type ITextEditorSelection_Input = {
...
export const enum ITextEditorSelectionRevealType {
...
export type ITextFileContent = IIBaseStat & IIBaseStatWithMetadata & IIBaseTextFileContent & IIFileClientMetadata & {
...
export const enum ITextFileOperationResult {
  FILE_IS_BINARY = 'FILE_IS_BINARY'
};

export type ITextFilePublishContent = IIBaseTextFileContent & IIBaseStat & {
...
export type ITextFileStreamContent = IIBaseTextFileContent & IIBaseStatWithMetadata & IIBaseStat & {
...
export type ITextSearchContext = {
...
export const enum ITreeItemCollapsibleState {
  None = 'None',
  Collapsed = 'Collapsed',
  Expanded = 'Expanded'
};

export type ITreeViewDescriptor = IIViewDescriptor & {
...
export type IUntitledEditorInput = IIEditorInput & IIEditorInputWithGroupFields & {
...
export type IUntitledResource_Input = {
  options?: Maybe<ITextEditorOptions_Input>;
  label?: Maybe<Scalars['String']>;
  description?: Maybe<Scalars['String']>;
  forceFile?: Maybe<Scalars['Boolean']>;
...
export type IUpdateDelayedResource = {
   __typename?: 'UpdateDelayedResource';
  resource?: Maybe<Scalars['URI']>;
};

export type IUpdatedResource = {
   __typename?: 'UpdatedResource';
  resource?: Maybe<Scalars['URI']>;
  etag?: Maybe<Scalars['String']>;
};

export type IUpdateEntry_input = {
  id?: Maybe<Scalars['String']>;
  alignment?: Maybe<Scalars['String']>;
  entry?: Maybe<IStatusbarEntry_input>;
  priority?: Maybe<Scalars['Int']>;
...
export type IUserPreferencesRes = {
...
export type IViewDescriptor = IIViewDescriptor & {
...
export type IWatchOptions_Input = {
  recursive?: Maybe<Scalars['Boolean']>;
  excludes?: Maybe<Array<Maybe<Scalars['String']>>>;
  session?: Maybe<Scalars['String']>;
};

export type IWindowConfiguration = {
...
export const enum IWorkspaceContextServiceAction {
...
export type IWorkspaceData = IIStaticWorkspaceData & {
...
export type IWorkspaceFolderData = {
...
export type IWorkspacePreferenceSideBar = {
   __typename?: 'WorkspacePreferenceSideBar';
  location?: Maybe<Scalars['String']>;
};

export type IWorkspacePreferenceStatusBar = {
   __typename?: 'WorkspacePreferenceStatusBar';
  visible?: Maybe<Scalars['Boolean']>;
};

export type IWorkspacePreferenceTips = {
...
export type IWorkspaceRes = {
   __typename?: 'WorkspaceRes';
  uri?: Maybe<Scalars['String']>;
};

export type IWorkspaceSettings = IISettingsSubject & {
...
export type IWorkspaceStackSettings = {
   __typename?: 'WorkspaceStackSettings';
  dummy?: Maybe<Scalars['Int']>;
};

export type IWorkspaceToOpen = {
   __typename?: 'WorkspaceToOpen';
  workspaceUri: Scalars['URI'];
  label?: Maybe<Scalars['String']>;
};

export type IWorkspaceValue_Input = {
  section?: Maybe<Scalars['String']>;
  overrides?: Maybe<IConfigurationOverrides_Input>;
};

export type IWriteFileOptions_Input = {
...
export type IWriteTextFileOptions_Input = {
  mtime?: Maybe<Scalars['BigInt']>;
  etag?: Maybe<Scalars['String']>;
...
export type IinstallMutationVariables = {
  vsix: Scalars['String'];
};
...
export type IproviderDefinitionMutationVariables = {
  params?: Maybe<ITextDocumentPositionParamsInput>;
};
...
export type IremoveMutationVariables = {
  id: Scalars['String'];
};
...
export type IExtensionsByLimitQueryVariables = {
  first: Scalars['Int'];
...
export type IExtensionsQueryVariables = {};


export type IExtensionsQuery = (
  { __typename?: 'Query' }
  & { extensions: (
    { __typename?: 'RegistryExtensionConnection' }
    & { nodes: Array<(
...
export type IgalleryExtensionQueryVariables = {
  extensionID: Scalars['String'];
};
...
export type IgalleryQueryVariables = {
  query?: Maybe<IGalleryQuery>;
};
...
export type IinstalledExtensionsQueryVariables = {};
...
export type IViewerSettingsQueryVariables = {};


export type IViewerSettingsQuery = (
  { __typename?: 'Query' }
  & { viewerSettings: (
    { __typename?: 'SettingsCascade' }
...
export type IDefaultSettingFragment = (
  { __typename?: 'Setting' }
...
export type IFilesConfigurationFragment = (
  { __typename?: 'Files' }
...
export type IGitConfigurationFragment = (
  { __typename?: 'Git' }
...
export type ILanguagesConfigurationFragment = (
  { __typename?: 'Languages' }
  & Pick<ILanguages, 'go' | 'css' | 'html' | 'json' | 'yaml' | 'typescript' | 'javascript'>
);

export type ISearchConfigurationFragment = (
  { __typename?: 'Search' }
...
export type ISettingRangeFragment = (
  { __typename?: 'Range' }
...
export type ITerminalConfigurationFragment = (
  { __typename?: 'Terminal' }
  & { integrated?: Maybe<(
    { __typename?: 'Integrated' }
...
export type IViewerSettingsFragment = (
  { __typename?: 'SettingsCascade' }
  & Pick<ISettingsCascade, 'final'>
  ...
  ) | { __typename?: 'LocalUserSettings' } | { __typename?: 'RemoteUserSettings' } | (
    { __typename?: 'FolderSettings' }
  ...
  ) | { __typename?: 'WorkspaceSettings' } | { __typename?: 'MemorySettings' } | { __typename?: 'DefaultSettings' }>>> }
);

export type IWorkspaceConfigurationFragment = (
  { __typename?: 'WorkspacePreferenceWorkbench' }
...
export type IGetConfigurationTargetMutationVariables = {
  resource?: Maybe<Scalars['URI']>;
};


export type IGetConfigurationTargetMutation = (
  { __typename?: 'Mutation' }
  & Pick<IMutation, 'getConfigurationTarget'>
);

export type IOpenGlobalKeybindingsSettingsMutationVariables = {
  textual?: Maybe<Scalars['Boolean']>;
};


export type IOpenGlobalKeybindingsSettingsMutation = (
  { __typename?: 'Mutation' }
  & Pick<IMutation, 'openGlobalKeybindingSettings'>
);

export type IOpenPreferenceSettingsMutationVariables = {
  jsonEditor?: Maybe<Scalars['Boolean']>;
  query?: Maybe<Scalars['String']>;
};


export type IOpenPreferenceSettingsMutation = (
  { __typename?: 'Mutation' }
  & Pick<IMutation, 'openPreferenceSettings'>
);

export type IResetSettingMutationVariables = {
  resource?: Maybe<Scalars['URI']>;
  settingKey?: Maybe<Scalars['String']>;
};


export type IResetSettingMutation = (
  { __typename?: 'Mutation' }
  & Pick<IMutation, 'resetSetting'>
);

export type IsaveUserSettingsMutationVariables = {
  content?: Maybe<Scalars['String']>;
};


export type IsaveUserSettingsMutation = (
  { __typename?: 'Mutation' }
...
export type IsaveWorkspaceSettingsMutationVariables = {};


export type IsaveWorkspaceSettingsMutation = (
  { __typename?: 'Mutation' }
...
export type ISwitchSettingsMutationVariables = {
  target?: Maybe<Scalars['Int']>;
  editorId?: Maybe<Scalars['Int']>;
  resource?: Maybe<Scalars['URI']>;
  jsonEditor?: Maybe<Scalars['Boolean']>;
...
export type ISwitchSettingsMutation = (
  { __typename?: 'Mutation' }
  & Pick<IMutation, 'switchSettings'>
);

export type IDefaultPreferencesQueryVariables = {};


export type IDefaultPreferencesQuery = (
  { __typename?: 'Query' }
...
export type IDefaultSettingsQueryVariables = {
  target?: Maybe<Scalars['Int']>;
};
...
export type IFullConfigurationQueryVariables = {};


export type IFullConfigurationQuery = (
  { __typename?: 'Query' }
  & { viewerSettings: (
    { __typename?: 'SettingsCascade' }
    & Pick<ISettingsCascade, 'final'>
    ...
    ) | { __typename?: 'MemorySettings' } | { __typename?: 'DefaultSettings' }>>> }
  ) }
);

export type IGetMostCommonlyUsedSettingsQueryVariables = {};


export type IGetMostCommonlyUsedSettingsQuery = (
  { __typename?: 'Query' }
  & Pick<IQuery, 'getMostCommonlyUsedSettings'>
);

export type IWorkspacesQueryVariables = {};


export type IWorkspacesQuery = (
  { __typename?: 'Query' }
...
export type IFinalConfigurationFragment = (
  { __typename?: 'Configuration' }
  & { terminal?: Maybe<(
    { __typename?: 'Terminal' }
    & ITerminalConfigurationFragment
...
export type IKeybindingItemFragment = (
  { __typename?: 'KeybindingItem' }
  & Pick<IKeybindingItem, 'command' | 'key' | 'when' | 'source'>
);

export type IKeybindingsFragment = (
  { __typename?: 'Keybindings' }
...
type IstatusbarItem_SelectionStatus_Fragment = (
  { __typename?: 'SelectionStatus' }
...
type IstatusbarItem_Indentation_Fragment = (
  { __typename?: 'Indentation' }
...
type IstatusbarItem_EncodingStatus_Fragment = (
  { __typename?: 'EncodingStatus' }
...
type IstatusbarItem_EndOfLineSequence_Fragment = (
  { __typename?: 'EndOfLineSequence' }
...
type IstatusbarItem_LanguageMode_Fragment = (
  { __typename?: 'LanguageMode' }
...
type IstatusbarItem_SyncStatus_Fragment = { __typename?: 'SyncStatus' };

type IstatusbarItem_BranchStatus_Fragment = { __typename?: 'BranchStatus' };

export type IstatusbarItemFragment = IstatusbarItem_Terminal_Fragment | IstatusbarItem_SelectionStatus_Fragment | IstatusbarItem_Indentation_Fragment | IstatusbarItem_EncodingStatus_Fragment | IstatusbarItem_EndOfLineSequence_Fragment | IstatusbarItem_LanguageMode_Fragment | IstatusbarItem_SyncStatus_Fragment | IstatusbarItem_BranchStatus_Fragment;

export type IUpdateConfigurationValueMutationVariables = {
  key: Scalars['String'];
  value: Scalars['AnyObject'];
...
export type IUpdateConfigurationValueMutation = (
  { __typename?: 'Mutation' }
  & Pick<IMutation, 'updateConfigurationValue'>
);

export type ICopyMutationVariables = {
  value?: Maybe<Scalars['String']>;
};
...
export type IRunMenuActionMutationVariables = {
  argument?: Maybe<IActionRun_input>;
};
...
export type IHideContextMenuMutationVariables = {};
...
export type IShowContextMenuMutationVariables = {
  delegate?: Maybe<IContextMenu_input>;
};
...
export type ICloseDialogMutationVariables = {};


export type ICloseDialogMutation = (
  { __typename?: 'Mutation' }
  & Pick<IMutation, 'closeDialog'>
);

export type IShowMutationVariables = {
  dialog?: Maybe<IDialog_input>;
};


export type IShowMutation = (
  { __typename?: 'Mutation' }
  & Pick<IMutation, 'show'>
);

export type IOpenEditorResourceInputMutationVariables = {
  editor: IResource_Input;
  group?: Maybe<Scalars['Int']>;
};


export type IOpenEditorResourceInputMutation = (
  { __typename?: 'Mutation' }
  & Pick<IMutation, 'openEditorWithResourceInput'>
);

export type IOpenEditorMutationVariables = {
  content: IOpenEditor_Input;
  options?: Maybe<IEditorOpenOptions_Input>;
};


export type IOpenEditorMutation = (
  { __typename?: 'Mutation' }
  & Pick<IMutation, 'openEditor'>
);

export type IGoToLineMutationVariables = {
  range?: Maybe<ILineRange_input>;
};


export type IGoToLineMutation = (
  { __typename?: 'Mutation' }
  & Pick<IMutation, 'gotoLine'>
);

export type IHighlightLineMutationVariables = {
  range?: Maybe<ILineRange_input>;
};


export type IHighlightLineMutation = (
  { __typename?: 'Mutation' }
  & Pick<IMutation, 'highlightLine'>
);

export type IJsonEditingWriteMutationVariables = {
  resource?: Maybe<Scalars['URI']>;
  value?: Maybe<IIJSONValue_input>;
  save?: Maybe<Scalars['Boolean']>;
};
...
export type IJsonEditingWriteMutation = (
  { __typename?: 'Mutation' }
  & Pick<IMutation, 'jsonWrite'>
);

export type IChangeKeybindingMutationVariables = {
  editItem?: Maybe<IKeybindingItem_input>;
  selectedIndex?: Maybe<Scalars['Int']>;
  isOpenDialog?: Maybe<Scalars['Boolean']>;
};
...
export type IChangeKeybindingMutation = (
  { __typename?: 'Mutation' }
  & Pick<IMutation, 'changeKeybinding'>
);

export type IChangeWhenExpressionMutationVariables = {
  editItem?: Maybe<IKeybindingItem_input>;
  editWhenIndex?: Maybe<Scalars['Int']>;
  newWhen?: Maybe<Scalars['String']>;
};
...
export type IChangeWhenExpressionMutation = (
  { __typename?: 'Mutation' }
  & Pick<IMutation, 'changeWhenExpression'>
);

export type IEditKeybindingMutationVariables = {
  keybindingItem?: Maybe<IKeybindingItem_input>;
  key?: Maybe<Scalars['String']>;
  when?: Maybe<Scalars['String']>;
};
...
export type IEditKeybindingMutation = (
  { __typename?: 'Mutation' }
  & Pick<IMutation, 'editKeybinding'>
);

export type IHideKeybindingDialogMutationVariables = {};


export type IHideKeybindingDialogMutation = (
  { __typename?: 'Mutation' }
  & Pick<IMutation, 'hideKeybindingDialog'>
);

export type ILookupKeybindingMutationVariables = {
  commandId?: Maybe<Scalars['String']>;
};


export type ILookupKeybindingMutation = (
  { __typename?: 'Mutation' }
  & Pick<IMutation, 'lookupKeybinding'>
);

export type IregisterKeybindingMutationVariables = {
  keybinding?: Maybe<IKeybinding_input>;
};


export type IregisterKeybindingMutation = (
  { __typename?: 'Mutation' }
  & Pick<IMutation, 'registerKeybinding'>
);

export type IRemoveKeybindingMutationVariables = {
  keybindingItem?: Maybe<IKeybindingItem_input>;
};


export type IRemoveKeybindingMutation = (
  { __typename?: 'Mutation' }
  & Pick<IMutation, 'removeKeybinding'>
);

export type IResetKeybindingMutationVariables = {
  keybindingItem?: Maybe<IKeybindingItem_input>;
};


export type IResetKeybindingMutation = (
  { __typename?: 'Mutation' }
  & Pick<IMutation, 'resetKeybinding'>
);

export type IResolveKeyboardEventMutationVariables = {
  keyboardEvent?: Maybe<IKeyboardEvent_input>;
};


export type IResolveKeyboardEventMutation = (
  { __typename?: 'Mutation' }
...
export type ISearchKeybindingMutationVariables = {
  value?: Maybe<Scalars['String']>;
};


export type ISearchKeybindingMutation = (
  { __typename?: 'Mutation' }
  & Pick<IMutation, 'searchKeybinding'>
);

export type ISetSelectedKeybindingIndexMutationVariables = {
  index?: Maybe<Scalars['Int']>;
};


export type ISetSelectedKeybindingIndexMutation = (
  { __typename?: 'Mutation' }
  & Pick<IMutation, 'setSelectedKeybindingIndex'>
);

export type IStopEditWhenExpressionMutationVariables = {};


export type IStopEditWhenExpressionMutation = (
  { __typename?: 'Mutation' }
  & Pick<IMutation, 'stopEditWhenExpression'>
);

export type IAddNotificationMutationVariables = {
  notification?: Maybe<INotification_input>;
};


export type IAddNotificationMutation = (
  { __typename?: 'Mutation' }
  & Pick<IMutation, 'addNotification'>
);

export type ICloseNotificationMutationVariables = {
  index?: Maybe<Scalars['Int']>;
};


export type ICloseNotificationMutation = (
  { __typename?: 'Mutation' }
  & Pick<IMutation, 'closeNotification'>
);

export type IHandlerMutationVariables = {
  arg?: Maybe<IActionRun_input>;
};


export type IHandlerMutation = (
  { __typename?: 'Mutation' }
  & Pick<IMutation, 'handler'>
);

export type IOpenEditorFileMutationVariables = {
  content: IOpenEditor_Input;
  options?: Maybe<IEditorOpenOptions_Input>;
};


export type IOpenEditorFileMutation = (
  { __typename?: 'Mutation' }
  & Pick<IMutation, 'openFile'>
);

export type IHideInputModelMutationVariables = {};


export type IHideInputModelMutation = (
  { __typename?: 'Mutation' }
  & Pick<IMutation, 'hideInputModel'>
);

export type ISetSelectedMutationVariables = {
  selectedValue?: Maybe<Array<Maybe<IPickItem>>>;
  inputValue?: Maybe<Scalars['String']>;
};


export type ISetSelectedMutation = (
  { __typename?: 'Mutation' }
  & Pick<IMutation, 'setSelected'>
);

export type IShowInputMutationVariables = {
  options?: Maybe<IInputOptions>;
};


export type IShowInputMutation = (
  { __typename?: 'Mutation' }
  & Pick<IMutation, 'showInput'>
);

export type IShowPickInputMutationVariables = {
  items?: Maybe<Array<Maybe<IPickItem>>>;
  options?: Maybe<IPickInputOptions>;
};


export type IShowPickInputMutation = (
  { __typename?: 'Mutation' }
  & Pick<IMutation, 'showPickInput'>
);

export type IAddEntryMutationVariables = {
  arg?: Maybe<IAddEntry_input>;
};


export type IAddEntryMutation = (
  { __typename?: 'Mutation' }
  & Pick<IMutation, 'addEntry'>
);

export type IRemoveStatusbarEntryMutationVariables = {
  id: Scalars['ID'];
};


export type IRemoveStatusbarEntryMutation = (
  { __typename?: 'Mutation' }
  & Pick<IMutation, 'removeStatusbarEntry'>
);

export type ISetStatusMessageMutationVariables = {
  arg?: Maybe<ISetStatusMsg_input>;
};


export type ISetStatusMessageMutation = (
  { __typename?: 'Mutation' }
  & Pick<IMutation, 'setStatusMessage'>
);

export type IUpdateStatusbarEntryMutationVariables = {
  arg?: Maybe<IUpdateEntry_input>;
};


export type IUpdateStatusbarEntryMutation = (
  { __typename?: 'Mutation' }
  & Pick<IMutation, 'updateStatusbarEntry'>
);

export type IAddFoldersMutationVariables = {
  folders?: Maybe<Array<Maybe<IFolder_input>>>;
  index?: Maybe<Scalars['Int']>;
};


export type IAddFoldersMutation = (
  { __typename?: 'Mutation' }
  & Pick<IMutation, 'addFolders'>
);

export type IChangeWorkspaceMutationVariables = {
  args?: Maybe<IArgs_input>;
};


export type IChangeWorkspaceMutation = (
  { __typename?: 'Mutation' }
  & Pick<IMutation, 'changeWorkspace'>
);

export type IRemoveFoldersMutationVariables = {
  folders?: Maybe<Array<Maybe<Scalars['URI']>>>;
};


export type IRemoveFoldersMutation = (
  { __typename?: 'Mutation' }
  & Pick<IMutation, 'removeFolders'>
);

export type IUpdateFoldersMutationVariables = {
  foldersToAdd?: Maybe<Array<Maybe<IFolder_input>>>;
  foldersToRemove?: Maybe<Array<Maybe<Scalars['URI']>>>;
  index?: Maybe<Scalars['Int']>;
};
...
export type IUpdateFoldersMutation = (
  { __typename?: 'Mutation' }
  & Pick<IMutation, 'updateFolders'>
);

export type IFinalConfiguration_WSQueryVariables = {};


export type IFinalConfiguration_WSQuery = (
  { __typename?: 'Query' }
  & { viewerSettings: (
    { __typename?: 'SettingsCascade' }
    & { finalConfiguration?: Maybe<(
...
export type IGetContextQueryVariables = {};


export type IGetContextQuery = (
  { __typename?: 'Query' }
...
export type IContextMenuQueryVariables = {};
...
export type IDialogQueryVariables = {};


export type IDialogQuery = (
  { __typename?: 'Query' }
  & { dialog?: Maybe<(
    { __typename?: 'Dialog' }
...
export type IshowDialogQueryVariables = {
  dialog?: Maybe<IDialog_input>;
};


export type IshowDialogQuery = (
  { __typename?: 'Query' }
  & { showDialog?: Maybe<(
    { __typename?: 'DialogResult' }
...
export type IGoToLineQuickAccessQueryVariables = {};


export type IGoToLineQuickAccessQuery = (
  { __typename?: 'Query' }
...
export type IGetKeybindingsQueryVariables = {};


export type IGetKeybindingsQuery = (
  { __typename?: 'Query' }
...
export type IKeybindingContextMenuQueryVariables = {};


export type IKeybindingContextMenuQuery = (
  { __typename?: 'Query' }
...
export type IKeybindingsQueryVariables = {};


export type IKeybindingsQuery = (
  { __typename?: 'Query' }
  & { keybindings?: Maybe<(
    { __typename?: 'Keybindings' }
    & { items?: Maybe<Array<Maybe<(
...
export type INotificationsQueryVariables = {};
...
export type IshowNotificationQueryVariables = {
  notification?: Maybe<INotification_input>;
};
...
export type IGetSelectedValueQueryVariables = {};


export type IGetSelectedValueQuery = (
  { __typename?: 'Query' }
...
export type IQuickInputModelQueryVariables = {};


export type IQuickInputModelQuery = (
  { __typename?: 'Query' }
  & { quickInputModel?: Maybe<(
    { __typename?: 'QuickInputModel' }
...
export type IStatusbarQueryVariables = {};


export type IStatusbarQuery = (
  { __typename?: 'Query' }
  & { statusbar?: Maybe<(
    { __typename?: 'Statusbar' }
    & { items?: Maybe<Array<Maybe<(
...
export type IStatusbarItemQueryVariables = {
  id?: Maybe<Scalars['String']>;
};


export type IStatusbarItemQuery = (
  { __typename?: 'Query' }
  & { statusbarItem?: Maybe<(
    { __typename?: 'Terminal' }
    & Pick<ITerminal, 'id' | 'name' | 'alignment' | 'priority' | 'typeId'>
...
export type IGetViewsQueryVariables = {
  containerId: Scalars['String'];
};


export type IGetViewsQuery = (
  { __typename?: 'Query' }
...
export type IGetWorkspaceQuery = (
  { __typename?: 'Query' }
  & { getWorkspace?: Maybe<(
    { __typename?: 'WorkspaceData' }
...
export type IGetConfigurationDataFragment = (
  { __typename?: 'ConfigurationData' }
  & { defaults?: Maybe<(
    { __typename?: 'ConfigurationModel' }
...
export type IINotificationMessageFragment = (
  { __typename?: 'NotificationMessage' }
...
export type INotificationMessageFragment = (
  { __typename?: 'NotificationMessage' }
  & { original?: Maybe<(
    { __typename?: 'NotificationMessage' }
...
export type INotificationFragment = (
  { __typename?: 'Notification' }
...
export type INotifyActionFragment = (
  { __typename?: 'Action' }
  & Pick<IAction, 'id' | 'label' | 'tooltip' | 'class' | 'enabled' | 'checked' | 'radio'>
);

export type IWorkspaceFolderFragment = (
  { __typename?: 'WorkspaceFolderData' }
  & Pick<IWorkspaceFolderData, 'uri' | 'name' | 'index'>
);

export type INotifyErrorMutationVariables = {
  message?: Maybe<Array<Maybe<INotificationMessage_input>>>;
};


export type INotifyErrorMutation = (
  { __typename?: 'Mutation' }
  & Pick<IMutation, 'notifyError'>
);

export type INotifyInfoMutationVariables = {
  message?: Maybe<Array<Maybe<INotificationMessage_input>>>;
};


export type INotifyInfoMutation = (
  { __typename?: 'Mutation' }
  & Pick<IMutation, 'notifyInfo'>
);

export type INotifyPromptMutationVariables = {
...
export type INotifyPromptMutation = (
  { __typename?: 'Mutation' }
  & Pick<IMutation, 'notifyPrompt'>
);

export type INotifyWarnMutationVariables = {
  message?: Maybe<Array<Maybe<INotificationMessage_input>>>;
};


export type INotifyWarnMutation = (
  { __typename?: 'Mutation' }
  & Pick<IMutation, 'notifyWarn'>
);

export type INotifyMutationVariables = {
  notification?: Maybe<INotification_input>;
};


export type INotifyMutation = (
  { __typename?: 'Mutation' }
  & Pick<IMutation, 'notify'>
);

export type IUpdateWorkspaceContextAddFoldersMutationVariables = {
  foldersToAdd?: Maybe<Array<Maybe<IFoldersToAdd_Input>>>;
  index?: Maybe<Scalars['Int']>;
};


export type IUpdateWorkspaceContextAddFoldersMutation = (
  { __typename?: 'Mutation' }
...
export type IUpdateWorkspaceContextRemoveFoldersMutationVariables = {
  foldersToRemove?: Maybe<Array<Maybe<Scalars['URI']>>>;
};


export type IUpdateWorkspaceContextRemoveFoldersMutation = (
  { __typename?: 'Mutation' }
...
export type IUpdateWorkspaceContextUpdateFoldersMutationVariables = {
  foldersToAdd?: Maybe<Array<Maybe<IFoldersToAdd_Input>>>;
  foldersToRemove?: Maybe<Array<Maybe<Scalars['URI']>>>;
  index?: Maybe<Scalars['Int']>;
};
...
export type IUpdateWorkspaceContextUpdateFoldersMutation = (
  { __typename?: 'Mutation' }
...
export type IGetConfiguration_WSQueryVariables = {};


export type IGetConfiguration_WSQuery = (
  { __typename?: 'Query' }
...
export type IGetEnvironment_WSQueryVariables = {};


export type IGetEnvironment_WSQuery = (
  { __typename?: 'Query' }
...
export type IGetWorkspace_WSQueryVariables = {};


export type IGetWorkspace_WSQuery = (
  { __typename?: 'Query' }
  & { getWorkspace?: Maybe<(
    { __typename?: 'WorkspaceData' }
    & Pick<IWorkspaceData, 'id' | 'name' | 'configuration'>
...
export type IGetWorkspaceValue_WSQueryVariables = {
  value?: Maybe<IWorkspaceValue_Input>;
};


export type IGetWorkspaceValue_WSQuery = (
  { __typename?: 'Query' }
  & Pick<IQuery, 'getWorkspaceValue'>
);

export type IAddServerNotificationMutationVariables = {
  notification?: Maybe<INotification_input>;
};


export type IAddServerNotificationMutation = (
  { __typename?: 'Mutation' }
  & Pick<IMutation, 'addNotification'>
);

export type IGetWorkspaceFolderContextQueryVariables = {
  arg?: Maybe<IArg_Input>;
};


export type IGetWorkspaceFolderContextQuery = (
  { __typename?: 'Query' }
...
export type ICodeLenseProviderDefinitionMutationVariables = {
  params?: Maybe<ITextDocumentPositionParamsInput>;
};


export type ICodeLenseProviderDefinitionMutation = (
  { __typename?: 'Mutation' }
  & Pick<IMutation, 'codeLenseProviderDefinition'>
);

export type ICompletionProviderDefinitionMutationVariables = {
  params?: Maybe<ITextDocumentPositionParamsInput>;
};


export type ICompletionProviderDefinitionMutation = (
  { __typename?: 'Mutation' }
  & Pick<IMutation, 'completionProviderDefinition'>
);

export type IDefinitionDefinitionMutationVariables = {
  params?: Maybe<ITextDocumentPositionParamsInput>;
};


export type IDefinitionDefinitionMutation = (
  { __typename?: 'Mutation' }
  & Pick<IMutation, 'definitionDefinition'>
);

export type IDocumentHighLightProviderDefinitionMutationVariables = {
  params?: Maybe<ITextDocumentPositionParamsInput>;
};


export type IDocumentHighLightProviderDefinitionMutation = (
  { __typename?: 'Mutation' }
  & Pick<IMutation, 'documentHighLightProviderDefinition'>
);

export type IDocumentFormattingProviderDefinitionMutationVariables = {
  params?: Maybe<ITextDocumentPositionParamsInput>;
};


export type IDocumentFormattingProviderDefinitionMutation = (
  { __typename?: 'Mutation' }
  & Pick<IMutation, 'documentFormattingProviderDefinition'>
);

export type IHoverProviderDefinitionMutationVariables = {
  params?: Maybe<ITextDocumentPositionParamsInput>;
};


export type IHoverProviderDefinitionMutation = (
  { __typename?: 'Mutation' }
  & Pick<IMutation, 'hoverProviderDefinition'>
);

export type IOpenLanguageDocumentMutationVariables = {
  document?: Maybe<IOpenDocumentParamsInput>;
};


export type IOpenLanguageDocumentMutation = (
  { __typename?: 'Mutation' }
  & Pick<IMutation, 'openLanguageDocument'>
);

export type IReferenceProviderDefinitionMutationVariables = {
  params?: Maybe<ITextDocumentPositionParamsInput>;
};


export type IReferenceProviderDefinitionMutation = (
  { __typename?: 'Mutation' }
  & Pick<IMutation, 'referenceProviderDefinition'>
);

export type IRenameDefinitionMutationVariables = {
  params?: Maybe<ITextDocumentPositionParamsInput>;
};


export type IRenameDefinitionMutation = (
  { __typename?: 'Mutation' }
  & Pick<IMutation, 'renameDefinition'>
);

export type IDocumentSymbolDefinitionMutationVariables = {
  params?: Maybe<ITextDocumentPositionParamsInput>;
};


export type IDocumentSymbolDefinitionMutation = (
  { __typename?: 'Mutation' }
  & Pick<IMutation, 'documentSymbolDefinition'>
);

export type IUpdateModelMutationVariables = {
  model?: Maybe<IIModelInput>;
};


export type IUpdateModelMutation = (
  { __typename?: 'Mutation' }
...
export type IResolversTypes = {
  ...
  EditorPart: ResolverTypeWrapper<Omit<IEditorPart, 'children'> & { children?: Maybe<Array<Maybe<IResolversTypes['EditorChildren']>>> }>,
  GroupOrientation: GroupOrientation,
  EditorChildren: IResolversTypes['EditorPart'] | IResolversTypes['EditorGroup'],
  EditorGroup: ResolverTypeWrapper<Omit<IEditorGroup, 'tabs'> & { tabs?: Maybe<Array<Maybe<IResolversTypes['EditorInput']>>> }>,
  ...
  DiffEditorInput: ResolverTypeWrapper<Omit<IDiffEditorInput, 'originalInput' | 'modifiedInput'> & { originalInput?: Maybe<IResolversTypes['EditorInput']>, modifiedInput?: Maybe<IResolversTypes['EditorInput']> }>,
  ...
  PreferencesEditorInput: ResolverTypeWrapper<Omit<IPreferencesEditorInput, 'master' | 'details'> & { master?: Maybe<IResolversTypes['EditorInput']>, details?: Maybe<IResolversTypes['EditorInput']> }>,
  ...
  SideBySideEditorInput: ResolverTypeWrapper<Omit<ISideBySideEditorInput, 'master' | 'details'> & { master?: Maybe<IResolversTypes['EditorInput']>, details?: Maybe<IResolversTypes['EditorInput']> }>,
  ...
  SearchComplete: ResolverTypeWrapper<Omit<ISearchComplete, 'stats'> & { stats: IResolversTypes['SearchCompleteStatsStats'] }>,
  ...
  FileSearchStats: ResolverTypeWrapper<Omit<IFileSearchStats, 'detailStats'> & { detailStats?: Maybe<IResolversTypes['FileSearchStatsdetailStats']> }>,
  ...
  FileMatch: ResolverTypeWrapper<Omit<IFileMatch, 'results'> & { results?: Maybe<Array<Maybe<IResolversTypes['TextSearchResult']>>> }>,
  ...
  Statusbar: ResolverTypeWrapper<Omit<IStatusbar, 'items'> & { items?: Maybe<Array<Maybe<IResolversTypes['StatusbarItem']>>> }>,
  ...
  SearchCompleteStream: ResolverTypeWrapper<Omit<ISearchCompleteStream, 'stats'> & { stats: IResolversTypes['SearchCompleteStatsStats'] }>,
  ...
  CloseEditorsFilter: ResolverTypeWrapper<Omit<ICloseEditorsFilter, 'except'> & { except?: Maybe<IResolversTypes['EditorInput']> }>,
  ...
  EditorIdentifier: ResolverTypeWrapper<Omit<IEditorIdentifier, 'editor'> & { editor?: Maybe<IResolversTypes['EditorInput']> }>,
  EditorSettings: ResolverTypeWrapper<IEditorSettings>,
  OpenDiff_Input: IOpenDiff_Input,
  DockLayout: ResolverTypeWrapper<Omit<IDockLayout, 'tabs'> & { tabs?: Maybe<Array<Maybe<IResolversTypes['EditorInput']>>> }>,
  ...
  OpenConfiguration: ResolverTypeWrapper<Omit<IOpenConfiguration, 'urisToOpen'> & { urisToOpen?: Maybe<Array<Maybe<IResolversTypes['URIToOpen']>>> }>,
  ...
  SearchProgressItem: ResolverTypeWrapper<Omit<ISearchProgressItem, 'results'> & { results?: Maybe<Array<Maybe<IResolversTypes['TextSearchResult']>>> }>,
...
export type IResolversParentTypes = {
  ...
  EditorPart: Omit<IEditorPart, 'children'> & { children?: Maybe<Array<Maybe<IResolversParentTypes['EditorChildren']>>> },
  GroupOrientation: GroupOrientation,
  EditorChildren: IResolversParentTypes['EditorPart'] | IResolversParentTypes['EditorGroup'],
  EditorGroup: Omit<IEditorGroup, 'tabs'> & { tabs?: Maybe<Array<Maybe<IResolversParentTypes['EditorInput']>>> },
  ...
  DiffEditorInput: Omit<IDiffEditorInput, 'originalInput' | 'modifiedInput'> & { originalInput?: Maybe<IResolversParentTypes['EditorInput']>, modifiedInput?: Maybe<IResolversParentTypes['EditorInput']> },
  ...
  PreferencesEditorInput: Omit<IPreferencesEditorInput, 'master' | 'details'> & { master?: Maybe<IResolversParentTypes['EditorInput']>, details?: Maybe<IResolversParentTypes['EditorInput']> },
  ...
  SideBySideEditorInput: Omit<ISideBySideEditorInput, 'master' | 'details'> & { master?: Maybe<IResolversParentTypes['EditorInput']>, details?: Maybe<IResolversParentTypes['EditorInput']> },
  ...
  URIInput: IURIInput,
  QueryType: IQueryType,
  SearchComplete: Omit<ISearchComplete, 'stats'> & { stats: IResolversParentTypes['SearchCompleteStatsStats'] },
  ...
  FileSearchStats: Omit<IFileSearchStats, 'detailStats'> & { detailStats?: Maybe<IResolversParentTypes['FileSearchStatsdetailStats']> },
  ...
  TextSearchStatsType: ITextSearchStatsType,
  FileMatch: Omit<IFileMatch, 'results'> & { results?: Maybe<Array<Maybe<IResolversParentTypes['TextSearchResult']>>> },
  ...
  NotificationActions_input: INotificationActions_input,
  Action_input: IAction_input,
  Statusbar: Omit<IStatusbar, 'items'> & { items?: Maybe<Array<Maybe<IResolversParentTypes['StatusbarItem']>>> },
  ...
  SearchCompleteStream: Omit<ISearchCompleteStream, 'stats'> & { stats: IResolversParentTypes['SearchCompleteStatsStats'] },
  ...
  MergeGroupOptions_Input: IMergeGroupOptions_Input,
  CloseDirection: CloseDirection,
  CloseEditorsFilter: Omit<ICloseEditorsFilter, 'except'> & { except?: Maybe<IResolversParentTypes['EditorInput']> },
  GroupsOrder: GroupsOrder,
  EditorsOrder: EditorsOrder,
  BaseResourceInput: IBaseResourceInput,
  CloseOptions_Input: ICloseOptions_Input,
  EditorActionType: IEditorActionType,
  EditorIdentifier: Omit<IEditorIdentifier, 'editor'> & { editor?: Maybe<IResolversParentTypes['EditorInput']> },
  EditorSettings: IEditorSettings,
  OpenDiff_Input: IOpenDiff_Input,
  DockLayout: Omit<IDockLayout, 'tabs'> & { tabs?: Maybe<Array<Maybe<IResolversParentTypes['EditorInput']>>> },
  EDITOR_ID: IEDITOR_ID,
  ...
  OpenConfiguration: Omit<IOpenConfiguration, 'urisToOpen'> & { urisToOpen?: Maybe<Array<Maybe<IResolversParentTypes['URIToOpen']>>> },
  ...
  SearchProgressItem: Omit<ISearchProgressItem, 'results'> & { results?: Maybe<Array<Maybe<IResolversParentTypes['TextSearchResult']>>> },
...
export type IActionResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['Action'] = IResolversParentTypes['Action']> = {
...
export type IActionItemResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['ActionItem'] = IResolversParentTypes['ActionItem']> = {
  label?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  description?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type IActionRunResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['ActionRun'] = IResolversParentTypes['ActionRun']> = {
...
export type IActionsResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['Actions'] = IResolversParentTypes['Actions']> = {
  id?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
...
export type IAddFoldersRequestResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['AddFoldersRequest'] = IResolversParentTypes['AddFoldersRequest']> = {
  foldersToAdd?: Resolver<Maybe<Array<Maybe<IResolversTypes['URI']>>>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type IAnchorResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['Anchor'] = IResolversParentTypes['Anchor']> = {
...
export type IArgsTypeResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['ArgsType'] = IResolversParentTypes['ArgsType']> = {
...
export type IAssetsResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['Assets'] = IResolversParentTypes['Assets']> = {
  Type?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  Content?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type IAuthorResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['Author'] = IResolversParentTypes['Author']> = {
  name?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type IBaseExtensionResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['BaseExtension'] = IResolversParentTypes['BaseExtension']> = {
...
export type IBranchStatusResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['BranchStatus'] = IResolversParentTypes['BranchStatus']> = {
  id?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  name?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
...
export type IBundlesResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['Bundles'] = IResolversParentTypes['Bundles']> = {
...
export type ICachedSearchStatsResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['CachedSearchStats'] = IResolversParentTypes['CachedSearchStats']> = {
...
export type IChangeRangeResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['ChangeRange'] = IResolversParentTypes['ChangeRange']> = {
...
export type IChangesChunkResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['ChangesChunk'] = IResolversParentTypes['ChangesChunk']> = {
...
export type ICheckboxOptionsResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['CheckboxOptions'] = IResolversParentTypes['CheckboxOptions']> = {
  label?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  checked?: Resolver<Maybe<IResolversTypes['Boolean']>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type ICloseEditorsFilterResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['CloseEditorsFilter'] = IResolversParentTypes['CloseEditorsFilter']> = {
...
export type ICodeEditorViewStateResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['CodeEditorViewState'] = IResolversParentTypes['CodeEditorViewState']> = {
...
export type ICommandHandlerDescriptionTypeResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['CommandHandlerDescriptionType'] = IResolversParentTypes['CommandHandlerDescriptionType']> = {
  description?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
...
export type ICommandsTypeResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['CommandsType'] = IResolversParentTypes['CommandsType']> = {
  commands?: Resolver<Maybe<Array<Maybe<IResolversTypes['CommandType']>>>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type ICommandTypeResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['CommandType'] = IResolversParentTypes['CommandType']> = {
  id?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
...
export type IConfigurationResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['Configuration'] = IResolversParentTypes['Configuration']> = {
...
export type IConfigurationDataResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['ConfigurationData'] = IResolversParentTypes['ConfigurationData']> = {
...
export type IConfigurationExtensionInfoResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['ConfigurationExtensionInfo'] = IResolversParentTypes['ConfigurationExtensionInfo']> = {
  id?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type IConfigurationModelResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['ConfigurationModel'] = IResolversParentTypes['ConfigurationModel']> = {
...
export type IConfigurationOverridesResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['ConfigurationOverrides'] = IResolversParentTypes['ConfigurationOverrides']> = {
  resource?: Resolver<Maybe<IResolversTypes['URI']>, ParentType, ContextType>,
  overrideIdentifier?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type IContentChangedEventResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['ContentChangedEvent'] = IResolversParentTypes['ContentChangedEvent']> = {
...
export type IContextResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['Context'] = IResolversParentTypes['Context']> = {
...
export type IContextMenuResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['ContextMenu'] = IResolversParentTypes['ContextMenu']> = {
  id?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
...
export type IContributesResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['Contributes'] = IResolversParentTypes['Contributes']> = {
...
export type ICrashReporterStartOptionsResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['CrashReporterStartOptions'] = IResolversParentTypes['CrashReporterStartOptions']> = {
...
export type ICursorStateResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['CursorState'] = IResolversParentTypes['CursorState']> = {
...
export type IDataUriEditorInputResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['DataUriEditorInput'] = IResolversParentTypes['DataUriEditorInput']> = {
  id?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
...
export type IDebuggerResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['Debugger'] = IResolversParentTypes['Debugger']> = {
  label?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  type?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
...
export type IDefaultPreferencesResponseResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['DefaultPreferencesResponse'] = IResolversParentTypes['DefaultPreferencesResponse']> = {
  preferences?: Resolver<Maybe<Array<Maybe<IResolversTypes['PreferencesType']>>>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type IDefaultSettingsResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['DefaultSettings'] = IResolversParentTypes['DefaultSettings']> = {
...
export type IDetailResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['Detail'] = IResolversParentTypes['Detail']> = {
...
export type IDevToolsOptionsResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['DevToolsOptions'] = IResolversParentTypes['DevToolsOptions']> = {
  mode?: Resolver<Maybe<IResolversTypes['DevToolsOptionsMode']>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type IDialogResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['Dialog'] = IResolversParentTypes['Dialog']> = {
...
export type IDialogResultResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['DialogResult'] = IResolversParentTypes['DialogResult']> = {
...
export type IDiffEditorInputResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['DiffEditorInput'] = IResolversParentTypes['DiffEditorInput']> = {
  id?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  resource?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  typeId?: Resolver<Maybe<IResolversTypes['EDITOR_INPUT_ID']>, ParentType, ContextType>,
  description?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
...
export type IDockLayoutResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['DockLayout'] = IResolversParentTypes['DockLayout']> = {
...
export type IDocSitePageResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['DocSitePage'] = IResolversParentTypes['DocSitePage']> = {
...
export type IDocumentFilterResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['DocumentFilter'] = IResolversParentTypes['DocumentFilter']> = {
...
export type IEditKeybindingItemResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['EditKeybindingItem'] = IResolversParentTypes['EditKeybindingItem']> = {
  command?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
...
export type IEditorChildrenResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['EditorChildren'] = IResolversParentTypes['EditorChildren']> = {
  __resolveType: TypeResolveFn<'EditorPart' | 'EditorGroup', ParentType, ContextType>
};

export type IEditorGroupResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['EditorGroup'] = IResolversParentTypes['EditorGroup']> = {
...
export type IEditorGroupLayoutResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['EditorGroupLayout'] = IResolversParentTypes['EditorGroupLayout']> = {
...
export type IEditorIdentifierResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['EditorIdentifier'] = IResolversParentTypes['EditorIdentifier']> = {
...
export type IEditorInputResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['EditorInput'] = IResolversParentTypes['EditorInput']> = {
...
export type IEditorPartResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['EditorPart'] = IResolversParentTypes['EditorPart']> = {
  id?: Resolver<IResolversTypes['Int'], ParentType, ContextType>,
  mode?: Resolver<Maybe<IResolversTypes['GroupOrientation']>, ParentType, ContextType>,
  height?: Resolver<Maybe<IResolversTypes['Int']>, ParentType, ContextType>,
  size?: Resolver<Maybe<IResolversTypes['Int']>, ParentType, ContextType>,
...
export type IEditorPartOptions_InputResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['EditorPartOptions_Input'] = IResolversParentTypes['EditorPartOptions_Input']> = {
...
export type IEditorSettingsResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['EditorSettings'] = IResolversParentTypes['EditorSettings']> = {
  editorOpenPositioning?: Resolver<Maybe<IResolversTypes['EditorOpenPositioning']>, ParentType, ContextType>,
  focusRecentEditorAfterClose?: Resolver<Maybe<IResolversTypes['Boolean']>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type IEmptyResponseResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['EmptyResponse'] = IResolversParentTypes['EmptyResponse']> = {
  alwaysNil?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type IEncodingStatusResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['EncodingStatus'] = IResolversParentTypes['EncodingStatus']> = {
  id?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  name?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  alignment?: Resolver<Maybe<IResolversTypes['StatusbarAlignment']>, ParentType, ContextType>,
  entry?: Resolver<Maybe<IResolversTypes['StatusbarEntry']>, ParentType, ContextType>,
...
export type IEndOfLineSequenceResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['EndOfLineSequence'] = IResolversParentTypes['EndOfLineSequence']> = {
  id?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  name?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  alignment?: Resolver<Maybe<IResolversTypes['StatusbarAlignment']>, ParentType, ContextType>,
  entry?: Resolver<Maybe<IResolversTypes['StatusbarEntry']>, ParentType, ContextType>,
...
export type IEnginesResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['Engines'] = IResolversParentTypes['Engines']> = {
...
export type IEnterWorkspaceResultResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['EnterWorkspaceResult'] = IResolversParentTypes['EnterWorkspaceResult']> = {
...
export type IEnvironmentResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['Environment'] = IResolversParentTypes['Environment']> = {
...
export type IExtensionColorResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['ExtensionColor'] = IResolversParentTypes['ExtensionColor']> = {
  id?: Resolver<Maybe<IResolversTypes['ID']>, ParentType, ContextType>,
  description?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
...
export type IExtensionColorTypesResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['ExtensionColorTypes'] = IResolversParentTypes['ExtensionColorTypes']> = {
...
export type IExtensionConfigurationResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['ExtensionConfiguration'] = IResolversParentTypes['ExtensionConfiguration']> = {
  properties?: Resolver<Maybe<IResolversTypes['JSON']>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type IExtensionConfigurationPropertyResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['ExtensionConfigurationProperty'] = IResolversParentTypes['ExtensionConfigurationProperty']> = {
  description?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
...
export type IExtensionContributionsResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['ExtensionContributions'] = IResolversParentTypes['ExtensionContributions']> = {
  actions?: Resolver<Maybe<Array<Maybe<IResolversTypes['Actions']>>>, ParentType, ContextType>,
...
export type IExtensionHostDebugParamsResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['ExtensionHostDebugParams'] = IResolversParentTypes['ExtensionHostDebugParams']> = {
...
export type IExtensionIdentifierResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['ExtensionIdentifier'] = IResolversParentTypes['ExtensionIdentifier']> = {
  id?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  uuid?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type IExtensionInstanceResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['ExtensionInstance'] = IResolversParentTypes['ExtensionInstance']> = {
...
export type IExtensionJSONValidationResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['ExtensionJSONValidation'] = IResolversParentTypes['ExtensionJSONValidation']> = {
...
export type IExtensionLanguageResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['ExtensionLanguage'] = IResolversParentTypes['ExtensionLanguage']> = {
  id?: Resolver<Maybe<IResolversTypes['ID']>, ParentType, ContextType>,
...
export type IExtensionManifestResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['ExtensionManifest'] = IResolversParentTypes['ExtensionManifest']> = {
  name?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
...
export type IExtensionManifestBugsResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['ExtensionManifestBugs'] = IResolversParentTypes['ExtensionManifestBugs']> = {
  url?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  email?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type IExtensionManifestRepositoryResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['ExtensionManifestRepository'] = IResolversParentTypes['ExtensionManifestRepository']> = {
  type?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  url?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type IExtensionPackageTypeResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['ExtensionPackageType'] = IResolversParentTypes['ExtensionPackageType']> = {
  type?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type IExtensionRegistryResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['ExtensionRegistry'] = IResolversParentTypes['ExtensionRegistry']> = {
...
export type IExtensionRegistryCreateExtensionResultResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['ExtensionRegistryCreateExtensionResult'] = IResolversParentTypes['ExtensionRegistryCreateExtensionResult']> = {
  extension?: Resolver<IResolversTypes['RegistryExtension'], ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type IExtensionRegistryPublishExtensionResultResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['ExtensionRegistryPublishExtensionResult'] = IResolversParentTypes['ExtensionRegistryPublishExtensionResult']> = {
  extension?: Resolver<IResolversTypes['RegistryExtension'], ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type IExtensionRegistryUpdateExtensionResultResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['ExtensionRegistryUpdateExtensionResult'] = IResolversParentTypes['ExtensionRegistryUpdateExtensionResult']> = {
  extension?: Resolver<IResolversTypes['RegistryExtension'], ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type IExtensionReleaseResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['ExtensionRelease'] = IResolversParentTypes['ExtensionRelease']> = {
  id?: Resolver<Maybe<IResolversTypes['ID']>, ParentType, ContextType>,
  bundle?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  bundleURL?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  version?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
...
export type IFieldErrorResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['FieldError'] = IResolversParentTypes['FieldError']> = {
  field?: Resolver<IResolversTypes['String'], ParentType, ContextType>,
  message?: Resolver<IResolversTypes['String'], ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type IFileChangeResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['FileChange'] = IResolversParentTypes['FileChange']> = {
  type?: Resolver<Maybe<IResolversTypes['FileChangeType']>, ParentType, ContextType>,
  resource?: Resolver<Maybe<IResolversTypes['URI']>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type IFileContentResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['FileContent'] = IResolversParentTypes['FileContent']> = {
...
export type IFileDeleteOptionsResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['FileDeleteOptions'] = IResolversParentTypes['FileDeleteOptions']> = {
...
export type IFileEditorInputResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['FileEditorInput'] = IResolversParentTypes['FileEditorInput']> = {
  id?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  resource?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  typeId?: Resolver<Maybe<IResolversTypes['EDITOR_INPUT_ID']>, ParentType, ContextType>,
  description?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
...
export type IFileFilterResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['FileFilter'] = IResolversParentTypes['FileFilter']> = {
  extensions?: Resolver<Maybe<Array<Maybe<IResolversTypes['String']>>>, ParentType, ContextType>,
  name?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type IFileIndexProviderStatsResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['FileIndexProviderStats'] = IResolversParentTypes['FileIndexProviderStats']> = {
...
export type IFileMatchResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['FileMatch'] = IResolversParentTypes['FileMatch']> = {
  resource?: Resolver<Maybe<IResolversTypes['URI']>, ParentType, ContextType>,
  results?: Resolver<Maybe<Array<Maybe<IResolversTypes['TextSearchResult']>>>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type IFileOpenOptionsResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['FileOpenOptions'] = IResolversParentTypes['FileOpenOptions']> = {
  create?: Resolver<IResolversTypes['Boolean'], ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type IFileOperationOutputResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['FileOperationOutput'] = IResolversParentTypes['FileOperationOutput']> = {
  resource?: Resolver<Maybe<IResolversTypes['URI']>, ParentType, ContextType>,
...
export type IFileOverwriteOptionsResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['FileOverwriteOptions'] = IResolversParentTypes['FileOverwriteOptions']> = {
  overwrite?: Resolver<IResolversTypes['Boolean'], ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type IFileResultResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['FileResult'] = IResolversParentTypes['FileResult']> = {
...
export type IFilesResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['Files'] = IResolversParentTypes['Files']> = {
  eol?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
...
export type IFiles_StatResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['Files_Stat'] = IResolversParentTypes['Files_Stat']> = {
...
export type IFileSearchProviderStatsResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['FileSearchProviderStats'] = IResolversParentTypes['FileSearchProviderStats']> = {
...
export type IFileSearchStatsResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['FileSearchStats'] = IResolversParentTypes['FileSearchStats']> = {
...
export type IFileSearchStatsdetailStatsResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['FileSearchStatsdetailStats'] = IResolversParentTypes['FileSearchStatsdetailStats']> = {
...
export type IFileStatResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['FileStat'] = IResolversParentTypes['FileStat']> = {
  resource?: Resolver<IResolversTypes['URI'], ParentType, ContextType>,
  name?: Resolver<IResolversTypes['String'], ParentType, ContextType>,
  size?: Resolver<Maybe<IResolversTypes['Int']>, ParentType, ContextType>,
  mtime?: Resolver<Maybe<IResolversTypes['BigInt']>, ParentType, ContextType>,
...
export type IFileStatWithMetadataResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['FileStatWithMetadata'] = IResolversParentTypes['FileStatWithMetadata']> = {
...
export type IFileStreamContentResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['FileStreamContent'] = IResolversParentTypes['FileStreamContent']> = {
  resource?: Resolver<IResolversTypes['URI'], ParentType, ContextType>,
  name?: Resolver<IResolversTypes['String'], ParentType, ContextType>,
  mtime?: Resolver<IResolversTypes['BigInt'], ParentType, ContextType>,
  etag?: Resolver<IResolversTypes['String'], ParentType, ContextType>,
...
export type IFileToOpenResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['FileToOpen'] = IResolversParentTypes['FileToOpen']> = {
  fileUri?: Resolver<Maybe<IResolversTypes['URI']>, ParentType, ContextType>,
  label?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type IFileWriteOptionsResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['FileWriteOptions'] = IResolversParentTypes['FileWriteOptions']> = {
  overwrite?: Resolver<IResolversTypes['Boolean'], ParentType, ContextType>,
  create?: Resolver<IResolversTypes['Boolean'], ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type IFolderConfigurationModelResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['FolderConfigurationModel'] = IResolversParentTypes['FolderConfigurationModel']> = {
...
export type IFolderQueryResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['FolderQuery'] = IResolversParentTypes['FolderQuery']> = {
...
export type IFolderSettingsResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['FolderSettings'] = IResolversParentTypes['FolderSettings']> = {
  id?: Resolver<Maybe<IResolversTypes['ID']>, ParentType, ContextType>,
  latestSettings?: Resolver<Maybe<IResolversTypes['Settings']>, ParentType, ContextType>,
  settingsURL?: Resolver<IResolversTypes['URI'], ParentType, ContextType>,
  viewerCanAdminister?: Resolver<IResolversTypes['Boolean'], ParentType, ContextType>,
...
export type IFolderToOpenResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['FolderToOpen'] = IResolversParentTypes['FolderToOpen']> = {
  folderUri?: Resolver<Maybe<IResolversTypes['URI']>, ParentType, ContextType>,
  label?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type IGalleryBannerResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['GalleryBanner'] = IResolversParentTypes['GalleryBanner']> = {
...
export type IGalleryExtensionResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['GalleryExtension'] = IResolversParentTypes['GalleryExtension']> = {
  id?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  name?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  identifier?: Resolver<Maybe<IResolversTypes['ExtensionIdentifier']>, ParentType, ContextType>,
  version?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
...
export type IGalleryExtensionAssetResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['GalleryExtensionAsset'] = IResolversParentTypes['GalleryExtensionAsset']> = {
...
export type IGalleryExtensionAssetsResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['GalleryExtensionAssets'] = IResolversParentTypes['GalleryExtensionAssets']> = {
...
export type IGalleryExtensionPropertiesResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['GalleryExtensionProperties'] = IResolversParentTypes['GalleryExtensionProperties']> = {
...
export type IGalleryExtensionResourcesResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['GalleryExtensionResources'] = IResolversParentTypes['GalleryExtensionResources']> = {
...
export type IGalleryPagerResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['GalleryPager'] = IResolversParentTypes['GalleryPager']> = {
...
export type IGitResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['Git'] = IResolversParentTypes['Git']> = {
  path?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  enabled?: Resolver<Maybe<IResolversTypes['Boolean']>, ParentType, ContextType>,
...
export type IGitDecorationsResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['GitDecorations'] = IResolversParentTypes['GitDecorations']> = {
  enabled?: Resolver<Maybe<IResolversTypes['Boolean']>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type IGlobalSettingsResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['GlobalSettings'] = IResolversParentTypes['GlobalSettings']> = {
  id?: Resolver<Maybe<IResolversTypes['ID']>, ParentType, ContextType>,
  latestSettings?: Resolver<Maybe<IResolversTypes['Settings']>, ParentType, ContextType>,
  settingsURL?: Resolver<IResolversTypes['URI'], ParentType, ContextType>,
  viewerCanAdminister?: Resolver<IResolversTypes['Boolean'], ParentType, ContextType>,
...
export type IGoToLineQuickAccessResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['GoToLineQuickAccess'] = IResolversParentTypes['GoToLineQuickAccess']> = {
...
export type IGrammarResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['Grammar'] = IResolversParentTypes['Grammar']> = {
  language?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type IGroupLayoutArgumentResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['GroupLayoutArgument'] = IResolversParentTypes['GroupLayoutArgument']> = {
  size?: Resolver<Maybe<IResolversTypes['Int']>, ParentType, ContextType>,
  groups?: Resolver<Maybe<Array<Maybe<IResolversTypes['GroupLayoutArgument']>>>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type IIBaseStatResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['IBaseStat'] = IResolversParentTypes['IBaseStat']> = {
...
export type IIBaseStatWithMetadataResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['IBaseStatWithMetadata'] = IResolversParentTypes['IBaseStatWithMetadata']> = {
...
export type IIBaseTextFileContentResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['IBaseTextFileContent'] = IResolversParentTypes['IBaseTextFileContent']> = {
  __resolveType: TypeResolveFn<'TextFileStreamContent' | 'TextFilePublishContent' | 'TextFileContent', ParentType, ContextType>,
  encoding?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
};

export type IIBehaviorSubjectResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['IBehaviorSubject'] = IResolversParentTypes['IBehaviorSubject']> = {
...
export type IIBehaviorSubjectValueResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['IBehaviorSubjectValue'] = IResolversParentTypes['IBehaviorSubjectValue']> = {
...
export type IIConfigurationChangeEventResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['IConfigurationChangeEvent'] = IResolversParentTypes['IConfigurationChangeEvent']> = {
...
export type IIContentChangedEventResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['IContentChangedEvent'] = IResolversParentTypes['IContentChangedEvent']> = {
...
export type IIDebugParamsResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['IDebugParams'] = IResolversParentTypes['IDebugParams']> = {
  __resolveType: TypeResolveFn<'ExtensionHostDebugParams', ParentType, ContextType>,
  port?: Resolver<Maybe<IResolversTypes['Int']>, ParentType, ContextType>,
  break?: Resolver<Maybe<IResolversTypes['Boolean']>, ParentType, ContextType>,
};

export type IIDestinationAnonymousSubjectResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['IDestinationAnonymousSubject'] = IResolversParentTypes['IDestinationAnonymousSubject']> = {
  closed?: Resolver<Maybe<IResolversTypes['Boolean']>, ParentType, ContextType>,
...
export type IIDocumentSelectorResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['IDocumentSelector'] = IResolversParentTypes['IDocumentSelector']> = {
  documentSelector?: Resolver<Maybe<IResolversTypes['JSON']>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type IIEditorGroupResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['IEditorGroup'] = IResolversParentTypes['IEditorGroup']> = {
  __resolveType: TypeResolveFn<'EditorGroup', ParentType, ContextType>,
  id?: Resolver<IResolversTypes['Int'], ParentType, ContextType>,
  label?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
};

export type IIEditorInputResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['IEditorInput'] = IResolversParentTypes['IEditorInput']> = {
  __resolveType: TypeResolveFn<'DataUriEditorInput' | 'DiffEditorInput' | 'FileEditorInput' | 'KeybindingEditorInput' | 'PreferencesEditorInput' | 'ResourceEditorInput' | 'SideBySideEditorInput' | 'UntitledEditorInput', ParentType, ContextType>,
  resource?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  typeId?: Resolver<Maybe<IResolversTypes['EDITOR_INPUT_ID']>, ParentType, ContextType>,
  label?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
...
export type IIEditorInputWithGroupFieldsResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['IEditorInputWithGroupFields'] = IResolversParentTypes['IEditorInputWithGroupFields']> = {
  __resolveType: TypeResolveFn<'DataUriEditorInput' | 'DiffEditorInput' | 'FileEditorInput' | 'KeybindingEditorInput' | 'PreferencesEditorInput' | 'ResourceEditorInput' | 'SideBySideEditorInput' | 'UntitledEditorInput', ParentType, ContextType>,
  isActive?: Resolver<Maybe<IResolversTypes['Boolean']>, ParentType, ContextType>,
  isPinned?: Resolver<Maybe<IResolversTypes['Boolean']>, ParentType, ContextType>,
  preview?: Resolver<Maybe<IResolversTypes['Boolean']>, ParentType, ContextType>,
...
export type IIEncodingSupportResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['IEncodingSupport'] = IResolversParentTypes['IEncodingSupport']> = {
  __resolveType: TypeResolveFn<'FileEditorInput', ParentType, ContextType>,
  encoding?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
};

export type IIFileClientMetadataResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['IFileClientMetadata'] = IResolversParentTypes['IFileClientMetadata']> = {
...
export type IIFileEditorInputResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['IFileEditorInput'] = IResolversParentTypes['IFileEditorInput']> = {
  __resolveType: TypeResolveFn<'FileEditorInput', ParentType, ContextType>,
  preferredEncoding?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  preferredMode?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  forceOpenAsBinary?: Resolver<Maybe<IResolversTypes['Boolean']>, ParentType, ContextType>,
...
export type IIFileMatchResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['IFileMatch'] = IResolversParentTypes['IFileMatch']> = {
  __resolveType: TypeResolveFn<'FileMatch' | 'SearchProgressItem', ParentType, ContextType>,
  resource?: Resolver<Maybe<IResolversTypes['URI']>, ParentType, ContextType>,
  results?: Resolver<Maybe<Array<Maybe<IResolversTypes['TextSearchResult']>>>, ParentType, ContextType>,
};

export type IIModelResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['IModel'] = IResolversParentTypes['IModel']> = {
...
export type IIModeSupportResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['IModeSupport'] = IResolversParentTypes['IModeSupport']> = {
  __resolveType: TypeResolveFn<'FileEditorInput', ParentType, ContextType>,
  mode?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
};

export type IImportResultResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['ImportResult'] = IResolversParentTypes['ImportResult']> = {
...
export type IIndentationResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['Indentation'] = IResolversParentTypes['Indentation']> = {
  id?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  name?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  alignment?: Resolver<Maybe<IResolversTypes['StatusbarAlignment']>, ParentType, ContextType>,
  entry?: Resolver<Maybe<IResolversTypes['StatusbarEntry']>, ParentType, ContextType>,
...
export type IInputTypeDetailResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['InputTypeDetail'] = IResolversParentTypes['InputTypeDetail']> = {
  type?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  options?: Resolver<Maybe<Array<Maybe<IResolversTypes['String']>>>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type IInstalledExtensionResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['InstalledExtension'] = IResolversParentTypes['InstalledExtension']> = {
...
export type IIntegratedResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['Integrated'] = IResolversParentTypes['Integrated']> = {
...
export type IIObservableResultResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['IObservableResult'] = IResolversParentTypes['IObservableResult']> = {
  closed?: Resolver<Maybe<IResolversTypes['Boolean']>, ParentType, ContextType>,
...
export type IIPathDataResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['IPathData'] = IResolversParentTypes['IPathData']> = {
...
export type IIPathsToWaitForDataResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['IPathsToWaitForData'] = IResolversParentTypes['IPathsToWaitForData']> = {
...
export type IISearchCompleteStatsResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['ISearchCompleteStats'] = IResolversParentTypes['ISearchCompleteStats']> = {
...
export type IISearchProgressResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['ISearchProgress'] = IResolversParentTypes['ISearchProgress']> = {
...
export type IISettingsSubjectResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['ISettingsSubject'] = IResolversParentTypes['ISettingsSubject']> = {
...
export type IISideBySideEditorInputResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['ISideBySideEditorInput'] = IResolversParentTypes['ISideBySideEditorInput']> = {
...
export type IISourceAnonymousSubjectResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['ISourceAnonymousSubject'] = IResolversParentTypes['ISourceAnonymousSubject']> = {
  closed?: Resolver<Maybe<IResolversTypes['Boolean']>, ParentType, ContextType>,
  destination?: Resolver<Maybe<IResolversTypes['IDestinationAnonymousSubject']>, ParentType, ContextType>,
  hasError?: Resolver<Maybe<IResolversTypes['Boolean']>, ParentType, ContextType>,
  isStopped?: Resolver<Maybe<IResolversTypes['Boolean']>, ParentType, ContextType>,
...
export type IIStaticWorkspaceDataResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['IStaticWorkspaceData'] = IResolversParentTypes['IStaticWorkspaceData']> = {
...
export type IIStatusbarItemResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['IStatusbarItem'] = IResolversParentTypes['IStatusbarItem']> = {
...
export type IISwitchMapOperatorResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['ISwitchMapOperator'] = IResolversParentTypes['ISwitchMapOperator']> = {
  project?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type IITextDocumentIdentifierResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['ITextDocumentIdentifier'] = IResolversParentTypes['ITextDocumentIdentifier']> = {
...
export type IITreeItemResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['ITreeItem'] = IResolversParentTypes['ITreeItem']> = {
  __resolveType: TypeResolveFn<'FileStatWithMetadata', ParentType, ContextType>,
  path?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  title?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  subtitle?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
...
export type IIUntitledFileValueResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['IUntitledFileValue'] = IResolversParentTypes['IUntitledFileValue']> = {
  __resolveType: TypeResolveFn<'FileStatWithMetadata', ParentType, ContextType>,
  value?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
};

export type IIUserPreferencesResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['IUserPreferences'] = IResolversParentTypes['IUserPreferences']> = {
  content?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  user?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type IIUserSettingsResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['IUserSettings'] = IResolversParentTypes['IUserSettings']> = {
  data?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type IIViewComponentDataResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['IViewComponentData'] = IResolversParentTypes['IViewComponentData']> = {
  type?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
...
export type IIViewDescriptorResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['IViewDescriptor'] = IResolversParentTypes['IViewDescriptor']> = {
...
export type IIWorkspaceRootResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['IWorkspaceRoot'] = IResolversParentTypes['IWorkspaceRoot']> = {
  url?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};
...
export type IKeyBindingResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['KeyBinding'] = IResolversParentTypes['KeyBinding']> = {
  command?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  key?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  when?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
...
export type IKeybindingContextMenuResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['KeybindingContextMenu'] = IResolversParentTypes['KeybindingContextMenu']> = {
...
export type IKeybindingEditorInputResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['KeybindingEditorInput'] = IResolversParentTypes['KeybindingEditorInput']> = {
  id?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  resource?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  typeId?: Resolver<Maybe<IResolversTypes['EDITOR_INPUT_ID']>, ParentType, ContextType>,
  description?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
...
export type IKeybindingItemResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['KeybindingItem'] = IResolversParentTypes['KeybindingItem']> = {
  command?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  key?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  when?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
...
export type IKeybindingsResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['Keybindings'] = IResolversParentTypes['Keybindings']> = {
  items?: Resolver<Maybe<Array<Maybe<IResolversTypes['KeybindingItem']>>>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type IKeyboardEvent_outputResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['KeyboardEvent_output'] = IResolversParentTypes['KeyboardEvent_output']> = {
  label?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  key?: Resolver<Maybe<Array<Maybe<IResolversTypes['String']>>>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type ILanguageModeResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['LanguageMode'] = IResolversParentTypes['LanguageMode']> = {
  id?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  name?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  alignment?: Resolver<Maybe<IResolversTypes['StatusbarAlignment']>, ParentType, ContextType>,
  entry?: Resolver<Maybe<IResolversTypes['StatusbarEntry']>, ParentType, ContextType>,
...
export type ILanguagesResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['Languages'] = IResolversParentTypes['Languages']> = {
...
export type ILineMatchResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['LineMatch'] = IResolversParentTypes['LineMatch']> = {
...
export type ILineRangeResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['LineRange'] = IResolversParentTypes['LineRange']> = {
  endColumn?: Resolver<Maybe<IResolversTypes['Int']>, ParentType, ContextType>,
...
export type ILocalizationResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['Localization'] = IResolversParentTypes['Localization']> = {
  languageId?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
...
export type ILocalizationTranslationResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['LocalizationTranslation'] = IResolversParentTypes['LocalizationTranslation']> = {
  id?: Resolver<Maybe<IResolversTypes['ID']>, ParentType, ContextType>,
  path?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type ILocalUserSettingsResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['LocalUserSettings'] = IResolversParentTypes['LocalUserSettings']> = {
  id?: Resolver<Maybe<IResolversTypes['ID']>, ParentType, ContextType>,
  latestSettings?: Resolver<Maybe<IResolversTypes['Settings']>, ParentType, ContextType>,
  settingsURL?: Resolver<IResolversTypes['URI'], ParentType, ContextType>,
  viewerCanAdminister?: Resolver<IResolversTypes['Boolean'], ParentType, ContextType>,
...
export type ILocationResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['Location'] = IResolversParentTypes['Location']> = {
...
export type IMatchResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['Match'] = IResolversParentTypes['Match']> = {
...
export type IMemorySettingsResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['MemorySettings'] = IResolversParentTypes['MemorySettings']> = {
  id?: Resolver<Maybe<IResolversTypes['ID']>, ParentType, ContextType>,
  latestSettings?: Resolver<Maybe<IResolversTypes['Settings']>, ParentType, ContextType>,
  settingsURL?: Resolver<IResolversTypes['URI'], ParentType, ContextType>,
  viewerCanAdminister?: Resolver<IResolversTypes['Boolean'], ParentType, ContextType>,
...
export type IMenuItemResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['MenuItem'] = IResolversParentTypes['MenuItem']> = {
  id?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  label?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  enabled?: Resolver<Maybe<IResolversTypes['Boolean']>, ParentType, ContextType>,
  run?: Resolver<Maybe<IResolversTypes['ActionRun']>, ParentType, ContextType>,
...
export type IMenuItemActionResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['MenuItemAction'] = IResolversParentTypes['MenuItemAction']> = {
  action?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  when?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type IMenuItemActionContextResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['MenuItemActionContext'] = IResolversParentTypes['MenuItemActionContext']> = {
  context?: Resolver<Maybe<Array<Maybe<IResolversTypes['MenuItemAction']>>>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type IMenuItemActionDebugResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['MenuItemActionDebug'] = IResolversParentTypes['MenuItemActionDebug']> = {
...
export type IMenuItemActionEditorResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['MenuItemActionEditor'] = IResolversParentTypes['MenuItemActionEditor']> = {
  context?: Resolver<Maybe<Array<Maybe<IResolversTypes['MenuItemAction']>>>, ParentType, ContextType>,
  title?: Resolver<Maybe<IResolversTypes['MenuItemActionEditorTitle']>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type IMenuItemActionEditorTitleResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['MenuItemActionEditorTitle'] = IResolversParentTypes['MenuItemActionEditorTitle']> = {
  own?: Resolver<Maybe<Array<Maybe<IResolversTypes['MenuItemAction']>>>, ParentType, ContextType>,
  context?: Resolver<Maybe<Array<Maybe<IResolversTypes['MenuItemAction']>>>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type IMenuItemActionScmResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['MenuItemActionScm'] = IResolversParentTypes['MenuItemActionScm']> = {
...
export type IMenuItemActionScmChangeResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['MenuItemActionScmChange'] = IResolversParentTypes['MenuItemActionScmChange']> = {
  title?: Resolver<Maybe<Array<Maybe<IResolversTypes['MenuItemAction']>>>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type IMenuItemActionViewResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['MenuItemActionView'] = IResolversParentTypes['MenuItemActionView']> = {
  title?: Resolver<Maybe<Array<Maybe<IResolversTypes['MenuItemAction']>>>, ParentType, ContextType>,
  item?: Resolver<Maybe<IResolversTypes['MenuItemActionContext']>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type IMenusResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['Menus'] = IResolversParentTypes['Menus']> = {
...
export type IMessageBoxOptionsResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['MessageBoxOptions'] = IResolversParentTypes['MessageBoxOptions']> = {
  type?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
...
export type IMessageBoxResultResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['MessageBoxResult'] = IResolversParentTypes['MessageBoxResult']> = {
  button?: Resolver<Maybe<IResolversTypes['Int']>, ParentType, ContextType>,
  checkboxChecked?: Resolver<Maybe<IResolversTypes['Boolean']>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type IMessageLinkResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['MessageLink'] = IResolversParentTypes['MessageLink']> = {
  name?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
...
export type IMutationResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['Mutation'] = IResolversParentTypes['Mutation']> = {
...
export type INativeOpenDialogOptionsResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['NativeOpenDialogOptions'] = IResolversParentTypes['NativeOpenDialogOptions']> = {
...
export type INewWindowOptionsResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['NewWindowOptions'] = IResolversParentTypes['NewWindowOptions']> = {
  remoteAuthority?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  reuseWindow?: Resolver<Maybe<IResolversTypes['Boolean']>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type INodeResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['Node'] = IResolversParentTypes['Node']> = {
  __resolveType: TypeResolveFn<'RegistryExtension', ParentType, ContextType>,
  id?: Resolver<IResolversTypes['ID'], ParentType, ContextType>,
};

export type INotificationResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['Notification'] = IResolversParentTypes['Notification']> = {
...
export type INotificationActionsResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['NotificationActions'] = IResolversParentTypes['NotificationActions']> = {
...
export type INotificationChangeEventResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['NotificationChangeEvent'] = IResolversParentTypes['NotificationChangeEvent']> = {
...
export type INotificationMessageResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['NotificationMessage'] = IResolversParentTypes['NotificationMessage']> = {
  raw?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
...
export type INotificationsResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['Notifications'] = IResolversParentTypes['Notifications']> = {
  notifications?: Resolver<Maybe<Array<Maybe<IResolversTypes['Notification']>>>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type INotificationViewItemResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['NotificationViewItem'] = IResolversParentTypes['NotificationViewItem']> = {
  severity?: Resolver<Maybe<IResolversTypes['NotificationSeverity']>, ParentType, ContextType>,
  sticky?: Resolver<Maybe<IResolversTypes['Boolean']>, ParentType, ContextType>,
...
export type INotificationViewItemProgressResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['NotificationViewItemProgress'] = IResolversParentTypes['NotificationViewItemProgress']> = {
  state?: Resolver<Maybe<IResolversTypes['NotificationViewItemProgressState']>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type INotificationViewItemProgressStateResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['NotificationViewItemProgressState'] = IResolversParentTypes['NotificationViewItemProgressState']> = {
...
export type IOneSearchPathPatternResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['OneSearchPathPattern'] = IResolversParentTypes['OneSearchPathPattern']> = {
  searchPath?: Resolver<Maybe<IResolversTypes['URI']>, ParentType, ContextType>,
  pattern?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type IOpenConfigurationResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['OpenConfiguration'] = IResolversParentTypes['OpenConfiguration']> = {
...
export type IOpenDialogOptionsResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['OpenDialogOptions'] = IResolversParentTypes['OpenDialogOptions']> = {
  title?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  defaultPath?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
...
export type IOpenFileRequestResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['OpenFileRequest'] = IResolversParentTypes['OpenFileRequest']> = {
...
export type IOpenSettingsResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['OpenSettings'] = IResolversParentTypes['OpenSettings']> = {
  forceNewWindow?: Resolver<Maybe<IResolversTypes['Boolean']>, ParentType, ContextType>,
  forceReuseWindow?: Resolver<Maybe<IResolversTypes['Boolean']>, ParentType, ContextType>,
  diffMode?: Resolver<Maybe<IResolversTypes['Boolean']>, ParentType, ContextType>,
  addMode?: Resolver<Maybe<IResolversTypes['Boolean']>, ParentType, ContextType>,
...
export type IOutputResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['Output'] = IResolversParentTypes['Output']> = {
  maxChannelHistory?: Resolver<Maybe<IResolversTypes['Int']>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type IOverridesResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['Overrides'] = IResolversParentTypes['Overrides']> = {
  contents?: Resolver<Maybe<IResolversTypes['AnyObject']>, ParentType, ContextType>,
  identifiers?: Resolver<Maybe<Array<Maybe<IResolversTypes['String']>>>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type IPageInfoResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['PageInfo'] = IResolversParentTypes['PageInfo']> = {
  hasNextPage?: Resolver<IResolversTypes['Boolean'], ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type IPathResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['Path'] = IResolversParentTypes['Path']> = {
  lineNumber?: Resolver<Maybe<IResolversTypes['Int']>, ParentType, ContextType>,
  columnNumber?: Resolver<Maybe<IResolversTypes['Int']>, ParentType, ContextType>,
  exists?: Resolver<Maybe<IResolversTypes['Boolean']>, ParentType, ContextType>,
  fileUri?: Resolver<Maybe<IResolversTypes['URI']>, ParentType, ContextType>,
...
export type IPathsToWaitForResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['PathsToWaitFor'] = IResolversParentTypes['PathsToWaitFor']> = {
  paths?: Resolver<Maybe<Array<Maybe<IResolversTypes['Path']>>>, ParentType, ContextType>,
  waitMarkerFileUri?: Resolver<Maybe<IResolversTypes['URI']>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type IPatternInfoResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['PatternInfo'] = IResolversParentTypes['PatternInfo']> = {
...
export type IPendingStatusbarEntryResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['PendingStatusbarEntry'] = IResolversParentTypes['PendingStatusbarEntry']> = {
  id?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  name?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  alignment?: Resolver<Maybe<IResolversTypes['StatusbarAlignment']>, ParentType, ContextType>,
  priority?: Resolver<Maybe<IResolversTypes['Int']>, ParentType, ContextType>,
...
export type IPositionResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['Position'] = IResolversParentTypes['Position']> = {
  lineNumber?: Resolver<Maybe<IResolversTypes['Int']>, ParentType, ContextType>,
...
export type IPreferenceItemResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['PreferenceItem'] = IResolversParentTypes['PreferenceItem']> = {
  name?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  type?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
...
export type IPreferencesEditorInputResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['PreferencesEditorInput'] = IResolversParentTypes['PreferencesEditorInput']> = {
  id?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  resource?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  typeId?: Resolver<Maybe<IResolversTypes['EDITOR_INPUT_ID']>, ParentType, ContextType>,
  description?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
...
export type IPreferencesTypeResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['PreferencesType'] = IResolversParentTypes['PreferencesType']> = {
  type?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  data?: Resolver<Maybe<Array<Maybe<IResolversTypes['Setting']>>>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type IPrimaryButtonActionResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['PrimaryButtonAction'] = IResolversParentTypes['PrimaryButtonAction']> = {
  label?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  run?: Resolver<Maybe<IResolversTypes['ActionRun']>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type IProcessMonitoringResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['ProcessMonitoring'] = IResolversParentTypes['ProcessMonitoring']> = {
...
export type IProgressResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['Progress'] = IResolversParentTypes['Progress']> = {
  total?: Resolver<Maybe<IResolversTypes['Int']>, ParentType, ContextType>,
  worked?: Resolver<Maybe<IResolversTypes['Int']>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type IProvideTextDocumentLocationSignatureResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['ProvideTextDocumentLocationSignature'] = IResolversParentTypes['ProvideTextDocumentLocationSignature']> = {
...
export type IQueryResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['Query'] = IResolversParentTypes['Query']> = {
...
export type IQuickInputResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['QuickInput'] = IResolversParentTypes['QuickInput']> = {
  title?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  description?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
...
export type IQuickInputModelResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['QuickInputModel'] = IResolversParentTypes['QuickInputModel']> = {
...
export type IQuickPickResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['QuickPick'] = IResolversParentTypes['QuickPick']> = {
  placeholder?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
...
export type IQuickPickItemResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['QuickPickItem'] = IResolversParentTypes['QuickPickItem']> = {
  id?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  label?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  description?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  detail?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
...
export type IQuickPickItemHighlightsResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['QuickPickItemHighlights'] = IResolversParentTypes['QuickPickItemHighlights']> = {
...
export type IRangeResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['Range'] = IResolversParentTypes['Range']> = {
...
export type IRegistryEntryResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['RegistryEntry'] = IResolversParentTypes['RegistryEntry']> = {
  registrationOptions?: Resolver<Maybe<IResolversTypes['TextDocumentRegistrationOptions']>, ParentType, ContextType>,
  provider?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type IRegistryExtensionResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['RegistryExtension'] = IResolversParentTypes['RegistryExtension']> = {
  id?: Resolver<IResolversTypes['ID'], ParentType, ContextType>,
...
export type IRegistryExtensionConnectionResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['RegistryExtensionConnection'] = IResolversParentTypes['RegistryExtensionConnection']> = {
...
export type IRegistryPublisherResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['RegistryPublisher'] = IResolversParentTypes['RegistryPublisher']> = {
  UserId?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type IRegistryPublisherConnectionResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['RegistryPublisherConnection'] = IResolversParentTypes['RegistryPublisherConnection']> = {
...
export type IRemoteUserSettingsResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['RemoteUserSettings'] = IResolversParentTypes['RemoteUserSettings']> = {
  id?: Resolver<Maybe<IResolversTypes['ID']>, ParentType, ContextType>,
  latestSettings?: Resolver<Maybe<IResolversTypes['Settings']>, ParentType, ContextType>,
  settingsURL?: Resolver<IResolversTypes['URI'], ParentType, ContextType>,
  viewerCanAdminister?: Resolver<IResolversTypes['Boolean'], ParentType, ContextType>,
...
export type IReplaceContentResultResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['ReplaceContentResult'] = IResolversParentTypes['ReplaceContentResult']> = {
  resource?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
...
export type IResolveFileResultResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['ResolveFileResult'] = IResolversParentTypes['ResolveFileResult']> = {
  stat?: Resolver<Maybe<IResolversTypes['FileStat']>, ParentType, ContextType>,
...
export type IResolveFileResultWithMetadataResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['ResolveFileResultWithMetadata'] = IResolversParentTypes['ResolveFileResultWithMetadata']> = {
  stat?: Resolver<Maybe<IResolversTypes['FileStatWithMetadata']>, ParentType, ContextType>,
  success?: Resolver<IResolversTypes['Boolean'], ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type IResourceEditorInputResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['ResourceEditorInput'] = IResolversParentTypes['ResourceEditorInput']> = {
  id?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  resource?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  typeId?: Resolver<Maybe<IResolversTypes['EDITOR_INPUT_ID']>, ParentType, ContextType>,
  description?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
...
export type IResourceEncodingResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['ResourceEncoding'] = IResolversParentTypes['ResourceEncoding']> = {
  encoding?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  hasBOM?: Resolver<Maybe<IResolversTypes['Boolean']>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type IResourceMapConfigurationModelResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['ResourceMapConfigurationModel'] = IResolversParentTypes['ResourceMapConfigurationModel']> = {
  resource?: Resolver<Maybe<IResolversTypes['URI']>, ParentType, ContextType>,
  contents?: Resolver<Maybe<IResolversTypes['AnyObject']>, ParentType, ContextType>,
  keys?: Resolver<Maybe<Array<Maybe<IResolversTypes['String']>>>, ParentType, ContextType>,
  overrides?: Resolver<Maybe<IResolversTypes['ConfigurationOverrides']>, ParentType, ContextType>,
...
export type IRevealOptionsResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['RevealOptions'] = IResolversParentTypes['RevealOptions']> = {
...
export type IRunActionInWindowRequestResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['RunActionInWindowRequest'] = IResolversParentTypes['RunActionInWindowRequest']> = {
  id?: Resolver<IResolversTypes['String'], ParentType, ContextType>,
...
export type IRunKeybindingInWindowRequestResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['RunKeybindingInWindowRequest'] = IResolversParentTypes['RunKeybindingInWindowRequest']> = {
  userSettingsLabel?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type ISaveDialogOptionsResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['SaveDialogOptions'] = IResolversParentTypes['SaveDialogOptions']> = {
  title?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  defaultPath?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  buttonLabel?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  filters?: Resolver<Maybe<Array<Maybe<IResolversTypes['FileFilter']>>>, ParentType, ContextType>,
...
export type ISaveWorkspaceResResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['SaveWorkspaceRes'] = IResolversParentTypes['SaveWorkspaceRes']> = {
  updated?: Resolver<Maybe<IResolversTypes['Boolean']>, ParentType, ContextType>,
  id?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type IScriptsResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['Scripts'] = IResolversParentTypes['Scripts']> = {
...
export type ISearchResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['Search'] = IResolversParentTypes['Search']> = {
...
export type ISearchCompleteResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['SearchComplete'] = IResolversParentTypes['SearchComplete']> = {
  limitHit?: Resolver<Maybe<IResolversTypes['Boolean']>, ParentType, ContextType>,
...
export type ISearchCompleteStatsStatsResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['SearchCompleteStatsStats'] = IResolversParentTypes['SearchCompleteStatsStats']> = {
  __resolveType: TypeResolveFn<'FileSearchStats' | 'TextSearchStats', ParentType, ContextType>
};

export type ISearchCompleteStreamResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['SearchCompleteStream'] = IResolversParentTypes['SearchCompleteStream']> = {
...
export type ISearchEngineStatsResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['SearchEngineStats'] = IResolversParentTypes['SearchEngineStats']> = {
...
export type ISearchLogResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['SearchLog'] = IResolversParentTypes['SearchLog']> = {
  message?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type ISearchPathPatternResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['SearchPathPattern'] = IResolversParentTypes['SearchPathPattern']> = {
  searchPath?: Resolver<Maybe<IResolversTypes['URI']>, ParentType, ContextType>,
  pattern?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type ISearchProgressItemResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['SearchProgressItem'] = IResolversParentTypes['SearchProgressItem']> = {
  resource?: Resolver<Maybe<IResolversTypes['URI']>, ParentType, ContextType>,
  results?: Resolver<Maybe<Array<Maybe<IResolversTypes['TextSearchResult']>>>, ParentType, ContextType>,
  total?: Resolver<Maybe<IResolversTypes['Int']>, ParentType, ContextType>,
  worked?: Resolver<Maybe<IResolversTypes['Int']>, ParentType, ContextType>,
...
export type ISearchQuickOpenResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['SearchQuickOpen'] = IResolversParentTypes['SearchQuickOpen']> = {
  includeSymbols?: Resolver<Maybe<IResolversTypes['Boolean']>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type ISearchRangeResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['SearchRange'] = IResolversParentTypes['SearchRange']> = {
  startLineNumber?: Resolver<Maybe<IResolversTypes['Int']>, ParentType, ContextType>,
  startColumn?: Resolver<Maybe<IResolversTypes['Int']>, ParentType, ContextType>,
  endLineNumber?: Resolver<Maybe<IResolversTypes['Int']>, ParentType, ContextType>,
  endColumn?: Resolver<Maybe<IResolversTypes['Int']>, ParentType, ContextType>,
...
export type ISelectedOutputResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['SelectedOutput'] = IResolversParentTypes['SelectedOutput']> = {
  title?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  inputValue?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  selectedValue?: Resolver<Maybe<Array<Maybe<IResolversTypes['QuickPickItem']>>>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
...
export type ISelectionStatusResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['SelectionStatus'] = IResolversParentTypes['SelectionStatus']> = {
  id?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  name?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  alignment?: Resolver<Maybe<IResolversTypes['StatusbarAlignment']>, ParentType, ContextType>,
  entry?: Resolver<Maybe<IResolversTypes['StatusbarEntry']>, ParentType, ContextType>,
...
export type ISettingResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['Setting'] = IResolversParentTypes['Setting']> = {
  name?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
...
export type ISettingsResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['Settings'] = IResolversParentTypes['Settings']> = {
...
export type ISettingsCascadeResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['SettingsCascade'] = IResolversParentTypes['SettingsCascade']> = {
...
export type ISettingsGroupResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['SettingsGroup'] = IResolversParentTypes['SettingsGroup']> = {
  id?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  range?: Resolver<Maybe<IResolversTypes['Range']>, ParentType, ContextType>,
  title?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
...
export type ISettingsSectionResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['SettingsSection'] = IResolversParentTypes['SettingsSection']> = {
  titleRange?: Resolver<Maybe<IResolversTypes['Range']>, ParentType, ContextType>,
  title?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
...
export type ISettingsSubjectResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['SettingsSubject'] = IResolversParentTypes['SettingsSubject']> = {
...
export type IShellResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['Shell'] = IResolversParentTypes['Shell']> = {
...
export type IShellArgsResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['ShellArgs'] = IResolversParentTypes['ShellArgs']> = {
...
export type ISideBySideEditorInputResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['SideBySideEditorInput'] = IResolversParentTypes['SideBySideEditorInput']> = {
  id?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  resource?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  typeId?: Resolver<Maybe<IResolversTypes['EDITOR_INPUT_ID']>, ParentType, ContextType>,
  description?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
...
export type ISnippetResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['Snippet'] = IResolversParentTypes['Snippet']> = {
  language?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type IStatusbarResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['Statusbar'] = IResolversParentTypes['Statusbar']> = {
  items?: Resolver<Maybe<Array<Maybe<IResolversTypes['StatusbarItem']>>>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type IStatusbarEntryResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['StatusbarEntry'] = IResolversParentTypes['StatusbarEntry']> = {
...
export type IStatusbarItemResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['StatusbarItem'] = IResolversParentTypes['StatusbarItem']> = {
  __resolveType: TypeResolveFn<'Terminal' | 'SelectionStatus' | 'Indentation' | 'EncodingStatus' | 'EndOfLineSequence' | 'LanguageMode' | 'SyncStatus' | 'BranchStatus', ParentType, ContextType>
};

export type IStreamContentResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['StreamContent'] = IResolversParentTypes['StreamContent']> = {
  resource?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  name?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  mtime?: Resolver<Maybe<IResolversTypes['BigInt']>, ParentType, ContextType>,
  etag?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
...
export type ISubscriptionResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['Subscription'] = IResolversParentTypes['Subscription']> = {
...
export type ISyncStatusResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['SyncStatus'] = IResolversParentTypes['SyncStatus']> = {
  id?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  name?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  alignment?: Resolver<Maybe<IResolversTypes['StatusbarAlignment']>, ParentType, ContextType>,
  entry?: Resolver<Maybe<IResolversTypes['StatusbarEntry']>, ParentType, ContextType>,
...
export type ITerminalResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['Terminal'] = IResolversParentTypes['Terminal']> = {
  alignment?: Resolver<Maybe<IResolversTypes['StatusbarAlignment']>, ParentType, ContextType>,
  container?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  entry?: Resolver<Maybe<IResolversTypes['StatusbarEntry']>, ParentType, ContextType>,
  id?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
...
export type ITextBufferDataResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['TextBufferData'] = IResolversParentTypes['TextBufferData']> = {
  EOL?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
...
export type ITextDocumentIdentifierResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['TextDocumentIdentifier'] = IResolversParentTypes['TextDocumentIdentifier']> = {
  uri?: Resolver<Maybe<IResolversTypes['URI']>, ParentType, ContextType>,
  languageId?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type ITextDocumentItemResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['TextDocumentItem'] = IResolversParentTypes['TextDocumentItem']> = {
  uri?: Resolver<Maybe<IResolversTypes['URI']>, ParentType, ContextType>,
  languageId?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  text?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
...
export type ITextDocumentPositionParamsResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['TextDocumentPositionParams'] = IResolversParentTypes['TextDocumentPositionParams']> = {
  __resolveType: TypeResolveFn<'ProvideTextDocumentLocationSignature', ParentType, ContextType>,
  textDocument?: Resolver<Maybe<IResolversTypes['TextDocumentIdentifier']>, ParentType, ContextType>,
  position?: Resolver<Maybe<IResolversTypes['Position']>, ParentType, ContextType>,
};

export type ITextDocumentRegistrationOptionsResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['TextDocumentRegistrationOptions'] = IResolversParentTypes['TextDocumentRegistrationOptions']> = {
  documentSelector?: Resolver<Maybe<Array<Maybe<IResolversTypes['String']>>>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type ITextFileContentResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['TextFileContent'] = IResolversParentTypes['TextFileContent']> = {
  dirty?: Resolver<Maybe<IResolversTypes['Boolean']>, ParentType, ContextType>,
  encoding?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  etag?: Resolver<IResolversTypes['String'], ParentType, ContextType>,
  inConflictMode?: Resolver<Maybe<IResolversTypes['Boolean']>, ParentType, ContextType>,
...
export type ITextFilePublishContentResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['TextFilePublishContent'] = IResolversParentTypes['TextFilePublishContent']> = {
  resource?: Resolver<IResolversTypes['URI'], ParentType, ContextType>,
  name?: Resolver<IResolversTypes['String'], ParentType, ContextType>,
  mtime?: Resolver<Maybe<IResolversTypes['BigInt']>, ParentType, ContextType>,
  etag?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
...
export type ITextFileStreamContentResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['TextFileStreamContent'] = IResolversParentTypes['TextFileStreamContent']> = {
  resource?: Resolver<IResolversTypes['URI'], ParentType, ContextType>,
  name?: Resolver<IResolversTypes['String'], ParentType, ContextType>,
  size?: Resolver<IResolversTypes['Int'], ParentType, ContextType>,
  mtime?: Resolver<IResolversTypes['BigInt'], ParentType, ContextType>,
...
export type ITextSearchContextResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['TextSearchContext'] = IResolversParentTypes['TextSearchContext']> = {
  uri?: Resolver<Maybe<IResolversTypes['URI']>, ParentType, ContextType>,
  text?: Resolver<IResolversTypes['String'], ParentType, ContextType>,
...
export type ITextSearchMatchResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['TextSearchMatch'] = IResolversParentTypes['TextSearchMatch']> = {
  uri?: Resolver<Maybe<IResolversTypes['URI']>, ParentType, ContextType>,
...
export type ITextSearchPreviewOptionsResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['TextSearchPreviewOptions'] = IResolversParentTypes['TextSearchPreviewOptions']> = {
...
export type ITextSearchResultResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['TextSearchResult'] = IResolversParentTypes['TextSearchResult']> = {
  __resolveType: TypeResolveFn<'TextSearchMatch' | 'TextSearchContext', ParentType, ContextType>
};

export type ITextSearchResultPreviewResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['TextSearchResultPreview'] = IResolversParentTypes['TextSearchResultPreview']> = {
  text?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  matches?: Resolver<Maybe<Array<Maybe<IResolversTypes['SearchRange']>>>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type ITextSearchStatsResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['TextSearchStats'] = IResolversParentTypes['TextSearchStats']> = {
  type?: Resolver<Maybe<IResolversTypes['TextSearchStatsType']>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type IThemeLabelResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['ThemeLabel'] = IResolversParentTypes['ThemeLabel']> = {
  label?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
...
export type ITreeItemResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['TreeItem'] = IResolversParentTypes['TreeItem']> = {
...
export type ITreeViewDescriptorResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['TreeViewDescriptor'] = IResolversParentTypes['TreeViewDescriptor']> = {
  id?: Resolver<IResolversTypes['String'], ParentType, ContextType>,
  name?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  when?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  order?: Resolver<Maybe<IResolversTypes['Int']>, ParentType, ContextType>,
...
export type IUntitledEditorInputResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['UntitledEditorInput'] = IResolversParentTypes['UntitledEditorInput']> = {
  id?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  resource?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  typeId?: Resolver<Maybe<IResolversTypes['EDITOR_INPUT_ID']>, ParentType, ContextType>,
  description?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
...
export type IUpdateDelayedResourceResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['UpdateDelayedResource'] = IResolversParentTypes['UpdateDelayedResource']> = {
  resource?: Resolver<Maybe<IResolversTypes['URI']>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type IUpdatedResourceResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['UpdatedResource'] = IResolversParentTypes['UpdatedResource']> = {
  resource?: Resolver<Maybe<IResolversTypes['URI']>, ParentType, ContextType>,
  etag?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};
...
export type IURIToOpenResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['URIToOpen'] = IResolversParentTypes['URIToOpen']> = {
  __resolveType: TypeResolveFn<'WorkspaceToOpen' | 'FolderToOpen' | 'FileToOpen', ParentType, ContextType>
};

export type IUserResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['User'] = IResolversParentTypes['User']> = {
  username?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type IUserPreferencesResResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['UserPreferencesRes'] = IResolversParentTypes['UserPreferencesRes']> = {
  prefs?: Resolver<Maybe<IResolversTypes['IUserPreferences']>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type IUserSettingsResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['UserSettings'] = IResolversParentTypes['UserSettings']> = {
  id?: Resolver<Maybe<IResolversTypes['ID']>, ParentType, ContextType>,
  latestSettings?: Resolver<Maybe<IResolversTypes['Settings']>, ParentType, ContextType>,
  settingsURL?: Resolver<IResolversTypes['URI'], ParentType, ContextType>,
  viewerCanAdminister?: Resolver<IResolversTypes['Boolean'], ParentType, ContextType>,
...
export type IViewResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['View'] = IResolversParentTypes['View']> = {
  id?: Resolver<Maybe<IResolversTypes['ID']>, ParentType, ContextType>,
  name?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type IViewContainerResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['ViewContainer'] = IResolversParentTypes['ViewContainer']> = {
  id?: Resolver<Maybe<IResolversTypes['ID']>, ParentType, ContextType>,
  title?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type IViewDescriptorResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['ViewDescriptor'] = IResolversParentTypes['ViewDescriptor']> = {
  id?: Resolver<IResolversTypes['String'], ParentType, ContextType>,
  name?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  when?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  order?: Resolver<Maybe<IResolversTypes['Int']>, ParentType, ContextType>,
...
export type IViewStateResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['ViewState'] = IResolversParentTypes['ViewState']> = {
...
export type IWindowConfigurationResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['WindowConfiguration'] = IResolversParentTypes['WindowConfiguration']> = {
...
export type IWorkspaceDataResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['WorkspaceData'] = IResolversParentTypes['WorkspaceData']> = {
  id?: Resolver<IResolversTypes['String'], ParentType, ContextType>,
...
export type IWorkspaceFolderDataResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['WorkspaceFolderData'] = IResolversParentTypes['WorkspaceFolderData']> = {
  uri?: Resolver<Maybe<IResolversTypes['URI']>, ParentType, ContextType>,
  name?: Resolver<IResolversTypes['String'], ParentType, ContextType>,
...
export type IWorkspaceIdentifierResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['WorkspaceIdentifier'] = IResolversParentTypes['WorkspaceIdentifier']> = {
  id?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  configPath?: Resolver<Maybe<IResolversTypes['URI']>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type IWorkspacePreferenceActivityBarResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['WorkspacePreferenceActivityBar'] = IResolversParentTypes['WorkspacePreferenceActivityBar']> = {
  visible?: Resolver<Maybe<IResolversTypes['Boolean']>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type IWorkspacePreferenceCommandPaletteResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['WorkspacePreferenceCommandPalette'] = IResolversParentTypes['WorkspacePreferenceCommandPalette']> = {
...
export type IWorkspacePreferenceEditorResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['WorkspacePreferenceEditor'] = IResolversParentTypes['WorkspacePreferenceEditor']> = {
...
export type IWorkspacePreferenceExperimentalResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['WorkspacePreferenceExperimental'] = IResolversParentTypes['WorkspacePreferenceExperimental']> = {
  editorAssociations?: Resolver<Maybe<Array<Maybe<IResolversTypes['String']>>>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type IWorkspacePreferenceListResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['WorkspacePreferenceList'] = IResolversParentTypes['WorkspacePreferenceList']> = {
...
export type IWorkspacePreferencePanelResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['WorkspacePreferencePanel'] = IResolversParentTypes['WorkspacePreferencePanel']> = {
  defaultLocation?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type IWorkspacePreferenceQuickOpenResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['WorkspacePreferenceQuickOpen'] = IResolversParentTypes['WorkspacePreferenceQuickOpen']> = {
  closeOnFocusLost?: Resolver<Maybe<IResolversTypes['Boolean']>, ParentType, ContextType>,
  preserveInput?: Resolver<Maybe<IResolversTypes['Boolean']>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type IWorkspacePreferenceSettingsResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['WorkspacePreferenceSettings'] = IResolversParentTypes['WorkspacePreferenceSettings']> = {
...
export type IWorkspacePreferenceSideBarResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['WorkspacePreferenceSideBar'] = IResolversParentTypes['WorkspacePreferenceSideBar']> = {
  location?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type IWorkspacePreferenceStatusBarResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['WorkspacePreferenceStatusBar'] = IResolversParentTypes['WorkspacePreferenceStatusBar']> = {
  visible?: Resolver<Maybe<IResolversTypes['Boolean']>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type IWorkspacePreferenceTipsResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['WorkspacePreferenceTips'] = IResolversParentTypes['WorkspacePreferenceTips']> = {
  enabled?: Resolver<Maybe<IResolversTypes['Boolean']>, ParentType, ContextType>,
  horizontalScrolling?: Resolver<Maybe<IResolversTypes['Boolean']>, ParentType, ContextType>,
...
export type IWorkspacePreferenceViewResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['WorkspacePreferenceView'] = IResolversParentTypes['WorkspacePreferenceView']> = {
  alwaysShowHeaderActions?: Resolver<Maybe<IResolversTypes['Boolean']>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type IWorkspacePreferenceWorkbenchResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['WorkspacePreferenceWorkbench'] = IResolversParentTypes['WorkspacePreferenceWorkbench']> = {
...
export type IWorkspaceResResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['WorkspaceRes'] = IResolversParentTypes['WorkspaceRes']> = {
  uri?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type IWorkspaceSettingsResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['WorkspaceSettings'] = IResolversParentTypes['WorkspaceSettings']> = {
  id?: Resolver<Maybe<IResolversTypes['ID']>, ParentType, ContextType>,
  latestSettings?: Resolver<Maybe<IResolversTypes['Settings']>, ParentType, ContextType>,
  settingsURL?: Resolver<IResolversTypes['URI'], ParentType, ContextType>,
  viewerCanAdminister?: Resolver<IResolversTypes['Boolean'], ParentType, ContextType>,
...
export type IWorkspaceStackSettingsResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['WorkspaceStackSettings'] = IResolversParentTypes['WorkspaceStackSettings']> = {
  dummy?: Resolver<Maybe<IResolversTypes['Int']>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type IWorkspaceToOpenResolvers<ContextType = ApolloContext, ParentType extends IResolversParentTypes['WorkspaceToOpen'] = IResolversParentTypes['WorkspaceToOpen']> = {
  workspaceUri?: Resolver<IResolversTypes['URI'], ParentType, ContextType>,
  label?: Resolver<Maybe<IResolversTypes['String']>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type IResolvers<ContextType = ApolloContext> = {
...
export const DefaultSettingFragmentDoc = gql`
  ...
  tags
    ...
    `;
export const SettingRangeFragmentDoc = gql`
  ...
  endColumn
    ...
    `;
export const TerminalConfigurationFragmentDoc = gql`
  ...
  integrated {
    ...
    `;
export const SearchConfigurationFragmentDoc = gql`
  ...
  exclude
    ...
    `;
export const LanguagesConfigurationFragmentDoc = gql`
  ...
  javascript
    ...
    `;
export const FilesConfigurationFragmentDoc = gql`
  ...
  exclude
    ...
    `;
export const GitConfigurationFragmentDoc = gql`
  ...
  decorations {
    ...
    `;
export const WorkspaceConfigurationFragmentDoc = gql`
  ...
  activityBar {
    ...
    `;
export const ViewerSettingsFragmentDoc = gql`
  ...
  subjects {
    ...
    ${TerminalConfigurationFragmentDoc}
${SearchConfigurationFragmentDoc}
${LanguagesConfigurationFragmentDoc}
${FilesConfigurationFragmentDoc}
${GitConfigurationFragmentDoc}
${WorkspaceConfigurationFragmentDoc}`;
export const AllContextFragmentDoc = gql`
  ...
  addToWorkspaceFolderRecommendations
    ...
    `;
export const FinalConfigurationFragmentDoc = gql`
...
${GitConfigurationFragmentDoc}
${WorkspaceConfigurationFragmentDoc}`;
export const KeybindingItemFragmentDoc = gql`
  ...
  source
    ...
    `;
export const KeybindingsFragmentDoc = gql`
  ...
  items {
    ...
    `;
export const pickItemFragmentDoc = gql`
  ...
  alwaysShow
    ...
    `;
export const selectedFragmentDoc = gql`
  ...
  selectedValue {
    ...
    ${pickItemFragmentDoc}`;
export const ResourceContextFragmentDoc = gql`
  ...
  isFileSystemResource
    ...
    `;
export const statusbarItemFragmentDoc = gql`
  ...
  ... on LanguageMode {
    ...
    `;
export const GetConfigurationDataFragmentDoc = gql`
  ...
  folders {
    ...
    `;
export const INotificationMessageFragmentDoc = gql`
...
export const NotificationMessageFragmentDoc = gql`
  ...
  original {
    ...
    ${INotificationMessageFragmentDoc}`;
export const NotifyActionFragmentDoc = gql`
...
export const NotificationFragmentDoc = gql`
  ...
  sticky
    ...
    ${NotifyActionFragmentDoc}`;
export const WorkspaceFolderFragmentDoc = gql`
...
export const installDocument = gql`
  ...
  install(vsix: $vsix) {
    ...
    `;
export type installMutationResult = ApolloReactCommon.MutationResult<IinstallMutation>;
export type installMutationOptions = ApolloReactCommon.BaseMutationOptions<IinstallMutation, IinstallMutationVariables>;
export const providerDefinitionDocument = gql`
  ...
  hoverProviderDefinition(params: $params) @client
    ...
    `;
export type providerDefinitionMutationResult = ApolloReactCommon.MutationResult<IproviderDefinitionMutation>;
export type providerDefinitionMutationOptions = ApolloReactCommon.BaseMutationOptions<IproviderDefinitionMutation, IproviderDefinitionMutationVariables>;
export const removeDocument = gql`
    mutation remove($id: String!) {
  removeExtension(id: $id)
}
    `;
export type removeMutationResult = ApolloReactCommon.MutationResult<IremoveMutation>;
export type removeMutationOptions = ApolloReactCommon.BaseMutationOptions<IremoveMutation, IremoveMutationVariables>;
export const ExtensionsByLimitDocument = gql`
  ...
  extensionRegistry {
    ...
    `;
export type ExtensionsByLimitQueryResult = ApolloReactCommon.QueryResult<IExtensionsByLimitQuery, IExtensionsByLimitQueryVariables>;
export const ExtensionsDocument = gql`
    query Extensions {
  extensions {
    nodes {
      id
    ...
    `;
export type ExtensionsQueryResult = ApolloReactCommon.QueryResult<IExtensionsQuery, IExtensionsQueryVariables>;
export const galleryExtensionDocument = gql`
  ...
  galleryExtension(extensionID: $extensionID) {
    ...
    `;
export type galleryExtensionQueryResult = ApolloReactCommon.QueryResult<IgalleryExtensionQuery, IgalleryExtensionQueryVariables>;
export const galleryDocument = gql`
  ...
  gallery(query: $query) {
    ...
    `;
export type galleryQueryResult = ApolloReactCommon.QueryResult<IgalleryQuery, IgalleryQueryVariables>;
export const installedExtensionsDocument = gql`
  ...
  installed {
    ...
    `;
export type installedExtensionsQueryResult = ApolloReactCommon.QueryResult<IinstalledExtensionsQuery, IinstalledExtensionsQueryVariables>;
export const ViewerSettingsDocument = gql`
  ...
  viewerSettings {
    ...
    `;
export type ViewerSettingsQueryResult = ApolloReactCommon.QueryResult<IViewerSettingsQuery, IViewerSettingsQueryVariables>;
export const GetConfigurationTargetDocument = gql`
    mutation GetConfigurationTarget($resource: URI) {
  getConfigurationTarget(resource: $resource) @client
}
    `;
export type GetConfigurationTargetMutationResult = ApolloReactCommon.MutationResult<IGetConfigurationTargetMutation>;
export type GetConfigurationTargetMutationOptions = ApolloReactCommon.BaseMutationOptions<IGetConfigurationTargetMutation, IGetConfigurationTargetMutationVariables>;
export const OpenGlobalKeybindingsSettingsDocument = gql`
    mutation OpenGlobalKeybindingsSettings($textual: Boolean) {
  openGlobalKeybindingSettings(textual: $textual) @client
}
    `;
export type OpenGlobalKeybindingsSettingsMutationResult = ApolloReactCommon.MutationResult<IOpenGlobalKeybindingsSettingsMutation>;
export type OpenGlobalKeybindingsSettingsMutationOptions = ApolloReactCommon.BaseMutationOptions<IOpenGlobalKeybindingsSettingsMutation, IOpenGlobalKeybindingsSettingsMutationVariables>;
export const OpenPreferenceSettingsDocument = gql`
  ...
  openPreferenceSettings(jsonEditor: $jsonEditor, query: $query) @client
    ...
    `;
export type OpenPreferenceSettingsMutationResult = ApolloReactCommon.MutationResult<IOpenPreferenceSettingsMutation>;
export type OpenPreferenceSettingsMutationOptions = ApolloReactCommon.BaseMutationOptions<IOpenPreferenceSettingsMutation, IOpenPreferenceSettingsMutationVariables>;
export const ResetSettingDocument = gql`
    mutation ResetSetting($resource: URI, $settingKey: String) {
  resetSetting(resource: $resource, settingKey: $settingKey) @client
}
    `;
export type ResetSettingMutationResult = ApolloReactCommon.MutationResult<IResetSettingMutation>;
export type ResetSettingMutationOptions = ApolloReactCommon.BaseMutationOptions<IResetSettingMutation, IResetSettingMutationVariables>;
export const saveUserSettingsDocument = gql`
  ...
  saveUserSettings(content: $content) {
    ...
    `;
export type saveUserSettingsMutationResult = ApolloReactCommon.MutationResult<IsaveUserSettingsMutation>;
export type saveUserSettingsMutationOptions = ApolloReactCommon.BaseMutationOptions<IsaveUserSettingsMutation, IsaveUserSettingsMutationVariables>;
export const saveWorkspaceSettingsDocument = gql`
  ...
  saveWorkspaceSettings {
    ...
    `;
export type saveWorkspaceSettingsMutationResult = ApolloReactCommon.MutationResult<IsaveWorkspaceSettingsMutation>;
export type saveWorkspaceSettingsMutationOptions = ApolloReactCommon.BaseMutationOptions<IsaveWorkspaceSettingsMutation, IsaveWorkspaceSettingsMutationVariables>;
export const SwitchSettingsDocument = gql`
  ...
  switchSettings(target: $target, editorId: $editorId, resource: $resource, jsonEditor: $jsonEditor) @client
    ...
    `;
export type SwitchSettingsMutationResult = ApolloReactCommon.MutationResult<ISwitchSettingsMutation>;
export type SwitchSettingsMutationOptions = ApolloReactCommon.BaseMutationOptions<ISwitchSettingsMutation, ISwitchSettingsMutationVariables>;
export const DefaultPreferencesDocument = gql`
  ...
  defaultPreferences {
    ...
    `;
export type DefaultPreferencesQueryResult = ApolloReactCommon.QueryResult<IDefaultPreferencesQuery, IDefaultPreferencesQueryVariables>;
export const DefaultSettingsDocument = gql`
  ...
  defaultViewerSettingsSubject(target: $target) {
    ...
    ${DefaultSettingFragmentDoc}`;
export type DefaultSettingsQueryResult = ApolloReactCommon.QueryResult<IDefaultSettingsQuery, IDefaultSettingsQueryVariables>;
...
${GitConfigurationFragmentDoc}
${WorkspaceConfigurationFragmentDoc}`;
export type FullConfigurationQueryResult = ApolloReactCommon.QueryResult<IFullConfigurationQuery, IFullConfigurationQueryVariables>;
export const GetMostCommonlyUsedSettingsDocument = gql`
    query GetMostCommonlyUsedSettings {
  getMostCommonlyUsedSettings @client
}
    `;
export type GetMostCommonlyUsedSettingsQueryResult = ApolloReactCommon.QueryResult<IGetMostCommonlyUsedSettingsQuery, IGetMostCommonlyUsedSettingsQueryVariables>;
export const WorkspacesDocument = gql`
  ...
  workspaces {
    ...
    `;
export type WorkspacesQueryResult = ApolloReactCommon.QueryResult<IWorkspacesQuery, IWorkspacesQueryVariables>;
export const UpdateConfigurationValueDocument = gql`
  ...
  updateConfigurationValue(key: $key, value: $value, overrides: $overrides, target: $target, donotNotifyError: $donotNotifyError)
    ...
    `;
export type UpdateConfigurationValueMutationResult = ApolloReactCommon.MutationResult<IUpdateConfigurationValueMutation>;
export type UpdateConfigurationValueMutationOptions = ApolloReactCommon.BaseMutationOptions<IUpdateConfigurationValueMutation, IUpdateConfigurationValueMutationVariables>;
export const CopyDocument = gql`
    mutation Copy($value: String) {
  copy(value: $value) @client
}
    `;
export type CopyMutationResult = ApolloReactCommon.MutationResult<ICopyMutation>;
export type CopyMutationOptions = ApolloReactCommon.BaseMutationOptions<ICopyMutation, ICopyMutationVariables>;
export const RunMenuActionDocument = gql`
  ...
  runMenuAction(argument: $argument) @client
    ...
    `;
export type RunMenuActionMutationResult = ApolloReactCommon.MutationResult<IRunMenuActionMutation>;
export type RunMenuActionMutationOptions = ApolloReactCommon.BaseMutationOptions<IRunMenuActionMutation, IRunMenuActionMutationVariables>;
export const HideContextMenuDocument = gql`
    mutation HideContextMenu {
  hideContextMenu @client
}
    `;
export type HideContextMenuMutationResult = ApolloReactCommon.MutationResult<IHideContextMenuMutation>;
export type HideContextMenuMutationOptions = ApolloReactCommon.BaseMutationOptions<IHideContextMenuMutation, IHideContextMenuMutationVariables>;
export const ShowContextMenuDocument = gql`
  ...
  showContextMenu(delegate: $delegate) @client
    ...
    `;
export type ShowContextMenuMutationResult = ApolloReactCommon.MutationResult<IShowContextMenuMutation>;
export type ShowContextMenuMutationOptions = ApolloReactCommon.BaseMutationOptions<IShowContextMenuMutation, IShowContextMenuMutationVariables>;
export const CloseDialogDocument = gql`
    mutation CloseDialog {
  closeDialog @client
}
    `;
export type CloseDialogMutationResult = ApolloReactCommon.MutationResult<ICloseDialogMutation>;
export type CloseDialogMutationOptions = ApolloReactCommon.BaseMutationOptions<ICloseDialogMutation, ICloseDialogMutationVariables>;
export const ShowDocument = gql`
    mutation Show($dialog: Dialog_input) {
  show(dialog: $dialog) @client
}
    `;
export type ShowMutationResult = ApolloReactCommon.MutationResult<IShowMutation>;
export type ShowMutationOptions = ApolloReactCommon.BaseMutationOptions<IShowMutation, IShowMutationVariables>;
export const OpenEditorResourceInputDocument = gql`
  ...
  openEditorWithResourceInput(editor: $editor, group: $group) @client
    ...
    `;
export type OpenEditorResourceInputMutationResult = ApolloReactCommon.MutationResult<IOpenEditorResourceInputMutation>;
export type OpenEditorResourceInputMutationOptions = ApolloReactCommon.BaseMutationOptions<IOpenEditorResourceInputMutation, IOpenEditorResourceInputMutationVariables>;
export const OpenEditorDocument = gql`
  ...
  openEditor(content: $content, options: $options) @client
    ...
    `;
export type OpenEditorMutationResult = ApolloReactCommon.MutationResult<IOpenEditorMutation>;
export type OpenEditorMutationOptions = ApolloReactCommon.BaseMutationOptions<IOpenEditorMutation, IOpenEditorMutationVariables>;
export const GoToLineDocument = gql`
    mutation GoToLine($range: LineRange_input) {
  gotoLine(range: $range) @client
}
    `;
export type GoToLineMutationResult = ApolloReactCommon.MutationResult<IGoToLineMutation>;
export type GoToLineMutationOptions = ApolloReactCommon.BaseMutationOptions<IGoToLineMutation, IGoToLineMutationVariables>;
export const HighlightLineDocument = gql`
    mutation HighlightLine($range: LineRange_input) {
  highlightLine(range: $range) @client
}
    `;
export type HighlightLineMutationResult = ApolloReactCommon.MutationResult<IHighlightLineMutation>;
export type HighlightLineMutationOptions = ApolloReactCommon.BaseMutationOptions<IHighlightLineMutation, IHighlightLineMutationVariables>;
export const JsonEditingWriteDocument = gql`
  ...
  jsonWrite(resource: $resource, value: $value, save: $save)
    ...
    `;
export type JsonEditingWriteMutationResult = ApolloReactCommon.MutationResult<IJsonEditingWriteMutation>;
export type JsonEditingWriteMutationOptions = ApolloReactCommon.BaseMutationOptions<IJsonEditingWriteMutation, IJsonEditingWriteMutationVariables>;
export const ChangeKeybindingDocument = gql`
  ...
  changeKeybinding(editItem: $editItem, selectedIndex: $selectedIndex, isOpenDialog: $isOpenDialog) @client
    ...
    `;
export type ChangeKeybindingMutationResult = ApolloReactCommon.MutationResult<IChangeKeybindingMutation>;
export type ChangeKeybindingMutationOptions = ApolloReactCommon.BaseMutationOptions<IChangeKeybindingMutation, IChangeKeybindingMutationVariables>;
export const ChangeWhenExpressionDocument = gql`
  ...
  changeWhenExpression(editItem: $editItem, editWhenIndex: $editWhenIndex, newWhen: $newWhen) @client
    ...
    `;
export type ChangeWhenExpressionMutationResult = ApolloReactCommon.MutationResult<IChangeWhenExpressionMutation>;
export type ChangeWhenExpressionMutationOptions = ApolloReactCommon.BaseMutationOptions<IChangeWhenExpressionMutation, IChangeWhenExpressionMutationVariables>;
export const EditKeybindingDocument = gql`
  ...
  editKeybinding(keybindingItem: $keybindingItem, key: $key, when: $when) @client
    ...
    `;
export type EditKeybindingMutationResult = ApolloReactCommon.MutationResult<IEditKeybindingMutation>;
export type EditKeybindingMutationOptions = ApolloReactCommon.BaseMutationOptions<IEditKeybindingMutation, IEditKeybindingMutationVariables>;
export const HideKeybindingDialogDocument = gql`
    mutation HideKeybindingDialog {
  hideKeybindingDialog @client
}
    `;
export type HideKeybindingDialogMutationResult = ApolloReactCommon.MutationResult<IHideKeybindingDialogMutation>;
export type HideKeybindingDialogMutationOptions = ApolloReactCommon.BaseMutationOptions<IHideKeybindingDialogMutation, IHideKeybindingDialogMutationVariables>;
export const LookupKeybindingDocument = gql`
    mutation LookupKeybinding($commandId: String) {
  lookupKeybinding(commandId: $commandId) @client
}
    `;
export type LookupKeybindingMutationResult = ApolloReactCommon.MutationResult<ILookupKeybindingMutation>;
export type LookupKeybindingMutationOptions = ApolloReactCommon.BaseMutationOptions<ILookupKeybindingMutation, ILookupKeybindingMutationVariables>;
export const registerKeybindingDocument = gql`
    mutation registerKeybinding($keybinding: Keybinding_input) {
  registerKeybinding(keybinding: $keybinding) @client
}
    `;
export type registerKeybindingMutationResult = ApolloReactCommon.MutationResult<IregisterKeybindingMutation>;
export type registerKeybindingMutationOptions = ApolloReactCommon.BaseMutationOptions<IregisterKeybindingMutation, IregisterKeybindingMutationVariables>;
export const RemoveKeybindingDocument = gql`
    mutation RemoveKeybinding($keybindingItem: KeybindingItem_input) {
  removeKeybinding(keybindingItem: $keybindingItem) @client
}
    `;
export type RemoveKeybindingMutationResult = ApolloReactCommon.MutationResult<IRemoveKeybindingMutation>;
export type RemoveKeybindingMutationOptions = ApolloReactCommon.BaseMutationOptions<IRemoveKeybindingMutation, IRemoveKeybindingMutationVariables>;
export const ResetKeybindingDocument = gql`
    mutation ResetKeybinding($keybindingItem: KeybindingItem_input) {
  resetKeybinding(keybindingItem: $keybindingItem) @client
}
    `;
export type ResetKeybindingMutationResult = ApolloReactCommon.MutationResult<IResetKeybindingMutation>;
export type ResetKeybindingMutationOptions = ApolloReactCommon.BaseMutationOptions<IResetKeybindingMutation, IResetKeybindingMutationVariables>;
export const ResolveKeyboardEventDocument = gql`
  ...
  resolveKeyboardEvent(keyboardEvent: $keyboardEvent) @client {
    ...
    `;
export type ResolveKeyboardEventMutationResult = ApolloReactCommon.MutationResult<IResolveKeyboardEventMutation>;
export type ResolveKeyboardEventMutationOptions = ApolloReactCommon.BaseMutationOptions<IResolveKeyboardEventMutation, IResolveKeyboardEventMutationVariables>;
export const SearchKeybindingDocument = gql`
    mutation SearchKeybinding($value: String) {
  searchKeybinding(value: $value) @client
}
    `;
export type SearchKeybindingMutationResult = ApolloReactCommon.MutationResult<ISearchKeybindingMutation>;
export type SearchKeybindingMutationOptions = ApolloReactCommon.BaseMutationOptions<ISearchKeybindingMutation, ISearchKeybindingMutationVariables>;
export const SetSelectedKeybindingIndexDocument = gql`
    mutation SetSelectedKeybindingIndex($index: Int) {
  setSelectedKeybindingIndex(index: $index) @client
}
    `;
export type SetSelectedKeybindingIndexMutationResult = ApolloReactCommon.MutationResult<ISetSelectedKeybindingIndexMutation>;
export type SetSelectedKeybindingIndexMutationOptions = ApolloReactCommon.BaseMutationOptions<ISetSelectedKeybindingIndexMutation, ISetSelectedKeybindingIndexMutationVariables>;
export const StopEditWhenExpressionDocument = gql`
    mutation StopEditWhenExpression {
  stopEditWhenExpression @client
}
    `;
export type StopEditWhenExpressionMutationResult = ApolloReactCommon.MutationResult<IStopEditWhenExpressionMutation>;
export type StopEditWhenExpressionMutationOptions = ApolloReactCommon.BaseMutationOptions<IStopEditWhenExpressionMutation, IStopEditWhenExpressionMutationVariables>;
export const AddNotificationDocument = gql`
  ...
  addNotification(notification: $notification) @client
    ...
    `;
export type AddNotificationMutationResult = ApolloReactCommon.MutationResult<IAddNotificationMutation>;
export type AddNotificationMutationOptions = ApolloReactCommon.BaseMutationOptions<IAddNotificationMutation, IAddNotificationMutationVariables>;
export const CloseNotificationDocument = gql`
    mutation CloseNotification($index: Int) {
  closeNotification(index: $index) @client
}
    `;
export type CloseNotificationMutationResult = ApolloReactCommon.MutationResult<ICloseNotificationMutation>;
export type CloseNotificationMutationOptions = ApolloReactCommon.BaseMutationOptions<ICloseNotificationMutation, ICloseNotificationMutationVariables>;
export const HandlerDocument = gql`
    mutation Handler($arg: ActionRun_input) {
  handler(arg: $arg) @client
}
    `;
export type HandlerMutationResult = ApolloReactCommon.MutationResult<IHandlerMutation>;
export type HandlerMutationOptions = ApolloReactCommon.BaseMutationOptions<IHandlerMutation, IHandlerMutationVariables>;
export const OpenEditorFileDocument = gql`
  ...
  openFile(content: $content, options: $options) @client
    ...
    `;
export type OpenEditorFileMutationResult = ApolloReactCommon.MutationResult<IOpenEditorFileMutation>;
export type OpenEditorFileMutationOptions = ApolloReactCommon.BaseMutationOptions<IOpenEditorFileMutation, IOpenEditorFileMutationVariables>;
export const HideInputModelDocument = gql`
    mutation HideInputModel {
  hideInputModel @client
}
    `;
export type HideInputModelMutationResult = ApolloReactCommon.MutationResult<IHideInputModelMutation>;
export type HideInputModelMutationOptions = ApolloReactCommon.BaseMutationOptions<IHideInputModelMutation, IHideInputModelMutationVariables>;
export const SetSelectedDocument = gql`
  ...
  setSelected(selectedValue: $selectedValue, inputValue: $inputValue) @client
    ...
    `;
export type SetSelectedMutationResult = ApolloReactCommon.MutationResult<ISetSelectedMutation>;
export type SetSelectedMutationOptions = ApolloReactCommon.BaseMutationOptions<ISetSelectedMutation, ISetSelectedMutationVariables>;
export const ShowInputDocument = gql`
    mutation ShowInput($options: InputOptions) {
  showInput(options: $options) @client
}
    `;
export type ShowInputMutationResult = ApolloReactCommon.MutationResult<IShowInputMutation>;
export type ShowInputMutationOptions = ApolloReactCommon.BaseMutationOptions<IShowInputMutation, IShowInputMutationVariables>;
export const ShowPickInputDocument = gql`
    mutation ShowPickInput($items: [PickItem], $options: PickInputOptions) {
  showPickInput(items: $items, options: $options) @client
}
    `;
export type ShowPickInputMutationResult = ApolloReactCommon.MutationResult<IShowPickInputMutation>;
export type ShowPickInputMutationOptions = ApolloReactCommon.BaseMutationOptions<IShowPickInputMutation, IShowPickInputMutationVariables>;
export const AddEntryDocument = gql`
    mutation AddEntry($arg: AddEntry_input) {
  addEntry(arg: $arg) @client
}
    `;
export type AddEntryMutationResult = ApolloReactCommon.MutationResult<IAddEntryMutation>;
export type AddEntryMutationOptions = ApolloReactCommon.BaseMutationOptions<IAddEntryMutation, IAddEntryMutationVariables>;
export const RemoveStatusbarEntryDocument = gql`
    mutation RemoveStatusbarEntry($id: ID!) {
  removeStatusbarEntry(id: $id) @client
}
    `;
export type RemoveStatusbarEntryMutationResult = ApolloReactCommon.MutationResult<IRemoveStatusbarEntryMutation>;
export type RemoveStatusbarEntryMutationOptions = ApolloReactCommon.BaseMutationOptions<IRemoveStatusbarEntryMutation, IRemoveStatusbarEntryMutationVariables>;
export const SetStatusMessageDocument = gql`
    mutation SetStatusMessage($arg: SetStatusMsg_input) {
  setStatusMessage(arg: $arg) @client
}
    `;
export type SetStatusMessageMutationResult = ApolloReactCommon.MutationResult<ISetStatusMessageMutation>;
export type SetStatusMessageMutationOptions = ApolloReactCommon.BaseMutationOptions<ISetStatusMessageMutation, ISetStatusMessageMutationVariables>;
export const UpdateStatusbarEntryDocument = gql`
    mutation UpdateStatusbarEntry($arg: UpdateEntry_input) {
  updateStatusbarEntry(arg: $arg) @client
}
    `;
export type UpdateStatusbarEntryMutationResult = ApolloReactCommon.MutationResult<IUpdateStatusbarEntryMutation>;
export type UpdateStatusbarEntryMutationOptions = ApolloReactCommon.BaseMutationOptions<IUpdateStatusbarEntryMutation, IUpdateStatusbarEntryMutationVariables>;
export const AddFoldersDocument = gql`
    mutation AddFolders($folders: [Folder_input], $index: Int) {
  addFolders(folders: $folders, index: $index) @client
}
    `;
export type AddFoldersMutationResult = ApolloReactCommon.MutationResult<IAddFoldersMutation>;
export type AddFoldersMutationOptions = ApolloReactCommon.BaseMutationOptions<IAddFoldersMutation, IAddFoldersMutationVariables>;
export const ChangeWorkspaceDocument = gql`
    mutation ChangeWorkspace($args: Args_input) {
  changeWorkspace(args: $args) @client
}
    `;
export type ChangeWorkspaceMutationResult = ApolloReactCommon.MutationResult<IChangeWorkspaceMutation>;
export type ChangeWorkspaceMutationOptions = ApolloReactCommon.BaseMutationOptions<IChangeWorkspaceMutation, IChangeWorkspaceMutationVariables>;
export const RemoveFoldersDocument = gql`
    mutation RemoveFolders($folders: [URI]) {
  removeFolders(folders: $folders) @client
}
    `;
export type RemoveFoldersMutationResult = ApolloReactCommon.MutationResult<IRemoveFoldersMutation>;
export type RemoveFoldersMutationOptions = ApolloReactCommon.BaseMutationOptions<IRemoveFoldersMutation, IRemoveFoldersMutationVariables>;
export const UpdateFoldersDocument = gql`
  ...
  updateFolders(foldersToAdd: $foldersToAdd, foldersToRemove: $foldersToRemove, index: $index) @client
    ...
    `;
export type UpdateFoldersMutationResult = ApolloReactCommon.MutationResult<IUpdateFoldersMutation>;
export type UpdateFoldersMutationOptions = ApolloReactCommon.BaseMutationOptions<IUpdateFoldersMutation, IUpdateFoldersMutationVariables>;
export const FinalConfiguration_WSDocument = gql`
  ...
  viewerSettings {
    ...
    ${FinalConfigurationFragmentDoc}`;
export type FinalConfiguration_WSQueryResult = ApolloReactCommon.QueryResult<IFinalConfiguration_WSQuery, IFinalConfiguration_WSQueryVariables>;
export const GetContextDocument = gql`
  ...
  getContextData @client {
    ...
    ${AllContextFragmentDoc}`;
export type GetContextQueryResult = ApolloReactCommon.QueryResult<IGetContextQuery, IGetContextQueryVariables>;
export const ContextMenuDocument = gql`
  ...
  contextMenu @client {
    ...
    `;
export type ContextMenuQueryResult = ApolloReactCommon.QueryResult<IContextMenuQuery, IContextMenuQueryVariables>;
export const DialogDocument = gql`
  ...
  dialog @client {
    ...
    `;
export type DialogQueryResult = ApolloReactCommon.QueryResult<IDialogQuery, IDialogQueryVariables>;
export const showDialogDocument = gql`
  ...
  showDialog(dialog: $dialog) @client {
    ...
    `;
export type showDialogQueryResult = ApolloReactCommon.QueryResult<IshowDialogQuery, IshowDialogQueryVariables>;
export const GoToLineQuickAccessDocument = gql`
  ...
  gotoLineQuickAccess @client {
    ...
    `;
export type GoToLineQuickAccessQueryResult = ApolloReactCommon.QueryResult<IGoToLineQuickAccessQuery, IGoToLineQuickAccessQueryVariables>;
export const GetKeybindingsDocument = gql`
  ...
  getKeybindings @client {
    ...
    `;
export type GetKeybindingsQueryResult = ApolloReactCommon.QueryResult<IGetKeybindingsQuery, IGetKeybindingsQueryVariables>;
export const KeybindingContextMenuDocument = gql`
  ...
  keybindingContextMenu @client {
    ...
    `;
export type KeybindingContextMenuQueryResult = ApolloReactCommon.QueryResult<IKeybindingContextMenuQuery, IKeybindingContextMenuQueryVariables>;
export const KeybindingsDocument = gql`
    query Keybindings {
  keybindings @client {
    items {
      command
    ...
    `;
export type KeybindingsQueryResult = ApolloReactCommon.QueryResult<IKeybindingsQuery, IKeybindingsQueryVariables>;
export const NotificationsDocument = gql`
  ...
  notifications @client {
    ...
    `;
export type NotificationsQueryResult = ApolloReactCommon.QueryResult<INotificationsQuery, INotificationsQueryVariables>;
export const showNotificationDocument = gql`
  ...
  showNotification(notification: $notification) @client
    ...
    `;
export type showNotificationQueryResult = ApolloReactCommon.QueryResult<IshowNotificationQuery, IshowNotificationQueryVariables>;
export const GetSelectedValueDocument = gql`
  ...
  quickInputModel @client {
    ...
    ${pickItemFragmentDoc}`;
export type GetSelectedValueQueryResult = ApolloReactCommon.QueryResult<IGetSelectedValueQuery, IGetSelectedValueQueryVariables>;
export const QuickInputModelDocument = gql`
  ...
  quickInputModel @client {
    ...
    ${pickItemFragmentDoc}`;
export type QuickInputModelQueryResult = ApolloReactCommon.QueryResult<IQuickInputModelQuery, IQuickInputModelQueryVariables>;
export const StatusbarDocument = gql`
    query Statusbar {
  statusbar @client {
    items {
      ... on Terminal {
    ...
    `;
export type StatusbarQueryResult = ApolloReactCommon.QueryResult<IStatusbarQuery, IStatusbarQueryVariables>;
export const StatusbarItemDocument = gql`
  ...
  statusbarItem(id: $id) @client {
    ...
    `;
export type StatusbarItemQueryResult = ApolloReactCommon.QueryResult<IStatusbarItemQuery, IStatusbarItemQueryVariables>;
export const GetViewsDocument = gql`
  ...
  getViews(containerId: $containerId) @client {
    ...
    `;
export type GetViewsQueryResult = ApolloReactCommon.QueryResult<IGetViewsQuery, IGetViewsQueryVariables>;
...
export const NotifyErrorDocument = gql`
    mutation NotifyError($message: [NotificationMessage_input]) {
  notifyError(message: $message)
}
    `;
export type NotifyErrorMutationResult = ApolloReactCommon.MutationResult<INotifyErrorMutation>;
export type NotifyErrorMutationOptions = ApolloReactCommon.BaseMutationOptions<INotifyErrorMutation, INotifyErrorMutationVariables>;
export const NotifyInfoDocument = gql`
    mutation NotifyInfo($message: [NotificationMessage_input]) {
  notifyInfo(message: $message)
}
    `;
export type NotifyInfoMutationResult = ApolloReactCommon.MutationResult<INotifyInfoMutation>;
export type NotifyInfoMutationOptions = ApolloReactCommon.BaseMutationOptions<INotifyInfoMutation, INotifyInfoMutationVariables>;
export const NotifyPromptDocument = gql`
  ...
  notifyPrompt(severity: $severity, message: $message, choices: $choices, options: $options)
    ...
    `;
export type NotifyPromptMutationResult = ApolloReactCommon.MutationResult<INotifyPromptMutation>;
export type NotifyPromptMutationOptions = ApolloReactCommon.BaseMutationOptions<INotifyPromptMutation, INotifyPromptMutationVariables>;
export const NotifyWarnDocument = gql`
    mutation NotifyWarn($message: [NotificationMessage_input]) {
  notifyWarn(message: $message)
}
    `;
export type NotifyWarnMutationResult = ApolloReactCommon.MutationResult<INotifyWarnMutation>;
export type NotifyWarnMutationOptions = ApolloReactCommon.BaseMutationOptions<INotifyWarnMutation, INotifyWarnMutationVariables>;
export const NotifyDocument = gql`
    mutation Notify($notification: Notification_input) {
  notify(notification: $notification)
}
    `;
export type NotifyMutationResult = ApolloReactCommon.MutationResult<INotifyMutation>;
export type NotifyMutationOptions = ApolloReactCommon.BaseMutationOptions<INotifyMutation, INotifyMutationVariables>;
export const UpdateWorkspaceContextAddFoldersDocument = gql`
  ...
  updateWorkspaceContextAddFolders(foldersToAdd: $foldersToAdd, index: $index) {
    ...
    `;
export type UpdateWorkspaceContextAddFoldersMutationResult = ApolloReactCommon.MutationResult<IUpdateWorkspaceContextAddFoldersMutation>;
export type UpdateWorkspaceContextAddFoldersMutationOptions = ApolloReactCommon.BaseMutationOptions<IUpdateWorkspaceContextAddFoldersMutation, IUpdateWorkspaceContextAddFoldersMutationVariables>;
export const UpdateWorkspaceContextRemoveFoldersDocument = gql`
  ...
  updateWorkspaceContextRemoveFolders(foldersToRemove: $foldersToRemove) {
    ...
    `;
export type UpdateWorkspaceContextRemoveFoldersMutationResult = ApolloReactCommon.MutationResult<IUpdateWorkspaceContextRemoveFoldersMutation>;
export type UpdateWorkspaceContextRemoveFoldersMutationOptions = ApolloReactCommon.BaseMutationOptions<IUpdateWorkspaceContextRemoveFoldersMutation, IUpdateWorkspaceContextRemoveFoldersMutationVariables>;
export const UpdateWorkspaceContextUpdateFoldersDocument = gql`
  ...
  updateWorkspaceContextUpdateFolders(foldersToAdd: $foldersToAdd, foldersToRemove: $foldersToRemove, index: $index) {
    ...
    `;
export type UpdateWorkspaceContextUpdateFoldersMutationResult = ApolloReactCommon.MutationResult<IUpdateWorkspaceContextUpdateFoldersMutation>;
export type UpdateWorkspaceContextUpdateFoldersMutationOptions = ApolloReactCommon.BaseMutationOptions<IUpdateWorkspaceContextUpdateFoldersMutation, IUpdateWorkspaceContextUpdateFoldersMutationVariables>;
export const GetConfiguration_WSDocument = gql`
    query GetConfiguration_WS {
  getConfigurationData {
    ...GetConfigurationData
  }
}
    ${GetConfigurationDataFragmentDoc}`;
export type GetConfiguration_WSQueryResult = ApolloReactCommon.QueryResult<IGetConfiguration_WSQuery, IGetConfiguration_WSQueryVariables>;
export const GetEnvironment_WSDocument = gql`
  ...
  getEnvironment {
    ...
    `;
export type GetEnvironment_WSQueryResult = ApolloReactCommon.QueryResult<IGetEnvironment_WSQuery, IGetEnvironment_WSQueryVariables>;
export const GetWorkspace_WSDocument = gql`
  ...
  getWorkspace {
    ...
    ${WorkspaceFolderFragmentDoc}`;
export type GetWorkspace_WSQueryResult = ApolloReactCommon.QueryResult<IGetWorkspace_WSQuery, IGetWorkspace_WSQueryVariables>;
export const GetWorkspaceValue_WSDocument = gql`
    query GetWorkspaceValue_WS($value: WorkspaceValue_Input) {
  getWorkspaceValue(value: $value)
}
    `;
export type GetWorkspaceValue_WSQueryResult = ApolloReactCommon.QueryResult<IGetWorkspaceValue_WSQuery, IGetWorkspaceValue_WSQueryVariables>;
export const AddServerNotificationDocument = gql`
    mutation AddServerNotification($notification: Notification_input) {
  addNotification(notification: $notification)
}
    `;
export type AddServerNotificationMutationResult = ApolloReactCommon.MutationResult<IAddServerNotificationMutation>;
export type AddServerNotificationMutationOptions = ApolloReactCommon.BaseMutationOptions<IAddServerNotificationMutation, IAddServerNotificationMutationVariables>;
export const GetWorkspaceFolderContextDocument = gql`
  ...
  getWorkspaceFolderContext(arg: $arg) {
    ...
    ${WorkspaceFolderFragmentDoc}`;
export type GetWorkspaceFolderContextQueryResult = ApolloReactCommon.QueryResult<IGetWorkspaceFolderContextQuery, IGetWorkspaceFolderContextQueryVariables>;
export const CodeLenseProviderDefinitionDocument = gql`
  ...
  codeLenseProviderDefinition(params: $params) @client
    ...
    `;
export type CodeLenseProviderDefinitionMutationResult = ApolloReactCommon.MutationResult<ICodeLenseProviderDefinitionMutation>;
export type CodeLenseProviderDefinitionMutationOptions = ApolloReactCommon.BaseMutationOptions<ICodeLenseProviderDefinitionMutation, ICodeLenseProviderDefinitionMutationVariables>;
export const CompletionProviderDefinitionDocument = gql`
  ...
  completionProviderDefinition(params: $params) @client
    ...
    `;
export type CompletionProviderDefinitionMutationResult = ApolloReactCommon.MutationResult<ICompletionProviderDefinitionMutation>;
export type CompletionProviderDefinitionMutationOptions = ApolloReactCommon.BaseMutationOptions<ICompletionProviderDefinitionMutation, ICompletionProviderDefinitionMutationVariables>;
export const DefinitionDefinitionDocument = gql`
    mutation DefinitionDefinition($params: TextDocumentPositionParamsInput) {
  definitionDefinition(params: $params) @client
}
    `;
export type DefinitionDefinitionMutationResult = ApolloReactCommon.MutationResult<IDefinitionDefinitionMutation>;
export type DefinitionDefinitionMutationOptions = ApolloReactCommon.BaseMutationOptions<IDefinitionDefinitionMutation, IDefinitionDefinitionMutationVariables>;
export const DocumentHighLightProviderDefinitionDocument = gql`
  ...
  documentHighLightProviderDefinition(params: $params) @client
    ...
    `;
export type DocumentHighLightProviderDefinitionMutationResult = ApolloReactCommon.MutationResult<IDocumentHighLightProviderDefinitionMutation>;
export type DocumentHighLightProviderDefinitionMutationOptions = ApolloReactCommon.BaseMutationOptions<IDocumentHighLightProviderDefinitionMutation, IDocumentHighLightProviderDefinitionMutationVariables>;
export const DocumentFormattingProviderDefinitionDocument = gql`
  ...
  documentFormattingProviderDefinition(params: $params) @client
    ...
    `;
export type DocumentFormattingProviderDefinitionMutationResult = ApolloReactCommon.MutationResult<IDocumentFormattingProviderDefinitionMutation>;
export type DocumentFormattingProviderDefinitionMutationOptions = ApolloReactCommon.BaseMutationOptions<IDocumentFormattingProviderDefinitionMutation, IDocumentFormattingProviderDefinitionMutationVariables>;
export const HoverProviderDefinitionDocument = gql`
    mutation HoverProviderDefinition($params: TextDocumentPositionParamsInput) {
  hoverProviderDefinition(params: $params) @client
}
    `;
export type HoverProviderDefinitionMutationResult = ApolloReactCommon.MutationResult<IHoverProviderDefinitionMutation>;
export type HoverProviderDefinitionMutationOptions = ApolloReactCommon.BaseMutationOptions<IHoverProviderDefinitionMutation, IHoverProviderDefinitionMutationVariables>;
export const OpenLanguageDocumentDocument = gql`
    mutation OpenLanguageDocument($document: OpenDocumentParamsInput) {
  openLanguageDocument(params: $document) @client
}
    `;
export type OpenLanguageDocumentMutationResult = ApolloReactCommon.MutationResult<IOpenLanguageDocumentMutation>;
export type OpenLanguageDocumentMutationOptions = ApolloReactCommon.BaseMutationOptions<IOpenLanguageDocumentMutation, IOpenLanguageDocumentMutationVariables>;
export const ReferenceProviderDefinitionDocument = gql`
  ...
  referenceProviderDefinition(params: $params) @client
    ...
    `;
export type ReferenceProviderDefinitionMutationResult = ApolloReactCommon.MutationResult<IReferenceProviderDefinitionMutation>;
export type ReferenceProviderDefinitionMutationOptions = ApolloReactCommon.BaseMutationOptions<IReferenceProviderDefinitionMutation, IReferenceProviderDefinitionMutationVariables>;
export const RenameDefinitionDocument = gql`
    mutation RenameDefinition($params: TextDocumentPositionParamsInput) {
  renameDefinition(params: $params) @client
}
    `;
export type RenameDefinitionMutationResult = ApolloReactCommon.MutationResult<IRenameDefinitionMutation>;
export type RenameDefinitionMutationOptions = ApolloReactCommon.BaseMutationOptions<IRenameDefinitionMutation, IRenameDefinitionMutationVariables>;
export const DocumentSymbolDefinitionDocument = gql`
    mutation DocumentSymbolDefinition($params: TextDocumentPositionParamsInput) {
  documentSymbolDefinition(params: $params) @client
}
    `;
export type DocumentSymbolDefinitionMutationResult = ApolloReactCommon.MutationResult<IDocumentSymbolDefinitionMutation>;
export type DocumentSymbolDefinitionMutationOptions = ApolloReactCommon.BaseMutationOptions<IDocumentSymbolDefinitionMutation, IDocumentSymbolDefinitionMutationVariables>;
export const UpdateModelDocument = gql`
    mutation UpdateModel($model: IModelInput) {
  updateModel(model: $model) @client
}
    `;
export type UpdateModelMutationResult = ApolloReactCommon.MutationResult<IUpdateModelMutation>;
export type UpdateModelMutationOptions = ApolloReactCommon.BaseMutationOptions<IUpdateModelMutation, IUpdateModelMutationVariables>;
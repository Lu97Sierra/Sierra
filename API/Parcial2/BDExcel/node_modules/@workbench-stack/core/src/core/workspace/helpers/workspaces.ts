...
import { IStoredWorkspaceFolder, IStoredWorkspace, ISingleFolderWorkspaceIdentifier, IWorkspaceIdentifier, 
    IRawFileWorkspaceFolder, IRawUriWorkspaceFolder, ISingleFolderWorkspaceInitializationPayload, IWorkspace,
} from '../../../interfaces';
import { extname } from '@vscode-alt/monaco-editor/esm/vs/base/common/path';
import { isWindows, isLinux, isMacintosh } from '@vscode-alt/monaco-editor/esm/vs/base/common/platform';
import { toSlashes } from '@vscode-alt/monaco-editor/esm/vs/base/common/extpath';
import * as json from '@vscode-alt/monaco-editor/esm/vs/base/common/json';
import * as jsonEdit from '@vscode-alt/monaco-editor/esm/vs/base/common/jsonEdit';
import { dirname, resolvePath, isEqualAuthority, isEqualOrParent, relativePath, extname as resourceExtname } from '@vscode-alt/monaco-editor/esm/vs/base/common/resources';
import { normalizeDriveLetter } from '@vscode-alt/monaco-editor/esm/vs/base/common/labels';
import { WORKSPACE_EXTENSION } from '../../../constants';

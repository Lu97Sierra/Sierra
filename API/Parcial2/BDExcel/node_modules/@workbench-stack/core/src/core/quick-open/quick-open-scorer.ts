/* tslint:disable */
import { compareAnything } from '@vscode-alt/monaco-editor/esm/vs/base/common/comparers';
import { matchesPrefix, IMatch, matchesCamelCase, isUpper } from '@vscode-alt/monaco-editor/esm/vs/base/common/filters';
import { sep } from '@vscode-alt/monaco-editor/esm/vs/base/common/path';
import { isWindows, isLinux } from '@vscode-alt/monaco-editor/esm/vs/base/common/platform';
import { stripWildcards, equalsIgnoreCase } from '@vscode-alt/monaco-editor/esm/vs/base/common/strings';
import { CharCode } from '@vscode-alt/monaco-editor/esm/vs/base/common/charCode';

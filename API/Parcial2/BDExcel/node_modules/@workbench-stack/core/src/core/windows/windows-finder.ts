import { IWorkspaceIdentifier, IResolvedWorkspace, ISingleFolderWorkspaceIdentifier } from '../../interfaces';
import { URI } from '@vscode-alt/monaco-editor/esm/vs/base/common/uri';
import { isEqualOrParent } from '@vscode-alt/monaco-editor/esm/vs/base/common/resources';
import * as extpath from '@vscode-alt/monaco-editor/esm/vs/base/common/extpath';
import { isSingleFolderWorkspaceIdentifier } from '@vscode-alt/monaco-editor/esm/vs/platform/workspaces/common/workspaces';
import { isEqual } from '@vscode-alt/monaco-editor/esm/vs/base/common/resources';
import { isWorkspaceIdentifier } from '@vscode-alt/monaco-editor/esm/vs/platform/workspaces/common/workspaces';

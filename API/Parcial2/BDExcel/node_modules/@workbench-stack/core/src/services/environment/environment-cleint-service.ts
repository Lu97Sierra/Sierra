...
import { IEnvironmentService, ParsedArgs, IEnvironment, IIDebugParams, IExtensionHostDebugParams, IGetEnvironment_WSQuery, GetEnvironment_WSDocument  } from '../../interfaces';
import { ClientTypes } from '@common-stack/client-core';
import { URI } from '@vscode-alt/monaco-editor/esm/vs/base/common/uri';


@injectable()
export class EnvironmentClientService implements IEnvironmentService {
    ...
    @postConstruct()
    public async asyncInitializedWorkspaceContainer() {
        const result = await this.apollo.query<IGetEnvironment_WSQuery>({
            query: GetEnvironment_WSDocument,
        });

...
exports.useSlashForPath = exports.rewriteWorkspaceFileForNewLocation = exports.getStoredWorkspaceFolder = exports.hasWorkspaceFileExtension = exports.isSingleFolderWorkspaceInitializationPayload = exports.toWorkspaceIdentifier = exports.isWorkspaceIdentifier = exports.isSingleFolderWorkspaceIdentifier = exports.isRawUriWorkspaceFolder = exports.isRawFileWorkspaceFolder = exports.isStoredWorkspaceFolder = exports.reviveWorkspaceIdentifier = void 0;
/* tslint:disable */
...
const extpath_1 = require("@vscode-alt/monaco-editor/esm/vs/base/common/extpath");
const json = require("@vscode-alt/monaco-editor/esm/vs/base/common/json");
const jsonEdit = require("@vscode-alt/monaco-editor/esm/vs/base/common/jsonEdit");
const resources_1 = require("@vscode-alt/monaco-editor/esm/vs/base/common/resources");
const labels_1 = require("@vscode-alt/monaco-editor/esm/vs/base/common/labels");
...
const WORKSPACE_SUFFIX = '.' + constants_1.WORKSPACE_EXTENSION;

import { IClientEnvironmentService, ParsedArgs, IEnvironment, IIDebugParams, IExtensionHostDebugParams } from '../../interfaces';
import { URI } from '@vscode-alt/monaco-editor/esm/vs/base/common/uri';
export declare abstract class AbstractEnvironmentService implements IClientEnvironmentService {
    protected _environment: IEnvironment;
    abstract extInitialize(): Promise<void>;
    get args(): ParsedArgs;
    get execPath(): string;
    get cliPath(): string;
    get appRoot(): string;

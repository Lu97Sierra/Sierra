...
let EnvironmentClientService = class EnvironmentClientService extends core_1.AbstractEnvironmentService {
    constructor(logger, broker) {
        super();
        this.broker = broker;
        this.topic = "EnvironmentService" /* EnvironmentService */;
    }
    extInitialize() {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield this.callAction("environment" /* environment */);
            this._environment = result;
        });
    }
...
], EnvironmentClientService.prototype, "extInitialize", null);
EnvironmentClientService = __decorate([
    ...
    __metadata("design:paramtypes", [ILogger,

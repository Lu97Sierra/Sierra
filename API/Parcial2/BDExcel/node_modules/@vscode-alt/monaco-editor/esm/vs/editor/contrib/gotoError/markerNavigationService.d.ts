import { IMarkerService, IMarker } from '../../../platform/markers/common/markers';
...
export declare class MarkerList {
    ...
    private _markers;
    private _nextIdx;
    constructor(resourceFilter: URI | ((uri: URI) => boolean) | undefined, _markerService: IMarkerService);
    dispose(): void;
    ...
    private static _compareMarker;
}
export declare const IMarkerNavigationService: import("../../../platform/instantiation/common/instantiation").ServiceIdentifier<IMarkerNavigationService>;

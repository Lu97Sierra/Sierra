...
import { Keybinding, KeyCode, ResolvedKeybinding } from '../../../base/common/keyCodes';
...
export declare const enum KeybindingSource {
    Default = 1,
    User = 2
}
...
export declare const IKeybindingService: import("../../instantiation/common/instantiation").ServiceIdentifier<IKeybindingService>;

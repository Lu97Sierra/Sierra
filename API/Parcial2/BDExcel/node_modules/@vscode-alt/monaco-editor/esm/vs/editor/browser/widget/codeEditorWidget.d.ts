...
import { IEditorContributionDescription } from '../editorExtensions';
import { ICodeEditorService } from '../services/codeEditorService';
import { View } from '../view/viewImpl';
import { ConfigurationChangedEvent, EditorLayoutInfo, IEditorOptions, EditorOption, IComputedEditorOptions, FindComputedEditorOptionValueById } from '../../common/config/editorOptions';
...
import { IIdentifiedSingleEditOperation, IModelDecoration, IModelDecorationsChangeAccessor, IModelDeltaDecoration, ITextModel, ICursorStateComputer, IWordAtPosition } from '../../common/model';
import { IModelContentChangedEvent, IModelDecorationsChangedEvent, IModelLanguageChangedEvent, IModelLanguageConfigurationChangedEvent, IModelOptionsChangedEvent } from '../../common/model/textModelEvents';
import { IEditorWhitespace } from '../../common/viewLayout/linesLayout';
...
export declare class CodeEditorWidget extends Disposable implements editorBrowser.ICodeEditor {
    ...
    protected readonly _contributions: {
    ...
    constructor(domElement: HTMLElement, options: editorBrowser.IEditorConstructionOptions, codeEditorWidgetOptions: ICodeEditorWidgetOptions, instantiationService: IInstantiationService, codeEditorService: ICodeEditorService, commandService: ICommandService, contextKeyService: IContextKeyService, themeService: IThemeService, notificationService: INotificationService, accessibilityService: IAccessibilityService);
...
export declare class EditorModeContext extends Disposable {
    ...
    constructor(_editor: CodeEditorWidget, _contextKeyService: IContextKeyService);
    dispose(): void;
    reset(): void;
    private _update;
}

...
import { ViewEvent } from '../view/viewEvents';
...
export declare const enum OutgoingViewModelEventKind {
    ...
    ScrollChanged = 2,
    ViewZonesChanged = 3,
    ReadOnlyEditAttempt = 4,
    CursorStateChanged = 5
}
...
export declare type OutgoingViewModelEvent = (ContentSizeChangedEvent | FocusChangedEvent | ScrollChangedEvent | ViewZonesChangedEvent | ReadOnlyEditAttemptEvent | CursorStateChangedEvent);

...
import { IModelDecoration, TrackedRangeStickiness as ActualTrackedRangeStickiness } from '../model';
...
export declare function getNodeIsInOverviewRuler(node: IntervalNode): boolean;
export declare function setNodeStickiness(node: IntervalNode, stickiness: ActualTrackedRangeStickiness): void;
export declare class IntervalNode implements IModelDecoration {
    /**

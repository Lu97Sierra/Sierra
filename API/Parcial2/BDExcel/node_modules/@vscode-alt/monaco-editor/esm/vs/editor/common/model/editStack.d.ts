...
import { EndOfLineSequence, ICursorStateComputer, IIdentifiedSingleEditOperation, ITextModel } from '../model';
import { TextModel } from './textModel';
import { IUndoRedoService, IResourceUndoRedoElement, UndoRedoElementType, IWorkspaceUndoRedoElement } from '../../../platform/undoRedo/common/undoRedo';
...
export declare class EditStack {
    ...
    pushEditOperation(beforeCursorState: Selection[] | null, editOperations: IIdentifiedSingleEditOperation[], cursorStateComputer: ICursorStateComputer | null): Selection[] | null;

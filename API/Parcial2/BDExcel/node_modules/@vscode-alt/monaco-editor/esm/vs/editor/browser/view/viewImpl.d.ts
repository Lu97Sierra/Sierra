...
import { ICommandDelegate } from './viewController';
...
export declare class View extends ViewEventHandler {
    ...
    constructor(commandDelegate: ICommandDelegate, configuration: IConfiguration, themeService: IThemeService, model: IViewModel, userInputEvents: ViewUserInputEvents, overflowWidgetsDomNode: HTMLElement | undefined);

...
import { IConstructorSignature1, ServicesAccessor as InstantiationServicesAccessor, BrandedService } from '../../platform/instantiation/common/instantiation';
...
export declare type IEditorContributionCtor = IConstructorSignature1<ICodeEditor, IEditorContribution>;
export declare type IDiffEditorContributionCtor = IConstructorSignature1<IDiffEditor, IDiffEditorContribution>;
...
export declare class MultiCommand extends Command {
     ...
     */
    addImplementation(priority: number, implementation: CommandImplementation): IDisposable;
...
export declare abstract class EditorCommand extends Command {
     ...
     */
    static bindToContribution<T extends IEditorContribution>(controllerGetter: (editor: ICodeEditor) => T): EditorControllerCommand<T>;
    runCommand(accessor: ServicesAccessor, args: any): void | Promise<void>;
...
export declare abstract class MultiEditorAction extends EditorAction {
    private readonly _implementations;
    constructor(opts: IActionOptions);
    addImplementation(priority: number, implementation: CommandImplementation): IDisposable;
    runEditorCommand(accessor: ServicesAccessor, editor: ICodeEditor, args: any): void | Promise<void>;
...
export declare function registerModelAndPositionCommand(id: string, handler: (model: ITextModel, position: Position, ...args: any[]) => any): void;
export declare function registerModelCommand(id: string, handler: (model: ITextModel, ...args: any[]) => any): void;

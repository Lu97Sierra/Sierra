...
import { VariableResolver, Variable } from './snippetParser';
import { IWorkspaceContextService } from '../../../platform/workspace/common/workspace';
import { ILabelService } from '../../../platform/label/common/label';
import { OvertypingCapturer } from '../suggest/suggestOvertypingCapturer';
export declare const KnownSnippetVariableNames: {
    [key: string]: true;
};
...
export declare class ModelBasedVariableResolver implements VariableResolver {
    ...
    private readonly _model;
    constructor(_labelService: ILabelService | undefined, _model: ITextModel);
    resolve(variable: Variable): string | undefined;
}
...
export declare class CommentBasedVariableResolver implements VariableResolver {
    private readonly _model;
    private readonly _selection;
    constructor(_model: ITextModel, _selection: Selection);
    resolve(variable: Variable): string | undefined;
}

...
export declare type DialogType = 'none' | 'info' | 'error' | 'question' | 'warning';
...
export declare type IDialogResult = IConfirmationResult | IInputResult | IShowResult;
...
export declare const IDialogService: import("../../instantiation/common/instantiation").ServiceIdentifier<IDialogService>;
...
export declare const IFileDialogService: import("../../instantiation/common/instantiation").ServiceIdentifier<IFileDialogService>;
/**

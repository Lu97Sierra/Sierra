...
export function safeInnerHtml(node, value) {
    ...
    const html = (_a = _ttpSafeInnerHtml === null || _ttpSafeInnerHtml === void 0 ? void 0 : _ttpSafeInnerHtml.createHTML(value, options)) !== null && _a !== void 0 ? _a : insane(value, options);
    node.innerHTML = html;
}
/**

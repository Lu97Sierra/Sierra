...
export declare const IUndoRedoService: import("../../instantiation/common/instantiation").ServiceIdentifier<IUndoRedoService>;
...
export declare type IUndoRedoElement = IResourceUndoRedoElement | IWorkspaceUndoRedoElement;

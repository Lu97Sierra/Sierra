...
export declare function isAuthenticaionProviderExtension(manifest: IExtensionManifest): boolean;
...
export declare const IBuiltinExtensionsScannerService: import("../../instantiation/common/instantiation").ServiceIdentifier<IBuiltinExtensionsScannerService>;

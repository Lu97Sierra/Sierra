...
//         });
//     }
//     private getConfirmOptions(confirmation: IConfirmation): any {
...
//         return opts;
//     }
//     public show(severity: Severity, message: string, buttons: string[], dialogOptions?: IDialogOptions): Promise<number> {
...
//     }
//     private massageMessageBoxOptions(options: any): IMassagedMessageBoxOptions {
...
//     ) { }
//     public defaultFilePath(schemeFilter = this.getSchemeFilterForWindow()): URI | undefined {
...
//     }
//     public defaultFolderPath(schemeFilter = this.getSchemeFilterForWindow()): URI | undefined {
...
//         return candidate && resources.dirname(candidate) || undefined;
//     }
//     public defaultWorkspacePath(schemeFilter = this.getSchemeFilterForWindow()): URI | undefined {
...
//             return this.pickRemoteResourceAndOpen({
//                 title, availableFileSystems,
//                 canSelectFiles: true, canSelectFolders: true,
//                 canSelectMany: false, defaultUri: options.defaultUri,
...
//             const availableFileSystems = this.ensureFileSchema(schema); // always allow file as well
//             return this.pickRemoteResourceAndOpen({
//                 title, filters, availableFileSystems,
//                 canSelectFiles: true, canSelectFolders: false,
//                 canSelectMany: false, defaultUri: options.defaultUri,
//             }, !!options.forceNewWindow, false);
//         }
...
//     }
//     private toNativeSaveDialogOptions(options: ISaveDialogOptions): any {
//         return {
//             defaultPath: options.defaultUri && options.defaultUri.fsPath,

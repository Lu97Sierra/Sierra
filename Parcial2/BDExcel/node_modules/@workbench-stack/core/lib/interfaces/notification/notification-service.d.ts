...
export declare type INotificationMessageStr = string | Error;
...
export interface INotificationService {
     ...
     */
    notify(notification: (Pick<INotification_input, Exclude<keyof INotification_input, 'message'>> & {
        message: INotificationMessageStr;
    }) | INotification_input): INotificationHandle;
    /**
...
export interface INotificationsService {
    addNotification(notification: INotification_input): any;
    closeNotification(index: number): any;
}

...
export interface IClientWorkspaceContextService extends IWorkspaceContextService {
    extAcceptChangedWorkbenchState(workspace: IWorkspaceData, event: WorkbenchState): any;
    extAcceptChangedWorkspaceFolders(data: IWorkspaceData, event: IWorkspaceFoldersChangeEvent): any;
    extAcceptChangedWorkspaceName(date: IWorkspaceData): any;

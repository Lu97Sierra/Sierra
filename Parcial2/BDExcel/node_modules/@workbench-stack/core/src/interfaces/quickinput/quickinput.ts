...
export interface IQuickInputService {
	 ...
	 */
	// pick<T extends IQuickPickItem>(picks: IQuickInput[], options?: IPickOptions<T> & { canPickMany: true }, token?: boolean): Promise<T[] | undefined>;
	// pick<T extends IQuickPickItem>(picks: IQuickInput[], options?: IPickOptions<T> & { canPickMany: false }, token?: boolean): Promise<T | undefined>;
	// pick<T extends IQuickPickItem>(picks: IQuickInput[], options?: Omit<IPickOptions<T>, 'canPickMany'>, token?: boolean): Promise<T | undefined>;

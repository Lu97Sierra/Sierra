...
import { IConfigurationChangeEvent } from '../configuration';
import { IPosition } from '../generated-model';
...
export interface ITextResourceConfigurationService {
    ...
    /**
     * Fetches the value fo the section for the given resource by applying language overrides.

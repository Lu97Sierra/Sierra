...
import { isFalsyOrWhitespace } from '@vscode-alt/monaco-editor/esm/vs/base/common/strings';
import { createDecorator } from '@vscode-alt/monaco-editor/esm/vs/platform/instantiation/common/instantiation';
import { isMacintosh, isLinux, isWindows, isWeb } from '@vscode-alt/monaco-editor/esm/vs/base/common/platform';
import { IContext, IContextKeyService } from '@vscode-alt/monaco-editor/esm/vs/platform/contextkey/common/contextkey';

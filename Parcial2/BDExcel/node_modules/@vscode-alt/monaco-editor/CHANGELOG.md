...
### Debt work
  - Removed HTML, razor, PHP and handlebars from `@vscode-alt/monaco-editor-core`:
    - the `@vscode-alt/monaco-editor-core` is now finally language agnostic.
  ...
  - Packaging improvements:
    - thanks to the removal of the old languages from `@vscode-alt/monaco-editor-core`, we could improve the bundling and reduce the number of .js files we ship.

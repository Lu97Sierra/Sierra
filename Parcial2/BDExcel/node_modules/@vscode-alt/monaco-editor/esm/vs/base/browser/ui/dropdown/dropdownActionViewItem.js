...
export class ActionWithDropdownActionViewItem extends ActionViewItem {
    ...
    render(container) {
        ...
        if (this.element) {
            ...
            this.dropdownMenuActionViewItem = new DropdownMenuActionViewItem(new Action('dropdownAction', undefined), this.options.menuActionsOrProvider, this.contextMenuProvider, { classNames: ['dropdown', ...Codicon.dropDownButton.classNamesArray, ...this.options.menuActionClassNames || []] });

...
export class ListView {
    ...
    get onMouseUp() { return Event.map(domEvent(this.domNode, 'mouseup'), e => this.toMouseEvent(e)); }
    get onMouseDown() { return Event.map(domEvent(this.domNode, 'mousedown'), e => this.toMouseEvent(e)); }
    get onMouseOver() { return Event.map(domEvent(this.domNode, 'mouseover'), e => this.toMouseEvent(e)); }
    get onMouseMove() { return Event.map(domEvent(this.domNode, 'mousemove'), e => this.toMouseEvent(e)); }
    get onMouseOut() { return Event.map(domEvent(this.domNode, 'mouseout'), e => this.toMouseEvent(e)); }

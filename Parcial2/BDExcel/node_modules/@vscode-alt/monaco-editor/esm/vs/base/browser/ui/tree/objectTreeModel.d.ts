import { IIndexTreeModelOptions, IList } from './indexTreeModel';
import { Event } from '../../../common/event';
import { ITreeModel, ITreeNode, ITreeElement, ITreeSorter, ICollapseStateChangeEvent, ITreeModelSpliceEvent } from './tree';
...
export declare class ObjectTreeModel<T extends NonNullable<any>, TFilterData extends NonNullable<any> = void> implements IObjectTreeModel<T, TFilterData> {
    ...
    setChildren(element: T | null, children?: Iterable<ITreeElement<T>>, onDidCreateNode?: ITreeNodeCallback<T, TFilterData>, onDidDeleteNode?: ITreeNodeCallback<T, TFilterData>): void;

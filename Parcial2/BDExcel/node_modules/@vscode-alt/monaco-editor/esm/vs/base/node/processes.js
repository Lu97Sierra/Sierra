...
export function getWindowsShell(environment = process.env) {
...
export class LineProcess extends AbstractProcess {
    constructor(arg1, arg2, arg3, arg4) {
    ...
    function findExecutable(command, cwd, paths) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            function fileExists(path) {
                return __awaiter(this, void 0, void 0, function* () {
                    if (yield promisify(fs.exists)(path)) {
                        return !((yield promisify(fs.stat)(path)).isDirectory());
                    }
                    return false;
                });
            }
            ...
            for (let pathEntry of paths) {
                ...
                if (yield fileExists(withExtension)) {

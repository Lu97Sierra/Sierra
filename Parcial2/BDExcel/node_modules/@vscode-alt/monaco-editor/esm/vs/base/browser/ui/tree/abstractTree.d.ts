...
import { IListOptions, List, IListStyles, MouseController } from '../list/listWidget';
import { IListVirtualDelegate, IListRenderer, IIdentityProvider } from '../list/list';
import { Event } from '../../../common/event';
import { StandardKeyboardEvent } from '../../keyboardEvent';
import { ITreeModel, ITreeNode, ITreeRenderer, ITreeEvent, ITreeMouseEvent, ITreeContextMenuEvent, ITreeFilter, ITreeNavigator, ICollapseStateChangeEvent, ITreeDragAndDrop, ITreeModelSpliceEvent } from './tree';
import { ISpliceable } from '../../../common/sequence';
import { FuzzyScore } from '../../../common/filters';
...
declare class Trait<T> {
    ...
    private _nodeSet;
    private get nodeSet();
    constructor(identityProvider?: IIdentityProvider<T> | undefined);
...
declare class TreeNodeList<T, TFilterData, TRef> extends List<ITreeNode<T, TFilterData>> {
    ...
    constructor(user: string, container: HTMLElement, virtualDelegate: IListVirtualDelegate<ITreeNode<T, TFilterData>>, renderers: IListRenderer<any, any>[], focusTrait: Trait<T>, selectionTrait: Trait<T>, options: ITreeNodeListOptions<T, TFilterData, TRef>);
...
export declare abstract class AbstractTree<T, TFilterData, TRef> implements IDisposable {
    ...
    get onDidChangeTypeFilterPattern(): Event<string>;
    get expandOnlyOnDoubleClick(): boolean;
    ...
    constructor(user: string, container: HTMLElement, delegate: IListVirtualDelegate<T>, renderers: ITreeRenderer<T, TFilterData, any>[], _options?: IAbstractTreeOptions<T, TFilterData>);
    ...
    focusNextPage(browserEvent?: UIEvent, filter?: ((node: ITreeNode<T, TFilterData>) => boolean) | undefined): void;
    focusPreviousPage(browserEvent?: UIEvent, filter?: ((node: ITreeNode<T, TFilterData>) => boolean) | undefined): void;

...
import { ICodeEditor, IDiffEditor, IEditorConstructionOptions } from '../../browser/editorBrowser';
...
import { ICommandHandler, ICommandService } from '../../../platform/commands/common/commands';
...
export declare class StandaloneCodeEditor extends CodeEditorWidget implements IStandaloneCodeEditor {
    ...
    constructor(domElement: HTMLElement, options: IStandaloneEditorConstructionOptions, instantiationService: IInstantiationService, codeEditorService: ICodeEditorService, commandService: ICommandService, contextKeyService: IContextKeyService, keybindingService: IKeybindingService, themeService: IThemeService, notificationService: INotificationService, accessibilityService: IAccessibilityService);
    addCommand(keybinding: number, handler: ICommandHandler, context?: string): string | null;
    createContextKey<T>(key: string, defaultValue: T): IContextKey<T>;
...
export declare class StandaloneEditor extends StandaloneCodeEditor implements IStandaloneCodeEditor {
    ...
    private _ownsModel;
    constructor(domElement: HTMLElement, options: IStandaloneEditorConstructionOptions | undefined, toDispose: IDisposable, instantiationService: IInstantiationService, codeEditorService: ICodeEditorService, commandService: ICommandService, contextKeyService: IContextKeyService, keybindingService: IKeybindingService, contextViewService: IContextViewService, themeService: IStandaloneThemeService, notificationService: INotificationService, configurationService: IConfigurationService, accessibilityService: IAccessibilityService);
    dispose(): void;
    updateOptions(newOptions: IEditorOptions & IGlobalEditorOptions): void;
...
export declare class StandaloneDiffEditor extends DiffEditorWidget implements IStandaloneDiffEditor {
    ...
    private readonly _configurationService;
    private readonly _standaloneThemeService;
    constructor(domElement: HTMLElement, options: IDiffEditorConstructionOptions | undefined, toDispose: IDisposable, instantiationService: IInstantiationService, contextKeyService: IContextKeyService, keybindingService: IKeybindingService, contextViewService: IContextViewService, editorWorkerService: IEditorWorkerService, codeEditorService: ICodeEditorService, themeService: IStandaloneThemeService, notificationService: INotificationService, configurationService: IConfigurationService, contextMenuService: IContextMenuService, editorProgressService: IEditorProgressService, clipboardService: IClipboardService);
    dispose(): void;
    updateOptions(newOptions: IDiffEditorOptions & IGlobalEditorOptions): void;

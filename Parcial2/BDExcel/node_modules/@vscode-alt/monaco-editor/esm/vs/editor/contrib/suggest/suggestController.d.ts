...
import { CompletionItemProvider } from '../../common/modes';
...
export declare class SuggestController implements IEditorContribution {
    ...
    static get(editor: ICodeEditor): SuggestController;
    ...
    constructor(editor: ICodeEditor, _memoryService: ISuggestMemoryService, _commandService: ICommandService, _contextKeyService: IContextKeyService, _instantiationService: IInstantiationService, _logService: ILogService);
    dispose(): void;

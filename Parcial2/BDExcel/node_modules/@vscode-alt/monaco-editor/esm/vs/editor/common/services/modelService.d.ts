...
import { DocumentSemanticTokensProvider, DocumentRangeSemanticTokensProvider } from '../modes';
import { SemanticTokensProviderStyling } from './semanticTokensProviderStyling';
export declare const IModelService: import("../../../platform/instantiation/common/instantiation").ServiceIdentifier<IModelService>;

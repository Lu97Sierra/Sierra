...
import { IIdentifiedSingleEditOperation, ITextModel } from '../model';
 ...
 */
export declare function trimTrailingWhitespace(model: ITextModel, cursors: Position[]): IIdentifiedSingleEditOperation[];

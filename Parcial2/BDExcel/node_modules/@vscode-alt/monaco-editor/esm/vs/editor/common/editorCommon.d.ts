...
import { ConfigurationChangedEvent, IComputedEditorOptions, IEditorOptions } from './config/editorOptions';
...
import { IModelDecorationsChangeAccessor, ITextModel, OverviewRulerLane, TrackedRangeStickiness, IValidEditOperation } from './model';
...
export declare type IEditorModel = ITextModel | IDiffEditorModel;
/**
 ...
 */
export declare type IEditorViewState = ICodeEditorViewState | IDiffEditorViewState;

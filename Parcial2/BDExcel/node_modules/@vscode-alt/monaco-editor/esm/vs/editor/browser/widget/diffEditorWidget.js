...
let DiffEditorWidget = class DiffEditorWidget extends Disposable {
    ...
    _createLeftHandSideEditor(options, instantiationService, contextKeyService) {
        ...
        this._register(editor.onDidChangeConfiguration((e) => {
            ...
            if (e.hasChanged(124 /* wrappingInfo */)) {
    ...
    _adjustOptionsForSubEditor(options) {
        const clonedOptions = objects.deepClone(options || {});
...
class ViewZonesComputer {
    ...
    getViewZones() {
        ...
        const originalHasWrapping = (this._originalEditor.getOption(124 /* wrappingInfo */).wrappingColumn !== -1);
        const modifiedHasWrapping = (this._modifiedEditor.getOption(124 /* wrappingInfo */).wrappingColumn !== -1);
...
class InlineViewZonesComputer extends ViewZonesComputer {
    ...
    _finalize(result) {
        ...
        const layoutInfo = modifiedEditorOptions.get(123 /* layoutInfo */);

...
import { OverviewRulerPosition, ConfigurationChangedEvent, EditorLayoutInfo, IComputedEditorOptions, EditorOption, FindComputedEditorOptionValueById, IEditorOptions, IDiffEditorOptions } from '../common/config/editorOptions';
...
import { IIdentifiedSingleEditOperation, IModelDecoration, IModelDeltaDecoration, ITextModel, ICursorStateComputer, IWordAtPosition } from '../common/model';
...
import { IDiffComputationResult } from '../common/services/editorWorkerService';
 ...
 *@internal
 */
export declare function isCodeEditor(thing: any): thing is ICodeEditor;
/**
 *@internal
 */
export declare function isDiffEditor(thing: any): thing is IDiffEditor;
/**
 *@internal
 */
export declare function isCompositeEditor(thing: any): thing is editorCommon.ICompositeCodeEditor;
/**
 *@internal
 */
export declare function getCodeEditor(thing: any): ICodeEditor | null;
/**
 *@internal
 */

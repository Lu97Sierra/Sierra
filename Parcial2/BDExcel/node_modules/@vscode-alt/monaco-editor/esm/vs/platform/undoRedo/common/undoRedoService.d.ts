import { IUndoRedoService, IUndoRedoElement, IPastFutureElements, ResourceEditStackSnapshot, UriComparisonKeyComputer, UndoRedoGroup, UndoRedoSource } from './undoRedo';
...
export declare class UndoRedoService implements IUndoRedoService {
    ...
    private _undo;
    private _confirmDifferentSourceAndContinueUndo;

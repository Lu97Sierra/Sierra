...
import { OVERRIDE_PROPERTY_PATTERN, Extensions, overrideIdentifierFromKey } from './configurationRegistry.js';
import { addToValueTree, toValuesTree, getConfigurationValue, getDefaultValues, getConfigurationKeys, removeFromValueTree, toOverrides, compare } from './configuration.js';
...
export class ConfigurationModelParser {
    ...
    doParseRaw(raw) {
        ...
        const overrides = toOverrides(raw, message => console.error(`Conflict in settings file ${this._name}: ${message}`));

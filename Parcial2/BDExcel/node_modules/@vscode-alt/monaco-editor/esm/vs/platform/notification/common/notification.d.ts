...
export declare const INotificationService: import("../../instantiation/common/instantiation").ServiceIdentifier<INotificationService>;
export declare type NotificationMessage = string | Error;

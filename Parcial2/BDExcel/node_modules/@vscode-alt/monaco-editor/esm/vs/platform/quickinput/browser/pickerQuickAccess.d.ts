...
import { IQuickPickSeparator, IKeyMods, IQuickPickAcceptEvent } from '../../../base/parts/quickinput/common/quickInput';
import { IQuickAccessProvider } from '../common/quickAccess';
import { IDisposable, DisposableStore, Disposable } from '../../../base/common/lifecycle';
...
export declare type PicksWithActive<T> = {
    items: ReadonlyArray<Pick<T>>;
    active?: T;
};
export declare type Picks<T> = ReadonlyArray<Pick<T>> | PicksWithActive<T>;
